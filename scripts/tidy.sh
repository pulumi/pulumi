...
EXCLUDE="-e tests/integration/construct_component_configure_provider/go/go.mod -e tests/integration/package-add/namespace/go/go.mod -e sdk/go/pulumi-language-go/testdata -e tests/testdata -e tests/smoke/testdata -e sdk/go/tools/automation/tests/runtime/go.mod -e sdk/go/common/util/logging/testdata/glog-flag-conflict/go.mod"
