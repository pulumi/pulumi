...
names, and the values are lists of tags and packages specs where
packages are either Go packages containing the tests, or test suites
names as passed to `run-testsuite.py`.
...
TEST_SUBSETS = {
    'integration-go': {
        'tags': 'go',
        'packages': ['github.com/pulumi/pulumi/tests/integration']
    },
    'integration-dotnet': {
        'tags': 'dotnet',
        'packages': ['github.com/pulumi/pulumi/tests/integration']
