...
func runTestingHost(t *testing.T) testingrpc.LanguageTestClient {
...
func TestLanguage(t *testing.T) {
	...
	testHost := runTestingHost(t)

	tests, err := testHost.GetLanguageTests(context.Background(), &testingrpc.GetLanguageTestsRequest{})
	require.NoError(t, err)
	...
	prepare, err := testHost.PrepareLanguageTests(context.Background(), &testingrpc.PrepareLanguageTestsRequest{
	...
	for _, tt := range tests.Tests {
		...
		t.Run(tt, func(t *testing.T) {
			result, err := testHost.RunLanguageTest(context.Background(), &testingrpc.RunLanguageTestRequest{
				Token: prepare.Token,
				Test:  tt,
			})
