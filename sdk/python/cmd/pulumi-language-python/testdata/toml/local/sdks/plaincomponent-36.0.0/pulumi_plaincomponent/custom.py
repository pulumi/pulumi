...
@pulumi.type_token("plaincomponent:index:Custom")
class Custom(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a Custom resource with the given unique name, props, and options.
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'plaincomponent:index:Custom', resource_name, id, __props__, opts or pulumi.ResourceOptions())
