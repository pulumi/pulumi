...
@pulumi.type_token("simple-invoke-with-scalar-return:index:StringResource")
class StringResource(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'simple-invoke-with-scalar-return:index:StringResource', resource_name, id, __props__, opts or pulumi.ResourceOptions())
