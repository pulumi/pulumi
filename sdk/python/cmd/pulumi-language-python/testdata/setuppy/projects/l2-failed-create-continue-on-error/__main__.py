...
independent2 = simple.Resource("independent2", value=True,
opts=pulumi.ResourceOptions(depends_on=[independent]))
independent3 = simple.Resource("independent3", value=True,
opts=pulumi.ResourceOptions(depends_on=[independent2]))
