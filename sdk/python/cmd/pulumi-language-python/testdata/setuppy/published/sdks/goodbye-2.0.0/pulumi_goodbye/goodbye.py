...
class Goodbye(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        __props__.__dict__["parameter_value"] = None
        __inst__ = Goodbye.__new__(Goodbye)
        return pulumi.runtime.exists_resource(__inst__, 'goodbye:index:Goodbye', resource_name, id, __props__, opts or pulumi.ResourceOptions(), package_ref=_utilities.get_package())
