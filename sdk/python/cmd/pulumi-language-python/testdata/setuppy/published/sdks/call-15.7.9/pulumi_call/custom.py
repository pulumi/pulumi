...
class Custom(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'call:index:Custom', resource_name, id, __props__, opts or pulumi.ResourceOptions())
    ...
    def provider_value(__self__) -> pulumi.Output['Custom.ProviderValueResult']:
        """
