...
@pulumi.type_token("snake_names:cool_module:some_resource")
class Some_resource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if nested is None and not opts.urn:
                raise TypeError("Missing required property 'nested'")
    ...
    def exists(id: pulumi.Input[str],
        ...
        return pulumi.runtime.exists_resource(__inst__, 'snake_names:cool_module:some_resource', id, __props__, opts or pulumi.ResourceOptions())
