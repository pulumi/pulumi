...
@pulumi.type_token("optionalprimitive:index:Resource")
class Resource(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'optionalprimitive:index:Resource', resource_name, id, __props__, opts or pulumi.ResourceOptions())
    ...
    @_builtins.property
    @pulumi.getter(name="booleanMap")
    def boolean_map(self) -> pulumi.Output[Optional[Mapping[str, _builtins.bool]]]:
        return pulumi.get(self, "boolean_map")
    ...
    @_builtins.property
    @pulumi.getter(name="numberArray")
    def number_array(self) -> pulumi.Output[Optional[Sequence[_builtins.float]]]:
        return pulumi.get(self, "number_array")
