...
pulumi.export("entriesOutput", res.output_map.apply(lambda output_map: [{"key": k, "value": v} for k, v in output_map.items()]))
...
pulumi.export("entriesObjectOutput", res.output_object.apply(lambda output_object: [{"key": k, "value": v} for k, v in output_object.items()]))
