...
def to_secret(bool1: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('config-grpc-no-jsonenc:index:toSecret', __args__, opts=opts, typ=ToSecretResult).value
...
def to_secret_output(bool1: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __args__['string3'] = string3
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('config-grpc-no-jsonenc:index:toSecret', __args__, opts=opts, typ=ToSecretResult)
