...
if not MYPY:
    class DataArgsDict(TypedDict):
        bool_array: pulumi.Input[Sequence[pulumi.Input[bool]]]
        boolean: pulumi.Input[bool]
        float: pulumi.Input[float]
        integer: pulumi.Input[int]
        string: pulumi.Input[str]
        string_map: pulumi.Input[Mapping[str, pulumi.Input[str]]]
elif False:
...
class DataArgs:
    ...
    def bool_array(self) -> pulumi.Input[Sequence[pulumi.Input[bool]]]:
        return pulumi.get(self, "bool_array")

    @bool_array.setter
    def bool_array(self, value: pulumi.Input[Sequence[pulumi.Input[bool]]]):
    ...
    def string_map(self) -> pulumi.Input[Mapping[str, pulumi.Input[str]]]:
        return pulumi.get(self, "string_map")

    @string_map.setter
    def string_map(self, value: pulumi.Input[Mapping[str, pulumi.Input[str]]]):
