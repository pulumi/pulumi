...
@pulumi.type_token("nestedcollections:elementType:ElementType")
class ElementType(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'ElementType':
        """
    ...
    def element_type(self) -> pulumi.Output[Optional['outputs.ElementType']]:
