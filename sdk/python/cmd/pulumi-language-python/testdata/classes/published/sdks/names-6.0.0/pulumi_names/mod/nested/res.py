...
@pulumi.type_token("names:mod/nested:Res")
class Res(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'names:mod/nested:Res', resource_name, id, __props__, opts or pulumi.ResourceOptions())
