...
class ExampleArgs:
    def __init__(__self__, *,
                 union_of: pulumi.Input[Optional[Union['Variant1Args', 'Variant2Args', 'Variant3Args', 'Variant4Args', 'Variant5Args', 'Variant6Args', 'Variant7Args', 'Variant8Args', 'Variant9Args', 'Variant10Args']]] = None):
        """
    ...
    def union_of(self) -> pulumi.Input[Optional[Union['Variant1Args', 'Variant2Args', 'Variant3Args', 'Variant4Args', 'Variant5Args', 'Variant6Args', 'Variant7Args', 'Variant8Args', 'Variant9Args', 'Variant10Args']]]:
        return pulumi.get(self, "union_of")

    @union_of.setter
    def union_of(self, value: pulumi.Input[Optional[Union['Variant1Args', 'Variant2Args', 'Variant3Args', 'Variant4Args', 'Variant5Args', 'Variant6Args', 'Variant7Args', 'Variant8Args', 'Variant9Args', 'Variant10Args']]]):
        pulumi.set(self, "union_of", value)


@pulumi.type_token("discriminated-union-many:index:Example")
class Example(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 union_of: pulumi.Input[Optional[Union[pulumi.InputType['Variant1Args'], pulumi.InputType['Variant2Args'], pulumi.InputType['Variant3Args'], pulumi.InputType['Variant4Args'], pulumi.InputType['Variant5Args'], pulumi.InputType['Variant6Args'], pulumi.InputType['Variant7Args'], pulumi.InputType['Variant8Args'], pulumi.InputType['Variant9Args'], pulumi.InputType['Variant10Args']]]] = None,
                 __props__=None):
        """
