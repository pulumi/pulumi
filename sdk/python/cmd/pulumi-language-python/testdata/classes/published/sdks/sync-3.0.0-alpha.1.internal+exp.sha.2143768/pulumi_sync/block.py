...
@pulumi.type_token("sync:index:Block")
class Block(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None) -> 'Block':
        """
    ...
    def exists(id: pulumi.Input[str],
        ...
        return pulumi.runtime.exists_resource(__inst__, 'sync:index:Block', id, __props__, opts or pulumi.ResourceOptions())
