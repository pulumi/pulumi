...
@pulumi.type_token("any-handled:index:Resource")
class Resource(pulumi.CustomResource):
    ...
    def exists(id: pulumi.Input[str],
        ...
        return pulumi.runtime.exists_resource(__inst__, 'any-handled:index:Resource', id, __props__, opts or pulumi.ResourceOptions())
