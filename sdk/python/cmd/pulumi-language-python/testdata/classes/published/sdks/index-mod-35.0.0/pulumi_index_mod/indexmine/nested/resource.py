...
@pulumi.type_token("index-mod:indexMine/nested:Resource")
class Resource(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'index-mod:indexMine/nested:Resource', resource_name, id, __props__, opts or pulumi.ResourceOptions())
    ...
    def call(__self__, *,
        ...
        return pulumi.runtime.call('index-mod:indexMine/nested:Resource/call', __args__, res=__self__, typ=Resource.CallResult)
