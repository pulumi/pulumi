...
@pulumi.type_token("componentreturnscalar:index:ComponentCallable")
class ComponentCallable(pulumi.ComponentResource):
    ...
    def _internal_init(__self__,
        ...
        super(ComponentCallable, __self__).__init__(
            'componentreturnscalar:index:ComponentCallable',
            resource_name,
            __props__,
            opts,
            remote=True)
    ...
    def identity(__self__) -> pulumi.Output['builtins.str']:
        """
        The `identity` method of the `ComponentCallable` component resource. Returns the component's `value` unaltered.
        """
        __args__ = dict()
        __args__['__self__'] = __self__
        return pulumi.runtime.call_single('componentreturnscalar:index:ComponentCallable/identity', __args__, res=__self__)

    def prefixed(__self__, *,
                 prefix: pulumi.Input[builtins.str]) -> pulumi.Output['builtins.str']:
        """
        ...
        return pulumi.runtime.call_single('componentreturnscalar:index:ComponentCallable/prefixed', __args__, res=__self__)
