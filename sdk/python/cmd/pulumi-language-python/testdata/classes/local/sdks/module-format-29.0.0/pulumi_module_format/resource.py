...
@pulumi.type_token("module-format:index_Resource:Resource")
class Resource(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'module-format:index_Resource:Resource', resource_name, id, __props__, opts or pulumi.ResourceOptions())
    ...
    def call(__self__, *,
        ...
        return pulumi.runtime.call('module-format:index_Resource:Resource/call', __args__, res=__self__, typ=Resource.CallResult)
