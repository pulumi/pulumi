...
@pulumi.type_token("output:index:Resource")
class Resource(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'output:index:Resource', resource_name, id, __props__, opts or pulumi.ResourceOptions())
