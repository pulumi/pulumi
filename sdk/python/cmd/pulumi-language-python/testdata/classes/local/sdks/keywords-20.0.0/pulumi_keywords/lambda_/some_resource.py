...
@pulumi.type_token("keywords:lambda:SomeResource")
class SomeResource(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'keywords:lambda:SomeResource', resource_name, id, __props__, opts or pulumi.ResourceOptions())
