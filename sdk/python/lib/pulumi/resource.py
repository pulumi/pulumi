...
class ResourceOptions:
    ...
    def __init__(
        ...
        :param Optional[List[StateMigration]] state_migrations: If provided, a list of state migrations to apply to
               ...
               Callback state includes plaintext secret values. Migration callbacks must not call operations that
               register resources or outputs, invoke or call providers, or register transforms, hooks, or packages,
               because the resource monitor is waiting for the callback. They must retain the prior root under its
               registered URN or prior alias and return provider resource states unchanged. This API is experimental.
        """
