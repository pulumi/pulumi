...
class StateMigrationArgs:
    """
    StateMigrationArgs are the arguments passed to a state migration callback. It carries the
...
class ResourceOptions:
    ...
    """
    Optional list of state migrations to apply. The migrations are applied in order, each receiving the previous one's
    output. See `StateMigration` for the callback contract and safety restrictions. """
    ...
    def __init__(
        ...
        :param Optional[List[StateMigration]] state_migrations: Optional list of state migrations to apply. The
                migrations are applied in order, each receiving the previous one's output. See `StateMigration` for
                the callback contract and safety restrictions.
        """
