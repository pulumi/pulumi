...
class StateMigrationEvent(BaseEvent):
    ...
    :param migrated: The number of prior resources that were handed to the migrations.
    :param added: The URNs of state entries introduced by the migration.
    :param removed: The URNs that were removed from the state (renames as well as forgets).
    :param unmanaged: The subset of removed whose resources' identities left the state entirely:
        the underlying cloud resources are no longer managed by Pulumi. They are NOT deleted.
    """
    ...
    def __init__(
        ...
        unmanaged: Optional[list[str]] = None,
    ):
        self.urn = urn
