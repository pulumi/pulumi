...
from .serializer import PropertyValueSerializer
...
class ComponentProvider(Provider):
    ...
    async def construct(
        ...
        inputs = serializer.deserialize_map(request.inputs)
        ...
        state = serializer.serialize_map(self.get_state(comp_instance, component_def))
