...
import pulumi.provider.experimental.new_provider as new_provider
...
class ProviderServicer(ResourceProviderServicer):
    ...
    _version: str
    _args: List[str]
    _provider: new_provider.Provider
    _engine_address: str
    _lock: asyncio.Lock
    ...
    def _construct_response(
        self, result: new_provider.ConstructResponse
    ) -> proto.ConstructResponse:
    ...
    async def _call(self, request: proto.CallRequest, context):
        ...
        result = await self._provider.call(
            new_provider.CallRequest(tok=request.tok, args=args)
        )
    ...
    async def _call_response(
        self, result: new_provider.CallResponse
    ) -> proto.CallResponse:
    ...
    async def Diff(self, request: proto.DiffRequest, context):
        ...
        tokind = {
            new_provider.PropertyDiffKind.ADD: proto.PropertyDiff.ADD,
            new_provider.PropertyDiffKind.ADD_REPLACE: proto.PropertyDiff.ADD_REPLACE,
            new_provider.PropertyDiffKind.DELETE: proto.PropertyDiff.DELETE,
            new_provider.PropertyDiffKind.DELETE_REPLACE: proto.PropertyDiff.DELETE_REPLACE,
            new_provider.PropertyDiffKind.UPDATE: proto.PropertyDiff.UPDATE,
            new_provider.PropertyDiffKind.UPDATE_REPLACE: proto.PropertyDiff.UPDATE_REPLACE,
        }
...
def main(args: List[str], version: str, provider: new_provider.Provider) -> None:
