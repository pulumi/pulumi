...
class EngineStub(object):
    ...
    def __init__(self, channel):
        ...
        self.About = channel.unary_unary(
                ...
                request_serializer=pulumi_dot_engine_dot_engine__pb2.AboutRequest.SerializeToString,
                response_deserializer=pulumi_dot_engine_dot_engine__pb2.AboutResponse.FromString,
                )
...
def add_EngineServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'About': grpc.unary_unary_rpc_method_handler(
                    servicer.About,
                    request_deserializer=pulumi_dot_engine_dot_engine__pb2.AboutRequest.FromString,
                    response_serializer=pulumi_dot_engine_dot_engine__pb2.AboutResponse.SerializeToString,
            ),
    }
...
class Engine(object):
    ...
    def About(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/pulumirpc.engine.Engine/About',
            pulumi_dot_engine_dot_engine__pb2.AboutRequest.SerializeToString,
            pulumi_dot_engine_dot_engine__pb2.AboutResponse.FromString,
