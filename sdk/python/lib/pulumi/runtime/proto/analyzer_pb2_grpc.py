...
class AnalyzerServicer(object):
    ...
    def TransformStack(self, request, context):
...
class Analyzer(object):
    ...
    def Transform(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pulumirpc.Analyzer/Transform',
            pulumi_dot_analyzer__pb2.AnalyzeRequest.SerializeToString,
