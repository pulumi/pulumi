...
class LanguageRuntimeStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Start = channel.unary_stream(
        '/pulumirpc.LanguageRuntime/Start',
        request_serializer=language__pb2.StartRequest.SerializeToString,
        response_deserializer=language__pb2.StartResponse.FromString,
        )
...
def add_LanguageRuntimeServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'Start': grpc.unary_stream_rpc_method_handler(
          servicer.Start,
          request_deserializer=language__pb2.StartRequest.FromString,
          response_serializer=language__pb2.StartResponse.SerializeToString,
      ),
  }
