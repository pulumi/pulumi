...
class RunRequest(google.protobuf.message.Message):
    ...
    START_DEBUGGER_FIELD_NUMBER: builtins.int
    project: builtins.str
    """the project name."""
    stack: builtins.str
