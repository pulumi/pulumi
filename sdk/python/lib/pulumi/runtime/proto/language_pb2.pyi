...
class InstallDependenciesRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["info", b"info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["directory", b"directory", "info", b"info", "is_plugin", b"is_plugin", "is_terminal", b"is_terminal", "use_language_version_tools", b"use_language_version_tools"]) -> None: ...
