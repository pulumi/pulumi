...
_STARTREQUEST = _descriptor.Descriptor(
    name="StartRequest",
    full_name="pulumirpc.StartRequest",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="pwd",
            full_name="pulumirpc.StartRequest.pwd",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="program",
            full_name="pulumirpc.StartRequest.program",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="args",
            full_name="pulumirpc.StartRequest.args",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="env",
            full_name="pulumirpc.StartRequest.env",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
...
_STARTRESPONSE = _descriptor.Descriptor(
    name="StartResponse",
    full_name="pulumirpc.StartResponse",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="stdout",
            full_name="pulumirpc.StartResponse.stdout",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="stderr",
            full_name="pulumirpc.StartResponse.stderr",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="exitcode",
            full_name="pulumirpc.StartResponse.exitcode",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
StartRequest = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "language_pb2"
        # @@protoc_insertion_point(class_scope:pulumirpc.StartRequest)
    },
)
...
StartResponse = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "language_pb2"
        # @@protoc_insertion_point(class_scope:pulumirpc.StartResponse)
    },
)
...
_LANGUAGERUNTIME = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            name="Start",
            full_name="pulumirpc.LanguageRuntime.Start",
            index=3,
            containing_service=None,
