...
_CHECKREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="entropy",
            full_name="pulumirpc.CheckRequest.entropy",
            index=4,
            number=5,
            type=12,
            cpp_type=9,
