...
class RunLanguageTestRequest(google.protobuf.message.Message):
    ...
    SKIP_CONVERT_TESTS_FIELD_NUMBER: builtins.int
    token: builtins.str
    test: builtins.str
    skip_convert_tests: builtins.bool
    ...
    def ClearField(self, field_name: typing.Literal["skip_convert_tests", b"skip_convert_tests", "test", b"test", "token", b"token"]) -> None: ...
