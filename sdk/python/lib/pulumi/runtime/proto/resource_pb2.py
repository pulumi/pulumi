...
_DELETEBEHAVIOUR = _descriptor.EnumDescriptor(
  name='DeleteBehaviour',
  full_name='pulumirpc.DeleteBehaviour',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_sym_db.RegisterEnumDescriptor(_DELETEBEHAVIOUR)

DeleteBehaviour = enum_type_wrapper.EnumTypeWrapper(_DELETEBEHAVIOUR)
DELETE = 0
DROP = 1
PROTECT = 2
...
_REGISTERRESOURCEREQUEST.fields_by_name['deleteBehaviour'].enum_type = _DELETEBEHAVIOUR
...
DESCRIPTOR.enum_types_by_name['DeleteBehaviour'] = _DELETEBEHAVIOUR
