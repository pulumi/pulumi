...
_REGISTERRESOURCEREQUEST_PROPERTYDEPENDENCIES = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='urn', full_name='pulumirpc.RegisterResourceRequest.PropertyDependencies.urn', index=0,
