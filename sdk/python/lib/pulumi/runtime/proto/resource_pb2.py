...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _REGISTERRESOURCEREQUEST.fields_by_name['aliases']._options = None
  _REGISTERRESOURCEREQUEST.fields_by_name['aliases']._serialized_options = b'\030\001'
