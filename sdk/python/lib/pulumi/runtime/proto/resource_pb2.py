...
_ALIAS_SMARTALIAS = _descriptor.Descriptor(
  name='SmartAlias',
  full_name='pulumirpc.Alias.SmartAlias',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='pulumirpc.Alias.SmartAlias.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='pulumirpc.Alias.SmartAlias.type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stack', full_name='pulumirpc.Alias.SmartAlias.stack', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='project', full_name='pulumirpc.Alias.SmartAlias.project', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='parentUrn', full_name='pulumirpc.Alias.SmartAlias.parentUrn', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='noParent', full_name='pulumirpc.Alias.SmartAlias.noParent', index=5,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='parent', full_name='pulumirpc.Alias.SmartAlias.parent',
...
_ALIAS = _descriptor.Descriptor(
  name='Alias',
  full_name='pulumirpc.Alias',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='urn', full_name='pulumirpc.Alias.urn', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='smartAlias', full_name='pulumirpc.Alias.smartAlias', index=1,
  ...
  nested_types=[_ALIAS_SMARTALIAS, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='alias', full_name='pulumirpc.Alias.alias',
      index=0, containing_type=None, fields=[]),
  ],
...
_READRESOURCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pluginDownloadURL', full_name='pulumirpc.ReadResourceRequest.pluginDownloadURL', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='smartAliases', full_name='pulumirpc.ReadResourceRequest.smartAliases', index=13,
...
_REGISTERRESOURCEREQUEST_PROVIDERSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='pulumirpc.RegisterResourceRequest.ProvidersEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='pulumirpc.RegisterResourceRequest.ProvidersEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REGISTERRESOURCEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='providers', full_name='pulumirpc.RegisterResourceRequest.providers', index=21,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pluginDownloadURL', full_name='pulumirpc.RegisterResourceRequest.pluginDownloadURL', index=23,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='retainOnDelete', full_name='pulumirpc.RegisterResourceRequest.retainOnDelete', index=24,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='smartAliases', full_name='pulumirpc.RegisterResourceRequest.smartAliases', index=25,
  ...
  nested_types=[_REGISTERRESOURCEREQUEST_PROPERTYDEPENDENCIES, _REGISTERRESOURCEREQUEST_CUSTOMTIMEOUTS, _REGISTERRESOURCEREQUEST_PROPERTYDEPENDENCIESENTRY, _REGISTERRESOURCEREQUEST_PROVIDERSENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_RESOURCEINVOKEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tok', full_name='pulumirpc.ResourceInvokeRequest.tok', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='args', full_name='pulumirpc.ResourceInvokeRequest.args', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='provider', full_name='pulumirpc.ResourceInvokeRequest.provider', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='pulumirpc.ResourceInvokeRequest.version', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='acceptResources', full_name='pulumirpc.ResourceInvokeRequest.acceptResources', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pluginDownloadURL', full_name='pulumirpc.ResourceInvokeRequest.pluginDownloadURL', index=5,
...
_ALIAS_SMARTALIAS.containing_type = _ALIAS
_ALIAS_SMARTALIAS.oneofs_by_name['parent'].fields.append(
  _ALIAS_SMARTALIAS.fields_by_name['parentUrn'])
_ALIAS_SMARTALIAS.fields_by_name['parentUrn'].containing_oneof = _ALIAS_SMARTALIAS.oneofs_by_name['parent']
_ALIAS_SMARTALIAS.oneofs_by_name['parent'].fields.append(
  _ALIAS_SMARTALIAS.fields_by_name['noParent'])
_ALIAS_SMARTALIAS.fields_by_name['noParent'].containing_oneof = _ALIAS_SMARTALIAS.oneofs_by_name['parent']
_ALIAS.fields_by_name['smartAlias'].message_type = _ALIAS_SMARTALIAS
_ALIAS.oneofs_by_name['alias'].fields.append(
  _ALIAS.fields_by_name['urn'])
_ALIAS.fields_by_name['urn'].containing_oneof = _ALIAS.oneofs_by_name['alias']
_ALIAS.oneofs_by_name['alias'].fields.append(
  _ALIAS.fields_by_name['smartAlias'])
_ALIAS.fields_by_name['smartAlias'].containing_oneof = _ALIAS.oneofs_by_name['alias']
_READRESOURCEREQUEST.fields_by_name['properties'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
_READRESOURCEREQUEST.fields_by_name['smartAliases'].message_type = _ALIAS
...
_REGISTERRESOURCEREQUEST.fields_by_name['providers'].message_type = _REGISTERRESOURCEREQUEST_PROVIDERSENTRY
_REGISTERRESOURCEREQUEST.fields_by_name['smartAliases'].message_type = _ALIAS
...
_RESOURCEINVOKEREQUEST.fields_by_name['args'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
...
Alias = _reflection.GeneratedProtocolMessageType('Alias', (_message.Message,), {
  ...
  'SmartAlias' : _reflection.GeneratedProtocolMessageType('SmartAlias', (_message.Message,), {
    'DESCRIPTOR' : _ALIAS_SMARTALIAS,
    '__module__' : 'resource_pb2'
    # @@protoc_insertion_point(class_scope:pulumirpc.Alias.SmartAlias)
    })
  ,
  'DESCRIPTOR' : _ALIAS,
  '__module__' : 'resource_pb2'
...
_sym_db.RegisterMessage(Alias.SmartAlias)
