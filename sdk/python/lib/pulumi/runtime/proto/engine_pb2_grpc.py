...
class EngineStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StartDebugger = channel.unary_unary(
                ...
                response_deserializer=pulumi_dot_engine__pb2.StartDebuggerResponse.FromString,
                )
...
def add_EngineServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'StartDebugger': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=pulumi_dot_engine__pb2.StartDebuggerResponse.SerializeToString,
            ),
    }
...
class Engine(object):
    ...
    def StartDebugger(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/pulumirpc.Engine/StartDebugger',
            ...
            pulumi_dot_engine__pb2.StartDebuggerResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
