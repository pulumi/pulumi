...
_PLUGININFO = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="version",
            full_name="pulumirpc.PluginInfo.version",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_PLUGINDEPENDENCY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="pulumirpc.PluginDependency.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="kind",
            full_name="pulumirpc.PluginDependency.kind",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="version",
            full_name="pulumirpc.PluginDependency.version",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="server",
            full_name="pulumirpc.PluginDependency.server",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
...
PluginDependency = _reflection.GeneratedProtocolMessageType(
    "PluginDependency",
    (_message.Message,),
    {
