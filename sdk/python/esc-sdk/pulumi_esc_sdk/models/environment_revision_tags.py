...
class EnvironmentRevisionTags(BaseModel):
    """
    EnvironmentRevisionTags
    """ # noqa: E501
    tags: Optional[List[EnvironmentRevisionTag]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags": [EnvironmentRevisionTag.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None,
