...
namespace Pulumirpc {
  ...
  public static partial class LanguageRuntime
  {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, LanguageRuntimeBase serviceImpl)
    {
      serviceBinder.AddMethod(__Method_GetRequiredPlugins, serviceImpl.GetRequiredPlugins);
