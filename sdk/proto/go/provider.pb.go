...
var file_pulumi_provider_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x32, 0xd9, 0x0a, 0x0a, 0x10,
...
var file_pulumi_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 49)
var file_pulumi_provider_proto_goTypes = []interface{}{
	...
	nil,                                          // 39: pulumirpc.CallRequest.PluginChecksumsEntry
	nil,                                          // 40: pulumirpc.CallRequest.ConfigEntry
	(*CallResponse_ReturnDependencies)(nil),      // 41: pulumirpc.CallResponse.ReturnDependencies
	nil,                                          // 42: pulumirpc.CallResponse.ReturnDependenciesEntry
	nil,                                          // 43: pulumirpc.DiffResponse.DetailedDiffEntry
	(*ConstructRequest_PropertyDependencies)(nil), // 44: pulumirpc.ConstructRequest.PropertyDependencies
	(*ConstructRequest_CustomTimeouts)(nil),       // 45: pulumirpc.ConstructRequest.CustomTimeouts
	nil,                                           // 46: pulumirpc.ConstructRequest.ConfigEntry
	nil,                                           // 47: pulumirpc.ConstructRequest.InputDependenciesEntry
	nil,                                           // 48: pulumirpc.ConstructRequest.ProvidersEntry
	(*ConstructResponse_PropertyDependencies)(nil), // 49: pulumirpc.ConstructResponse.PropertyDependencies
	nil,                     // 50: pulumirpc.ConstructResponse.StateDependenciesEntry
	(*structpb.Struct)(nil), // 51: google.protobuf.Struct
	(*SourcePosition)(nil),  // 52: pulumirpc.SourcePosition
	(*structpb.Value)(nil),  // 53: google.protobuf.Value
	(*emptypb.Empty)(nil),   // 54: google.protobuf.Empty
	(*PluginAttach)(nil),    // 55: pulumirpc.PluginAttach
	(*PluginInfo)(nil),      // 56: pulumirpc.PluginInfo
}
var file_pulumi_provider_proto_depIdxs = []int32{
	...
	51, // 3: pulumirpc.ConfigureRequest.args:type_name -> google.protobuf.Struct
	36, // 4: pulumirpc.ConfigureErrorMissingKeys.missingKeys:type_name -> pulumirpc.ConfigureErrorMissingKeys.MissingKey
	51, // 5: pulumirpc.InvokeRequest.args:type_name -> google.protobuf.Struct
	51, // 6: pulumirpc.InvokeResponse.return:type_name -> google.protobuf.Struct
	15, // 7: pulumirpc.InvokeResponse.failures:type_name -> pulumirpc.CheckFailure
	51, // 8: pulumirpc.CallRequest.args:type_name -> google.protobuf.Struct
	38, // 9: pulumirpc.CallRequest.argDependencies:type_name -> pulumirpc.CallRequest.ArgDependenciesEntry
	39, // 10: pulumirpc.CallRequest.pluginChecksums:type_name -> pulumirpc.CallRequest.PluginChecksumsEntry
	40, // 11: pulumirpc.CallRequest.config:type_name -> pulumirpc.CallRequest.ConfigEntry
	52, // 12: pulumirpc.CallRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	51, // 13: pulumirpc.CallResponse.return:type_name -> google.protobuf.Struct
	42, // 14: pulumirpc.CallResponse.returnDependencies:type_name -> pulumirpc.CallResponse.ReturnDependenciesEntry
	15, // 15: pulumirpc.CallResponse.failures:type_name -> pulumirpc.CheckFailure
	51, // 16: pulumirpc.CheckRequest.olds:type_name -> google.protobuf.Struct
	51, // 17: pulumirpc.CheckRequest.news:type_name -> google.protobuf.Struct
	51, // 18: pulumirpc.CheckResponse.inputs:type_name -> google.protobuf.Struct
	15, // 19: pulumirpc.CheckResponse.failures:type_name -> pulumirpc.CheckFailure
	51, // 20: pulumirpc.DiffRequest.olds:type_name -> google.protobuf.Struct
	51, // 21: pulumirpc.DiffRequest.news:type_name -> google.protobuf.Struct
	51, // 22: pulumirpc.DiffRequest.old_inputs:type_name -> google.protobuf.Struct
	0,  // 23: pulumirpc.PropertyDiff.kind:type_name -> pulumirpc.PropertyDiff.Kind
	1,  // 24: pulumirpc.DiffResponse.changes:type_name -> pulumirpc.DiffResponse.DiffChanges
	43, // 25: pulumirpc.DiffResponse.detailedDiff:type_name -> pulumirpc.DiffResponse.DetailedDiffEntry
	51, // 26: pulumirpc.CreateRequest.properties:type_name -> google.protobuf.Struct
	51, // 27: pulumirpc.CreateResponse.properties:type_name -> google.protobuf.Struct
	51, // 28: pulumirpc.ReadRequest.properties:type_name -> google.protobuf.Struct
	51, // 29: pulumirpc.ReadRequest.inputs:type_name -> google.protobuf.Struct
	51, // 30: pulumirpc.ReadResponse.properties:type_name -> google.protobuf.Struct
	51, // 31: pulumirpc.ReadResponse.inputs:type_name -> google.protobuf.Struct
	51, // 32: pulumirpc.UpdateRequest.olds:type_name -> google.protobuf.Struct
	51, // 33: pulumirpc.UpdateRequest.news:type_name -> google.protobuf.Struct
	51, // 34: pulumirpc.UpdateRequest.old_inputs:type_name -> google.protobuf.Struct
	51, // 35: pulumirpc.UpdateResponse.properties:type_name -> google.protobuf.Struct
	51, // 36: pulumirpc.DeleteRequest.properties:type_name -> google.protobuf.Struct
	51, // 37: pulumirpc.DeleteRequest.old_inputs:type_name -> google.protobuf.Struct
	46, // 38: pulumirpc.ConstructRequest.config:type_name -> pulumirpc.ConstructRequest.ConfigEntry
	51, // 39: pulumirpc.ConstructRequest.inputs:type_name -> google.protobuf.Struct
	47, // 40: pulumirpc.ConstructRequest.inputDependencies:type_name -> pulumirpc.ConstructRequest.InputDependenciesEntry
	48, // 41: pulumirpc.ConstructRequest.providers:type_name -> pulumirpc.ConstructRequest.ProvidersEntry
	45, // 42: pulumirpc.ConstructRequest.customTimeouts:type_name -> pulumirpc.ConstructRequest.CustomTimeouts
	51, // 43: pulumirpc.ConstructResponse.state:type_name -> google.protobuf.Struct
	50, // 44: pulumirpc.ConstructResponse.stateDependencies:type_name -> pulumirpc.ConstructResponse.StateDependenciesEntry
	51, // 45: pulumirpc.ErrorResourceInitFailed.properties:type_name -> google.protobuf.Struct
	51, // 46: pulumirpc.ErrorResourceInitFailed.inputs:type_name -> google.protobuf.Struct
	53, // 47: pulumirpc.ParameterizeRequest.ParametersValue.value:type_name -> google.protobuf.Value
	37, // 48: pulumirpc.CallRequest.ArgDependenciesEntry.value:type_name -> pulumirpc.CallRequest.ArgumentDependencies
	41, // 49: pulumirpc.CallResponse.ReturnDependenciesEntry.value:type_name -> pulumirpc.CallResponse.ReturnDependencies
	17, // 50: pulumirpc.DiffResponse.DetailedDiffEntry.value:type_name -> pulumirpc.PropertyDiff
	44, // 51: pulumirpc.ConstructRequest.InputDependenciesEntry.value:type_name -> pulumirpc.ConstructRequest.PropertyDependencies
	49, // 52: pulumirpc.ConstructResponse.StateDependenciesEntry.value:type_name -> pulumirpc.ConstructResponse.PropertyDependencies
	2,  // 53: pulumirpc.ResourceProvider.Parameterize:input_type -> pulumirpc.ParameterizeRequest
	4,  // 54: pulumirpc.ResourceProvider.GetSchema:input_type -> pulumirpc.GetSchemaRequest
	13, // 55: pulumirpc.ResourceProvider.CheckConfig:input_type -> pulumirpc.CheckRequest
	16, // 56: pulumirpc.ResourceProvider.DiffConfig:input_type -> pulumirpc.DiffRequest
	6,  // 57: pulumirpc.ResourceProvider.Configure:input_type -> pulumirpc.ConfigureRequest
	9,  // 58: pulumirpc.ResourceProvider.Invoke:input_type -> pulumirpc.InvokeRequest
	9,  // 59: pulumirpc.ResourceProvider.StreamInvoke:input_type -> pulumirpc.InvokeRequest
	11, // 60: pulumirpc.ResourceProvider.Call:input_type -> pulumirpc.CallRequest
	13, // 61: pulumirpc.ResourceProvider.Check:input_type -> pulumirpc.CheckRequest
	16, // 62: pulumirpc.ResourceProvider.Diff:input_type -> pulumirpc.DiffRequest
	19, // 63: pulumirpc.ResourceProvider.Create:input_type -> pulumirpc.CreateRequest
	21, // 64: pulumirpc.ResourceProvider.Read:input_type -> pulumirpc.ReadRequest
	23, // 65: pulumirpc.ResourceProvider.Update:input_type -> pulumirpc.UpdateRequest
	25, // 66: pulumirpc.ResourceProvider.Delete:input_type -> pulumirpc.DeleteRequest
	26, // 67: pulumirpc.ResourceProvider.Construct:input_type -> pulumirpc.ConstructRequest
	54, // 68: pulumirpc.ResourceProvider.Cancel:input_type -> google.protobuf.Empty
	54, // 69: pulumirpc.ResourceProvider.GetPluginInfo:input_type -> google.protobuf.Empty
	55, // 70: pulumirpc.ResourceProvider.Attach:input_type -> pulumirpc.PluginAttach
	29, // 71: pulumirpc.ResourceProvider.GetMapping:input_type -> pulumirpc.GetMappingRequest
	31, // 72: pulumirpc.ResourceProvider.GetMappings:input_type -> pulumirpc.GetMappingsRequest
	3,  // 73: pulumirpc.ResourceProvider.Parameterize:output_type -> pulumirpc.ParameterizeResponse
	5,  // 74: pulumirpc.ResourceProvider.GetSchema:output_type -> pulumirpc.GetSchemaResponse
	14, // 75: pulumirpc.ResourceProvider.CheckConfig:output_type -> pulumirpc.CheckResponse
	18, // 76: pulumirpc.ResourceProvider.DiffConfig:output_type -> pulumirpc.DiffResponse
	7,  // 77: pulumirpc.ResourceProvider.Configure:output_type -> pulumirpc.ConfigureResponse
	10, // 78: pulumirpc.ResourceProvider.Invoke:output_type -> pulumirpc.InvokeResponse
	10, // 79: pulumirpc.ResourceProvider.StreamInvoke:output_type -> pulumirpc.InvokeResponse
	12, // 80: pulumirpc.ResourceProvider.Call:output_type -> pulumirpc.CallResponse
	14, // 81: pulumirpc.ResourceProvider.Check:output_type -> pulumirpc.CheckResponse
	18, // 82: pulumirpc.ResourceProvider.Diff:output_type -> pulumirpc.DiffResponse
	20, // 83: pulumirpc.ResourceProvider.Create:output_type -> pulumirpc.CreateResponse
	22, // 84: pulumirpc.ResourceProvider.Read:output_type -> pulumirpc.ReadResponse
	24, // 85: pulumirpc.ResourceProvider.Update:output_type -> pulumirpc.UpdateResponse
	54, // 86: pulumirpc.ResourceProvider.Delete:output_type -> google.protobuf.Empty
	27, // 87: pulumirpc.ResourceProvider.Construct:output_type -> pulumirpc.ConstructResponse
	54, // 88: pulumirpc.ResourceProvider.Cancel:output_type -> google.protobuf.Empty
	56, // 89: pulumirpc.ResourceProvider.GetPluginInfo:output_type -> pulumirpc.PluginInfo
	54, // 90: pulumirpc.ResourceProvider.Attach:output_type -> google.protobuf.Empty
	30, // 91: pulumirpc.ResourceProvider.GetMapping:output_type -> pulumirpc.GetMappingResponse
	32, // 92: pulumirpc.ResourceProvider.GetMappings:output_type -> pulumirpc.GetMappingsResponse
