...
var file_pulumi_provider_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x32, 0xea, 0x0a, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x6f, 0x75,
...
var file_pulumi_provider_proto_depIdxs = []int32{
	...
	14, // 59: pulumirpc.ResourceProvider.Call:input_type -> pulumirpc.CallRequest
	16, // 60: pulumirpc.ResourceProvider.Check:input_type -> pulumirpc.CheckRequest
	19, // 61: pulumirpc.ResourceProvider.Diff:input_type -> pulumirpc.DiffRequest
	22, // 62: pulumirpc.ResourceProvider.Create:input_type -> pulumirpc.CreateRequest
	24, // 63: pulumirpc.ResourceProvider.Read:input_type -> pulumirpc.ReadRequest
	26, // 64: pulumirpc.ResourceProvider.Update:input_type -> pulumirpc.UpdateRequest
	28, // 65: pulumirpc.ResourceProvider.Delete:input_type -> pulumirpc.DeleteRequest
	29, // 66: pulumirpc.ResourceProvider.Construct:input_type -> pulumirpc.ConstructRequest
	55, // 67: pulumirpc.ResourceProvider.Cancel:input_type -> google.protobuf.Empty
	55, // 68: pulumirpc.ResourceProvider.GetPluginInfo:input_type -> google.protobuf.Empty
	56, // 69: pulumirpc.ResourceProvider.Attach:input_type -> pulumirpc.PluginAttach
	32, // 70: pulumirpc.ResourceProvider.GetMapping:input_type -> pulumirpc.GetMappingRequest
	34, // 71: pulumirpc.ResourceProvider.GetMappings:input_type -> pulumirpc.GetMappingsRequest
	4,  // 72: pulumirpc.ResourceProvider.Handshake:output_type -> pulumirpc.ProviderHandshakeResponse
	6,  // 73: pulumirpc.ResourceProvider.Parameterize:output_type -> pulumirpc.ParameterizeResponse
	8,  // 74: pulumirpc.ResourceProvider.GetSchema:output_type -> pulumirpc.GetSchemaResponse
	17, // 75: pulumirpc.ResourceProvider.CheckConfig:output_type -> pulumirpc.CheckResponse
	21, // 76: pulumirpc.ResourceProvider.DiffConfig:output_type -> pulumirpc.DiffResponse
	10, // 77: pulumirpc.ResourceProvider.Configure:output_type -> pulumirpc.ConfigureResponse
	13, // 78: pulumirpc.ResourceProvider.Invoke:output_type -> pulumirpc.InvokeResponse
	15, // 79: pulumirpc.ResourceProvider.Call:output_type -> pulumirpc.CallResponse
	17, // 80: pulumirpc.ResourceProvider.Check:output_type -> pulumirpc.CheckResponse
	21, // 81: pulumirpc.ResourceProvider.Diff:output_type -> pulumirpc.DiffResponse
	23, // 82: pulumirpc.ResourceProvider.Create:output_type -> pulumirpc.CreateResponse
	25, // 83: pulumirpc.ResourceProvider.Read:output_type -> pulumirpc.ReadResponse
	27, // 84: pulumirpc.ResourceProvider.Update:output_type -> pulumirpc.UpdateResponse
	55, // 85: pulumirpc.ResourceProvider.Delete:output_type -> google.protobuf.Empty
	30, // 86: pulumirpc.ResourceProvider.Construct:output_type -> pulumirpc.ConstructResponse
	55, // 87: pulumirpc.ResourceProvider.Cancel:output_type -> google.protobuf.Empty
	57, // 88: pulumirpc.ResourceProvider.GetPluginInfo:output_type -> pulumirpc.PluginInfo
	55, // 89: pulumirpc.ResourceProvider.Attach:output_type -> google.protobuf.Empty
	33, // 90: pulumirpc.ResourceProvider.GetMapping:output_type -> pulumirpc.GetMappingResponse
	35, // 91: pulumirpc.ResourceProvider.GetMappings:output_type -> pulumirpc.GetMappingsResponse
