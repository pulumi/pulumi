...
var file_pulumi_provider_proto_rawDesc = []byte{
	...
	0x32, 0x17, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x06, 0x69, 0x6e, 0x70, 0x75, 0x74,
	0x73, 0x22, 0x25, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x44, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x4d,
	...
	0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xb6,
	0x09, 0x0a, 0x10, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x76, 0x69,
...
var file_pulumi_provider_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_pulumi_provider_proto_goTypes = []interface{}{
	...
	nil,                                          // 33: pulumirpc.CallRequest.PluginChecksumsEntry
	nil,                                          // 34: pulumirpc.CallRequest.ConfigEntry
	(*CallResponse_ReturnDependencies)(nil),      // 35: pulumirpc.CallResponse.ReturnDependencies
	nil,                                          // 36: pulumirpc.CallResponse.ReturnDependenciesEntry
	nil,                                          // 37: pulumirpc.DiffResponse.DetailedDiffEntry
	(*ConstructRequest_PropertyDependencies)(nil), // 38: pulumirpc.ConstructRequest.PropertyDependencies
	(*ConstructRequest_CustomTimeouts)(nil),       // 39: pulumirpc.ConstructRequest.CustomTimeouts
	nil,                                           // 40: pulumirpc.ConstructRequest.ConfigEntry
	nil,                                           // 41: pulumirpc.ConstructRequest.InputDependenciesEntry
	nil,                                           // 42: pulumirpc.ConstructRequest.ProvidersEntry
	(*ConstructResponse_PropertyDependencies)(nil), // 43: pulumirpc.ConstructResponse.PropertyDependencies
	nil,                     // 44: pulumirpc.ConstructResponse.StateDependenciesEntry
	(*structpb.Struct)(nil), // 45: google.protobuf.Struct
	(*SourcePosition)(nil),  // 46: pulumirpc.SourcePosition
...
var file_pulumi_provider_proto_depIdxs = []int32{
	...
	45, // 1: pulumirpc.ConfigureRequest.args:type_name -> google.protobuf.Struct
	30, // 2: pulumirpc.ConfigureErrorMissingKeys.missingKeys:type_name -> pulumirpc.ConfigureErrorMissingKeys.MissingKey
	45, // 3: pulumirpc.InvokeRequest.args:type_name -> google.protobuf.Struct
	45, // 4: pulumirpc.InvokeResponse.return:type_name -> google.protobuf.Struct
	13, // 5: pulumirpc.InvokeResponse.failures:type_name -> pulumirpc.CheckFailure
	45, // 6: pulumirpc.CallRequest.args:type_name -> google.protobuf.Struct
	32, // 7: pulumirpc.CallRequest.argDependencies:type_name -> pulumirpc.CallRequest.ArgDependenciesEntry
	33, // 8: pulumirpc.CallRequest.pluginChecksums:type_name -> pulumirpc.CallRequest.PluginChecksumsEntry
	34, // 9: pulumirpc.CallRequest.config:type_name -> pulumirpc.CallRequest.ConfigEntry
	46, // 10: pulumirpc.CallRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	45, // 11: pulumirpc.CallResponse.return:type_name -> google.protobuf.Struct
	36, // 12: pulumirpc.CallResponse.returnDependencies:type_name -> pulumirpc.CallResponse.ReturnDependenciesEntry
	13, // 13: pulumirpc.CallResponse.failures:type_name -> pulumirpc.CheckFailure
	45, // 14: pulumirpc.CheckRequest.olds:type_name -> google.protobuf.Struct
	45, // 15: pulumirpc.CheckRequest.news:type_name -> google.protobuf.Struct
	45, // 16: pulumirpc.CheckResponse.inputs:type_name -> google.protobuf.Struct
	13, // 17: pulumirpc.CheckResponse.failures:type_name -> pulumirpc.CheckFailure
	45, // 18: pulumirpc.DiffRequest.olds:type_name -> google.protobuf.Struct
	45, // 19: pulumirpc.DiffRequest.news:type_name -> google.protobuf.Struct
	45, // 20: pulumirpc.DiffRequest.old_inputs:type_name -> google.protobuf.Struct
	...
	37, // 23: pulumirpc.DiffResponse.detailedDiff:type_name -> pulumirpc.DiffResponse.DetailedDiffEntry
	45, // 24: pulumirpc.CreateRequest.properties:type_name -> google.protobuf.Struct
	45, // 25: pulumirpc.CreateResponse.properties:type_name -> google.protobuf.Struct
	45, // 26: pulumirpc.ReadRequest.properties:type_name -> google.protobuf.Struct
	45, // 27: pulumirpc.ReadRequest.inputs:type_name -> google.protobuf.Struct
	45, // 28: pulumirpc.ReadResponse.properties:type_name -> google.protobuf.Struct
	45, // 29: pulumirpc.ReadResponse.inputs:type_name -> google.protobuf.Struct
	45, // 30: pulumirpc.UpdateRequest.olds:type_name -> google.protobuf.Struct
	45, // 31: pulumirpc.UpdateRequest.news:type_name -> google.protobuf.Struct
	45, // 32: pulumirpc.UpdateRequest.old_inputs:type_name -> google.protobuf.Struct
	45, // 33: pulumirpc.UpdateResponse.properties:type_name -> google.protobuf.Struct
	45, // 34: pulumirpc.DeleteRequest.properties:type_name -> google.protobuf.Struct
	40, // 35: pulumirpc.ConstructRequest.config:type_name -> pulumirpc.ConstructRequest.ConfigEntry
	45, // 36: pulumirpc.ConstructRequest.inputs:type_name -> google.protobuf.Struct
	41, // 37: pulumirpc.ConstructRequest.inputDependencies:type_name -> pulumirpc.ConstructRequest.InputDependenciesEntry
	42, // 38: pulumirpc.ConstructRequest.providers:type_name -> pulumirpc.ConstructRequest.ProvidersEntry
	39, // 39: pulumirpc.ConstructRequest.customTimeouts:type_name -> pulumirpc.ConstructRequest.CustomTimeouts
	45, // 40: pulumirpc.ConstructResponse.state:type_name -> google.protobuf.Struct
	44, // 41: pulumirpc.ConstructResponse.stateDependencies:type_name -> pulumirpc.ConstructResponse.StateDependenciesEntry
	45, // 42: pulumirpc.ErrorResourceInitFailed.properties:type_name -> google.protobuf.Struct
	45, // 43: pulumirpc.ErrorResourceInitFailed.inputs:type_name -> google.protobuf.Struct
	31, // 44: pulumirpc.CallRequest.ArgDependenciesEntry.value:type_name -> pulumirpc.CallRequest.ArgumentDependencies
	35, // 45: pulumirpc.CallResponse.ReturnDependenciesEntry.value:type_name -> pulumirpc.CallResponse.ReturnDependencies
	15, // 46: pulumirpc.DiffResponse.DetailedDiffEntry.value:type_name -> pulumirpc.PropertyDiff
	38, // 47: pulumirpc.ConstructRequest.InputDependenciesEntry.value:type_name -> pulumirpc.ConstructRequest.PropertyDependencies
	43, // 48: pulumirpc.ConstructResponse.StateDependenciesEntry.value:type_name -> pulumirpc.ConstructResponse.PropertyDependencies
