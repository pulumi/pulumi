...
type ConstructRequest struct {
	...
	ReplaceWith   []string `protobuf:"bytes,28,rep,name=replaceWith,proto3" json:"replaceWith,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_pulumi_provider_proto_rawDesc = "" +
	...
	"\told_views\x18\n" +
	" \x03(\v2\x0f.pulumirpc.ViewR\boldViews\"\xa5\x0f\n" +
	...
	"\vreplaceWith\x18\x1c \x03(\tR\vreplaceWith\x1a*\n" +
