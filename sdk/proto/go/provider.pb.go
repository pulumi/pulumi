...
var file_pulumi_provider_proto_rawDesc = []byte{
	...
	0x09, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x32, 0xd9, 0x0a, 0x0a, 0x10, 0x52,
...
var file_pulumi_provider_proto_depIdxs = []int32{
	...
	50, // 34: pulumirpc.UpdateResponse.properties:type_name -> google.protobuf.Struct
	50, // 35: pulumirpc.DeleteRequest.properties:type_name -> google.protobuf.Struct
	50, // 36: pulumirpc.DeleteRequest.old_inputs:type_name -> google.protobuf.Struct
	45, // 37: pulumirpc.ConstructRequest.config:type_name -> pulumirpc.ConstructRequest.ConfigEntry
	50, // 38: pulumirpc.ConstructRequest.inputs:type_name -> google.protobuf.Struct
	46, // 39: pulumirpc.ConstructRequest.inputDependencies:type_name -> pulumirpc.ConstructRequest.InputDependenciesEntry
	47, // 40: pulumirpc.ConstructRequest.providers:type_name -> pulumirpc.ConstructRequest.ProvidersEntry
	44, // 41: pulumirpc.ConstructRequest.customTimeouts:type_name -> pulumirpc.ConstructRequest.CustomTimeouts
	50, // 42: pulumirpc.ConstructResponse.state:type_name -> google.protobuf.Struct
	49, // 43: pulumirpc.ConstructResponse.stateDependencies:type_name -> pulumirpc.ConstructResponse.StateDependenciesEntry
	50, // 44: pulumirpc.ErrorResourceInitFailed.properties:type_name -> google.protobuf.Struct
	50, // 45: pulumirpc.ErrorResourceInitFailed.inputs:type_name -> google.protobuf.Struct
	...
	51, // 66: pulumirpc.ResourceProvider.Cancel:input_type -> google.protobuf.Empty
	51, // 67: pulumirpc.ResourceProvider.GetPluginInfo:input_type -> google.protobuf.Empty
	52, // 68: pulumirpc.ResourceProvider.Attach:input_type -> pulumirpc.PluginAttach
	...
	51, // 84: pulumirpc.ResourceProvider.Delete:output_type -> google.protobuf.Empty
	27, // 85: pulumirpc.ResourceProvider.Construct:output_type -> pulumirpc.ConstructResponse
	51, // 86: pulumirpc.ResourceProvider.Cancel:output_type -> google.protobuf.Empty
	53, // 87: pulumirpc.ResourceProvider.GetPluginInfo:output_type -> pulumirpc.PluginInfo
	51, // 88: pulumirpc.ResourceProvider.Attach:output_type -> google.protobuf.Empty
