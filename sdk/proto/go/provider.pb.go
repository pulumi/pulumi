...
type ProviderHandshakeRequest struct {
	...
	InvokeWithDryRun bool `protobuf:"varint,7,opt,name=invoke_with_dry_run,json=invokeWithDryRun,proto3" json:"invoke_with_dry_run,omitempty"`
...
func (x *ProviderHandshakeRequest) GetInvokeWithDryRun() bool {
	if x != nil {
		return x.InvokeWithDryRun
	}
	return false
}
...
const file_pulumi_provider_proto_rawDesc = "" +
	"\n" +
	"\x15pulumi/provider.proto\x12\tpulumirpc\x1a\x13pulumi/plugin.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\"\x91\x03\n" +
	...
	"\x13invoke_with_dry_run\x18\a \x01(\bR\x10invokeWithDryRunB\x11\n" +
	...
	"\vdescription\x18\x02 \x01(\tR\vdescription\"\xa4\x01\n" +
	"\rInvokeRequest\x12\x10\n" +
	"\x03tok\x18\x01 \x01(\tR\x03tok\x12+\n" +
	"\x04args\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x04args\x12\x17\n" +
	"\adry_run\x18\a \x01(\bR\x06dryRunJ\x04\b\x03\x10\aR\bproviderR\aversionR\x0facceptResourcesR\x11pluginDownloadURL\"v\n" +
