...
type ConstructRequest struct {
	...
	// equal. This option is forwarded from the initial remote component registration request so that component
	// providers can propagate it to their inner component resource registration.
...
const file_pulumi_provider_proto_rawDesc = "" +
	...
	"\told_views\x18\n" +
	" \x03(\v2\x0f.pulumirpc.ViewR\boldViews\"\xef\x0f\n" +
