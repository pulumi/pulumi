...
var file_pulumi_provider_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x32, 0x90, 0x0a, 0x0a, 0x10, 0x52, 0x65, 0x73,
...
var file_pulumi_provider_proto_depIdxs = []int32{
	...
	52, // 65: pulumirpc.ResourceProvider.Cancel:input_type -> google.protobuf.Empty
	52, // 66: pulumirpc.ResourceProvider.GetPluginInfo:input_type -> google.protobuf.Empty
	53, // 67: pulumirpc.ResourceProvider.Attach:input_type -> pulumirpc.PluginAttach
	...
	12, // 76: pulumirpc.ResourceProvider.Call:output_type -> pulumirpc.CallResponse
	14, // 77: pulumirpc.ResourceProvider.Check:output_type -> pulumirpc.CheckResponse
	18, // 78: pulumirpc.ResourceProvider.Diff:output_type -> pulumirpc.DiffResponse
	20, // 79: pulumirpc.ResourceProvider.Create:output_type -> pulumirpc.CreateResponse
	22, // 80: pulumirpc.ResourceProvider.Read:output_type -> pulumirpc.ReadResponse
	24, // 81: pulumirpc.ResourceProvider.Update:output_type -> pulumirpc.UpdateResponse
	52, // 82: pulumirpc.ResourceProvider.Delete:output_type -> google.protobuf.Empty
	27, // 83: pulumirpc.ResourceProvider.Construct:output_type -> pulumirpc.ConstructResponse
	52, // 84: pulumirpc.ResourceProvider.Cancel:output_type -> google.protobuf.Empty
	54, // 85: pulumirpc.ResourceProvider.GetPluginInfo:output_type -> pulumirpc.PluginInfo
	52, // 86: pulumirpc.ResourceProvider.Attach:output_type -> google.protobuf.Empty
	30, // 87: pulumirpc.ResourceProvider.GetMapping:output_type -> pulumirpc.GetMappingResponse
	32, // 88: pulumirpc.ResourceProvider.GetMappings:output_type -> pulumirpc.GetMappingsResponse
