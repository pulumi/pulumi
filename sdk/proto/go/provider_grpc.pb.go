...
// All implementations should embed UnimplementedResourceProviderServer
...
// UnimplementedResourceProviderServer should be embedded to have forward compatible implementations.
