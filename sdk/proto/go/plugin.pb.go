...
func (*PluginInfo) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func (*PluginDependency) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{1} }
...
func init() { proto.RegisterFile("plugin.proto", fileDescriptor5) }
