...
type PackageDependency struct {
	...
	Parameterization *Parameterization `protobuf:"bytes,6,opt,name=parameterization,proto3" json:"parameterization,omitempty"`
}
...
func (x *PackageDependency) GetParameterization() *Parameterization {
	if x != nil {
...
var file_pulumi_plugin_proto_rawDesc = []byte{
	...
	0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x56, 0x0a, 0x10, 0x50, 0x61, 0x72,
	...
	0x65, 0x22, 0xbf, 0x02, 0x0a, 0x11, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x44, 0x65, 0x70,
	...
	0x72, 0x12, 0x49, 0x0a, 0x09, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x73, 0x18, 0x05,
	...
	0x63, 0x79, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x70, 0x75, 0x6c, 0x75, 0x6d, 0x69, 0x72,
...
var file_pulumi_plugin_proto_goTypes = []interface{}{
	...
	(*Parameterization)(nil),  // 3: pulumirpc.Parameterization
...
var file_pulumi_plugin_proto_depIdxs = []int32{
	...
	3, // 2: pulumirpc.PackageDependency.parameterization:type_name -> pulumirpc.Parameterization
