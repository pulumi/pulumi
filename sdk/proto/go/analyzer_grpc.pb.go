...
type AnalyzerClient interface {
	...
	TransformStack(ctx context.Context, in *AnalyzeStackRequest, opts ...grpc.CallOption) (*TransformResponse, error)
...
func (c *analyzerClient) TransformStack(ctx context.Context, in *AnalyzeStackRequest, opts ...grpc.CallOption) (*TransformResponse, error) {
	out := new(TransformResponse)
...
type AnalyzerServer interface {
	...
	// TransformStack optionally transforms an entire stack's worth of resources. This effectively
	// rewrites all resource properties instead of using what was generated by the program.
	TransformStack(context.Context, *AnalyzeStackRequest) (*TransformResponse, error)
	// GetAnalyzerInfo returns metadata about the analyzer (e.g., list of policies contained).
...
func (UnimplementedAnalyzerServer) TransformStack(context.Context, *AnalyzeStackRequest) (*TransformResponse, error) {
