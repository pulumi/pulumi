...
type AnalyzerClient interface {
	...
	Transform(ctx context.Context, in *AnalyzeRequest, opts ...grpc.CallOption) (*TransformResponse, error)
	...
	TransformStack(ctx context.Context, in *AnalyzeStackRequest, opts ...grpc.CallOption) (*TransformStackResponse, error)
...
func (c *analyzerClient) Transform(ctx context.Context, in *AnalyzeRequest, opts ...grpc.CallOption) (*TransformResponse, error) {
	out := new(TransformResponse)
	err := c.cc.Invoke(ctx, "/pulumirpc.Analyzer/Transform", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *analyzerClient) TransformStack(ctx context.Context, in *AnalyzeStackRequest, opts ...grpc.CallOption) (*TransformStackResponse, error) {
	out := new(TransformStackResponse)
	err := c.cc.Invoke(ctx, "/pulumirpc.Analyzer/TransformStack", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AnalyzerServer interface {
	...
	// Transform optionally transforms a single resource object. This effectively rewrites
	// a single resource object's properties instead of using what was generated by the program.
	Transform(context.Context, *AnalyzeRequest) (*TransformResponse, error)
	// TransformStack optionally transforms an entire stack's worth of resources. This effectively
	// rewrites all resource properties instead of using what was generated by the program.
	TransformStack(context.Context, *AnalyzeStackRequest) (*TransformStackResponse, error)
	// GetAnalyzerInfo returns metadata about the analyzer (e.g., list of policies contained).
...
func (UnimplementedAnalyzerServer) Transform(context.Context, *AnalyzeRequest) (*TransformResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Transform not implemented")
}
func (UnimplementedAnalyzerServer) TransformStack(context.Context, *AnalyzeStackRequest) (*TransformStackResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransformStack not implemented")
}
...
func _Analyzer_Transform_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyzeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyzerServer).Transform(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pulumirpc.Analyzer/Transform",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyzerServer).Transform(ctx, req.(*AnalyzeRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Analyzer_TransformStack_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AnalyzeStackRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyzerServer).TransformStack(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pulumirpc.Analyzer/TransformStack",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyzerServer).TransformStack(ctx, req.(*AnalyzeStackRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Analyzer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Analyzer_Transform_Handler,
		},
		{
			MethodName: "TransformStack",
			Handler:    _Analyzer_TransformStack_Handler,
		},
		{
