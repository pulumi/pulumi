...
// All implementations should embed UnimplementedResourceMonitorServer
...
// UnimplementedResourceMonitorServer should be embedded to have forward compatible implementations.
