...
func (EnforcementLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{0}
}
...
func (*AnalyzerResource) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{1}
}
...
func (*AnalyzerResourceOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{2}
}
...
func (*AnalyzerResourceOptions_CustomTimeouts) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{2, 0}
}
...
func (*AnalyzerProviderResource) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{3}
}
...
func (*AnalyzerPropertyDependencies) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{4}
}
...
func (*AnalyzeStackRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{5}
}
...
func (*AnalyzeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{6}
}
...
func (*AnalyzeDiagnostic) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{7}
}
...
func (*AnalyzerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{8}
}
...
func (*PolicyInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_analyzer_a2194cdd67b40a69, []int{9}
}
...
func init() { proto.RegisterFile("analyzer.proto", fileDescriptor_analyzer_a2194cdd67b40a69) }

var fileDescriptor_analyzer_a2194cdd67b40a69 = []byte{
