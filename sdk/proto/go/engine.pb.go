...
func (LogSeverity) EnumDescriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func (*LogRequest) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func init() { proto.RegisterFile("engine.proto", fileDescriptor2) }
