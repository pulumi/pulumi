...
type EngineClient interface {
	...
	StartDebugger(ctx context.Context, in *StartDebuggerRequest, opts ...grpc.CallOption) (*StartDebuggerResponse, error)
}
...
func (c *engineClient) StartDebugger(ctx context.Context, in *StartDebuggerRequest, opts ...grpc.CallOption) (*StartDebuggerResponse, error) {
	out := new(StartDebuggerResponse)
...
type EngineServer interface {
	...
	StartDebugger(context.Context, *StartDebuggerRequest) (*StartDebuggerResponse, error)
...
func (UnimplementedEngineServer) StartDebugger(context.Context, *StartDebuggerRequest) (*StartDebuggerResponse, error) {
