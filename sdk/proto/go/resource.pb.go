...
type RegisterResourceRequest struct {
	...
	ReplacementTrigger         string                                                   `protobuf:"bytes,39,opt,name=replacement_trigger,json=replacementTrigger,proto3" json:"replacement_trigger,omitempty"`                                                    // if set, the engine will diff this with the last recorded value, and trigger a replace if they are not equal.
...
func (x *RegisterResourceRequest) GetReplacementTrigger() string {
	if x != nil {
...
type TransformResourceOptions struct {
	...
	ReplacementTrigger      string                                        `protobuf:"bytes,20,opt,name=replacement_trigger,json=replacementTrigger,proto3" json:"replacement_trigger,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *TransformResourceOptions) GetReplacementTrigger() string {
	if x != nil {
		return x.ReplacementTrigger
	}
	return ""
...
const file_pulumi_resource_proto_rawDesc = "" +
	...
	"\x13replacement_trigger\x18' \x01(\tR\x12replacementTrigger\x12\x1e\n" +
	"\n" +
	...
	"J\x04\b\n" +
	"\x10\vJ\x04\b\v\x10\fJ\x04\b\f\x10\rJ\x04\b\x0e\x10\x0fR\aprojectR\x05stackR\x06configR\x10configSecretKeysR\x06dryRunR\bparallelR\x0fmonitorEndpointR\forganization\"\x8b\t\n" +
	...
	"\x13replacement_trigger\x18\x14 \x01(\tR\x12replacementTrigger\x1a<\n" +
	"\x0eProvidersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aB\n" +
	"\x14PluginChecksumsEntry\x12\x10\n" +
