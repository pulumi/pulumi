...
type TransformationRequest struct {
	...
	Properties *structpb.Struct               `protobuf:"bytes,3,opt,name=properties,proto3" json:"properties,omitempty"` // the input properties of the resource.
	Options    *TransformationResourceOptions `protobuf:"bytes,4,opt,name=options,proto3" json:"options,omitempty"`       // the options for the resource.
}
...
var file_pulumi_resource_proto_rawDesc = []byte{
	...
	0x65, 0x66, 0x6f, 0x72, 0x65, 0x5f, 0x72, 0x65, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x22, 0xbc, 0x01,
	...
	0x6f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x70, 0x75, 0x6c, 0x75,
