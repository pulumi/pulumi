...
type RegisterResourceResponse struct {
	...
	SkippedCreate        bool                                                      `protobuf:"varint,8,opt,name=skipped_create,json=skippedCreate,proto3" json:"skipped_create,omitempty"`                                                                   // true if the create was elided, e.g. because it was not targeted; result is still SUCCESS and SDKs should resolve outputs as unknown.
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *RegisterResourceResponse) GetSkippedCreate() bool {
	if x != nil {
		return x.SkippedCreate
	}
	return false
}
...
const file_pulumi_resource_proto_rawDesc = "" +
	...
	"\x06result\x18\a \x01(\x0e2\x11.pulumirpc.ResultR\x06result\x12%\n" +
	"\x0eskipped_create\x18\b \x01(\bR\rskippedCreate\x1a*\n" +
	"\x14PropertyDependencies\x12\x12\n" +
