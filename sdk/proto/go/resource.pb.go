...
type ResourceExtension struct {
	...
	// The base provider package this resource is an extension of. For parameterized resources this is used to
	// lookup the provider plugin instead of the package part of RegisterResourceRequest.Type as for a
	// parameterized package the type tokens will not use the base schemas package.
	Package string `protobuf:"bytes,1,opt,name=package,proto3" json:"package,omitempty"`
	// The version of the base provider package this extension is for. This is used to lookup the provider
	// plugin instead of RegisterResourceRequest.Version as for an extension package the version field will be
	// the extension packages version.
	Version string `protobuf:"bytes,2,opt,name=version,proto3" json:"version,omitempty"`
	// An optional setting to parameterize this resource.
	Parameter *ResourceParameter `protobuf:"bytes,3,opt,name=parameter,proto3" json:"parameter,omitempty"`
}
...
func (x *ResourceExtension) GetPackage() string {
	if x != nil {
		return x.Package
	}
	return ""
...
func (x *ResourceExtension) GetParameter() *ResourceParameter {
	if x != nil {
		return x.Parameter
	}
	return nil
...
type ResourceParameter struct {
	...
	// True if this is an additive (rather than replacement) parameterization. An additive parameterization
	// will use the base packages provider instance and repeatedly call Parameterize on it. A non-additive
	// (replacement) parameterization will instantiate a new provider instance for itself (and call
	// Parameterize on it once). A replacement parameterization can not have further additive
	// parameterizations.
	Additive bool `protobuf:"varint,2,opt,name=additive,proto3" json:"additive,omitempty"`
}

func (x *ResourceParameter) Reset() {
	*x = ResourceParameter{}
	if protoimpl.UnsafeEnabled {
...
func (x *ResourceParameter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResourceParameter) ProtoMessage() {}

func (x *ResourceParameter) ProtoReflect() protoreflect.Message {
	mi := &file_pulumi_resource_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResourceParameter.ProtoReflect.Descriptor instead.
func (*ResourceParameter) Descriptor() ([]byte, []int) {
	return file_pulumi_resource_proto_rawDescGZIP(), []int{5}
}

func (x *ResourceParameter) GetValue() *structpb.Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *ResourceParameter) GetAdditive() bool {
	if x != nil {
		return x.Additive
	}
	return false
...
type RegisterResourceRequest struct {
	...
	Extension               *ResourceExtension `protobuf:"bytes,33,opt,name=extension,proto3" json:"extension,omitempty"`                              // optional extension for this resource, changes the base package.
}
...
func (x *RegisterResourceRequest) GetExtension() *ResourceExtension {
	if x != nil {
		return x.Extension
	}
	return nil
...
func (*RegisterResourceRequest_CustomTimeouts) Descriptor() ([]byte, []int) {
	return file_pulumi_resource_proto_rawDescGZIP(), []int{6, 1}
}
...
func (*RegisterResourceResponse_PropertyDependencies) Descriptor() ([]byte, []int) {
	return file_pulumi_resource_proto_rawDescGZIP(), []int{7, 0}
}
...
var file_pulumi_resource_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x65, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x11, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x3a,
	0x0a, 0x09, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x1c, 0x2e, 0x70, 0x75, 0x6c, 0x75, 0x6d, 0x69, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x52,
	0x09, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x22, 0x5d, 0x0a, 0x11, 0x52, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x12,
	...
	0x08, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69, 0x76, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x08, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69, 0x76, 0x65, 0x22, 0xaa, 0x0f, 0x0a, 0x17, 0x52, 0x65,
	...
	0x3a, 0x0a, 0x09, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x21, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x70, 0x75, 0x6c, 0x75, 0x6d, 0x69, 0x72, 0x70, 0x63, 0x2e, 0x52,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e,
	0x52, 0x09, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x1a, 0x2a, 0x0a, 0x14, 0x50,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xed, 0x03, 0x0a, 0x18, 0x52, 0x65, 0x67, 0x69, 0x73,
	...
	0x72, 0x75, 0x63, 0x74, 0x52, 0x07, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x22, 0xcc, 0x03,
	...
	0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x42, 0x0a, 0x14, 0x50, 0x6c, 0x75, 0x67,
	0x69, 0x6e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b,
	0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xad, 0x06, 0x0a,
	...
	0x70, 0x75, 0x6c, 0x75, 0x6d, 0x69, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0e, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x2a, 0x0a, 0x14, 0x41, 0x72, 0x67, 0x75,
	...
	0x6f, 0x72, 0x67, 0x61, 0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xab, 0x07, 0x0a,
	...
	,
	...
	,
	...
	0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x73, 0x12, 0x63, 0x0a, 0x10, 0x70, 0x6c, 0x75,
	0x67, 0x69, 0x6e, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x73, 0x18, 0x0f, 0x20,
	...
	0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x43,
	0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0f, 0x70,
	0x6c, 0x75, 0x67, 0x69, 0x6e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x73, 0x1a, 0x3c,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x52, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2a, 0x29, 0x0a,
	...
	0x0a, 0x04, 0x53, 0x4b, 0x49, 0x50, 0x10, 0x02, 0x32, 0xa5, 0x05, 0x0a, 0x0f, 0x52, 0x65, 0x73,
...
var file_pulumi_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_pulumi_resource_proto_goTypes = []interface{}{
	...
	(*ResourceExtension)(nil),                            // 5: pulumirpc.ResourceExtension
	(*ResourceParameter)(nil),                            // 6: pulumirpc.ResourceParameter
	...
	nil,                                                  // 15: pulumirpc.ReadResourceRequest.PluginChecksumsEntry
	(*RegisterResourceRequest_PropertyDependencies)(nil), // 16: pulumirpc.RegisterResourceRequest.PropertyDependencies
	(*RegisterResourceRequest_CustomTimeouts)(nil),       // 17: pulumirpc.RegisterResourceRequest.CustomTimeouts
	nil, // 18: pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry
	nil, // 19: pulumirpc.RegisterResourceRequest.ProvidersEntry
	nil, // 20: pulumirpc.RegisterResourceRequest.PluginChecksumsEntry
	(*RegisterResourceResponse_PropertyDependencies)(nil), // 21: pulumirpc.RegisterResourceResponse.PropertyDependencies
	nil, // 22: pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry
	nil, // 23: pulumirpc.ResourceInvokeRequest.PluginChecksumsEntry
	(*ResourceCallRequest_ArgumentDependencies)(nil), // 24: pulumirpc.ResourceCallRequest.ArgumentDependencies
	nil,                     // 25: pulumirpc.ResourceCallRequest.ArgDependenciesEntry
	nil,                     // 26: pulumirpc.ResourceCallRequest.PluginChecksumsEntry
	nil,                     // 27: pulumirpc.TransformResourceOptions.ProvidersEntry
	nil,                     // 28: pulumirpc.TransformResourceOptions.PluginChecksumsEntry
	(*structpb.Struct)(nil), // 29: google.protobuf.Struct
	(*SourcePosition)(nil),  // 30: pulumirpc.SourcePosition
	(*structpb.Value)(nil),  // 31: google.protobuf.Value
	(*Alias)(nil),           // 32: pulumirpc.Alias
	(*Callback)(nil),        // 33: pulumirpc.Callback
	(*InvokeResponse)(nil),  // 34: pulumirpc.InvokeResponse
	(*CallResponse)(nil),    // 35: pulumirpc.CallResponse
	(*emptypb.Empty)(nil),   // 36: google.protobuf.Empty
}
var file_pulumi_resource_proto_depIdxs = []int32{
	29, // 0: pulumirpc.ReadResourceRequest.properties:type_name -> google.protobuf.Struct
	15, // 1: pulumirpc.ReadResourceRequest.pluginChecksums:type_name -> pulumirpc.ReadResourceRequest.PluginChecksumsEntry
	30, // 2: pulumirpc.ReadResourceRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	29, // 3: pulumirpc.ReadResourceResponse.properties:type_name -> google.protobuf.Struct
	6,  // 4: pulumirpc.ResourceExtension.parameter:type_name -> pulumirpc.ResourceParameter
	31, // 5: pulumirpc.ResourceParameter.value:type_name -> google.protobuf.Value
	29, // 6: pulumirpc.RegisterResourceRequest.object:type_name -> google.protobuf.Struct
	18, // 7: pulumirpc.RegisterResourceRequest.propertyDependencies:type_name -> pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry
	17, // 8: pulumirpc.RegisterResourceRequest.customTimeouts:type_name -> pulumirpc.RegisterResourceRequest.CustomTimeouts
	19, // 9: pulumirpc.RegisterResourceRequest.providers:type_name -> pulumirpc.RegisterResourceRequest.ProvidersEntry
	20, // 10: pulumirpc.RegisterResourceRequest.pluginChecksums:type_name -> pulumirpc.RegisterResourceRequest.PluginChecksumsEntry
	32, // 11: pulumirpc.RegisterResourceRequest.aliases:type_name -> pulumirpc.Alias
	30, // 12: pulumirpc.RegisterResourceRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	33, // 13: pulumirpc.RegisterResourceRequest.transforms:type_name -> pulumirpc.Callback
	5,  // 14: pulumirpc.RegisterResourceRequest.extension:type_name -> pulumirpc.ResourceExtension
	29, // 15: pulumirpc.RegisterResourceResponse.object:type_name -> google.protobuf.Struct
	22, // 16: pulumirpc.RegisterResourceResponse.propertyDependencies:type_name -> pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry
	0,  // 17: pulumirpc.RegisterResourceResponse.result:type_name -> pulumirpc.Result
	29, // 18: pulumirpc.RegisterResourceOutputsRequest.outputs:type_name -> google.protobuf.Struct
	29, // 19: pulumirpc.ResourceInvokeRequest.args:type_name -> google.protobuf.Struct
	23, // 20: pulumirpc.ResourceInvokeRequest.pluginChecksums:type_name -> pulumirpc.ResourceInvokeRequest.PluginChecksumsEntry
	30, // 21: pulumirpc.ResourceInvokeRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	29, // 22: pulumirpc.ResourceCallRequest.args:type_name -> google.protobuf.Struct
	25, // 23: pulumirpc.ResourceCallRequest.argDependencies:type_name -> pulumirpc.ResourceCallRequest.ArgDependenciesEntry
	26, // 24: pulumirpc.ResourceCallRequest.pluginChecksums:type_name -> pulumirpc.ResourceCallRequest.PluginChecksumsEntry
	30, // 25: pulumirpc.ResourceCallRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	32, // 26: pulumirpc.TransformResourceOptions.aliases:type_name -> pulumirpc.Alias
	17, // 27: pulumirpc.TransformResourceOptions.custom_timeouts:type_name -> pulumirpc.RegisterResourceRequest.CustomTimeouts
	27, // 28: pulumirpc.TransformResourceOptions.providers:type_name -> pulumirpc.TransformResourceOptions.ProvidersEntry
	28, // 29: pulumirpc.TransformResourceOptions.plugin_checksums:type_name -> pulumirpc.TransformResourceOptions.PluginChecksumsEntry
	29, // 30: pulumirpc.TransformRequest.properties:type_name -> google.protobuf.Struct
	12, // 31: pulumirpc.TransformRequest.options:type_name -> pulumirpc.TransformResourceOptions
	29, // 32: pulumirpc.TransformResponse.properties:type_name -> google.protobuf.Struct
	12, // 33: pulumirpc.TransformResponse.options:type_name -> pulumirpc.TransformResourceOptions
	16, // 34: pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceRequest.PropertyDependencies
	21, // 35: pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceResponse.PropertyDependencies
	24, // 36: pulumirpc.ResourceCallRequest.ArgDependenciesEntry.value:type_name -> pulumirpc.ResourceCallRequest.ArgumentDependencies
	1,  // 37: pulumirpc.ResourceMonitor.SupportsFeature:input_type -> pulumirpc.SupportsFeatureRequest
	10, // 38: pulumirpc.ResourceMonitor.Invoke:input_type -> pulumirpc.ResourceInvokeRequest
	10, // 39: pulumirpc.ResourceMonitor.StreamInvoke:input_type -> pulumirpc.ResourceInvokeRequest
	11, // 40: pulumirpc.ResourceMonitor.Call:input_type -> pulumirpc.ResourceCallRequest
	3,  // 41: pulumirpc.ResourceMonitor.ReadResource:input_type -> pulumirpc.ReadResourceRequest
	7,  // 42: pulumirpc.ResourceMonitor.RegisterResource:input_type -> pulumirpc.RegisterResourceRequest
	9,  // 43: pulumirpc.ResourceMonitor.RegisterResourceOutputs:input_type -> pulumirpc.RegisterResourceOutputsRequest
	33, // 44: pulumirpc.ResourceMonitor.RegisterStackTransform:input_type -> pulumirpc.Callback
	2,  // 45: pulumirpc.ResourceMonitor.SupportsFeature:output_type -> pulumirpc.SupportsFeatureResponse
	34, // 46: pulumirpc.ResourceMonitor.Invoke:output_type -> pulumirpc.InvokeResponse
	34, // 47: pulumirpc.ResourceMonitor.StreamInvoke:output_type -> pulumirpc.InvokeResponse
	35, // 48: pulumirpc.ResourceMonitor.Call:output_type -> pulumirpc.CallResponse
	4,  // 49: pulumirpc.ResourceMonitor.ReadResource:output_type -> pulumirpc.ReadResourceResponse
	8,  // 50: pulumirpc.ResourceMonitor.RegisterResource:output_type -> pulumirpc.RegisterResourceResponse
	36, // 51: pulumirpc.ResourceMonitor.RegisterResourceOutputs:output_type -> google.protobuf.Empty
	36, // 52: pulumirpc.ResourceMonitor.RegisterStackTransform:output_type -> google.protobuf.Empty
...
func file_pulumi_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pulumi_resource_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResourceExtension); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pulumi_resource_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResourceParameter); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_pulumi_resource_proto_msgTypes[11].OneofWrappers = []interface{}{}
	type x struct{}
