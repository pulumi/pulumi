...
type CreateNewContextResponse struct {
	...
	MonitorAddr string `protobuf:"bytes,1,opt,name=monitorAddr,proto3" json:"monitorAddr,omitempty"`
}
...
func (x *CreateNewContextResponse) GetMonitorAddr() string {
	if x != nil {
...
var file_pulumi_resource_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x52, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x37, 0x0a, 0x17,
	...
	0x69, 0x64, 0x65, 0x72, 0x73, 0x22, 0x3c, 0x0a, 0x18, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4e,
	0x65, 0x77, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x12, 0x20, 0x0a, 0x0b, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x41, 0x64, 0x64, 0x72,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x41,
	0x64, 0x64, 0x72, 0x2a, 0x29, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x0b, 0x0a,
	0x07, 0x53, 0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x46, 0x41,
	0x49, 0x4c, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x53, 0x4b, 0x49, 0x50, 0x10, 0x02, 0x32, 0x84,
	...
	0x4e, 0x65, 0x77, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x12, 0x22, 0x2e, 0x70, 0x75, 0x6c,
	0x75, 0x6d, 0x69, 0x72, 0x70, 0x63, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4e, 0x65, 0x77,
	...
	0x65, 0x4e, 0x65, 0x77, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_pulumi_resource_proto_goTypes = []interface{}{
	...
	(*CreateNewContextRequest)(nil),                      // 13: pulumirpc.CreateNewContextRequest
	(*CreateNewContextResponse)(nil),                     // 14: pulumirpc.CreateNewContextResponse
	...
	(*Alias)(nil),           // 31: pulumirpc.Alias
	(*Callback)(nil),        // 32: pulumirpc.Callback
	(*InvokeResponse)(nil),  // 33: pulumirpc.InvokeResponse
	(*CallResponse)(nil),    // 34: pulumirpc.CallResponse
...
var file_pulumi_resource_proto_depIdxs = []int32{
	...
	29, // 4: pulumirpc.RegisterResourceRequest.object:type_name -> google.protobuf.Struct
	18, // 5: pulumirpc.RegisterResourceRequest.propertyDependencies:type_name -> pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry
	17, // 6: pulumirpc.RegisterResourceRequest.customTimeouts:type_name -> pulumirpc.RegisterResourceRequest.CustomTimeouts
	19, // 7: pulumirpc.RegisterResourceRequest.providers:type_name -> pulumirpc.RegisterResourceRequest.ProvidersEntry
	20, // 8: pulumirpc.RegisterResourceRequest.pluginChecksums:type_name -> pulumirpc.RegisterResourceRequest.PluginChecksumsEntry
	31, // 9: pulumirpc.RegisterResourceRequest.aliases:type_name -> pulumirpc.Alias
	30, // 10: pulumirpc.RegisterResourceRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	32, // 11: pulumirpc.RegisterResourceRequest.transforms:type_name -> pulumirpc.Callback
	29, // 12: pulumirpc.RegisterResourceResponse.object:type_name -> google.protobuf.Struct
	22, // 13: pulumirpc.RegisterResourceResponse.propertyDependencies:type_name -> pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry
	0,  // 14: pulumirpc.RegisterResourceResponse.result:type_name -> pulumirpc.Result
	29, // 15: pulumirpc.RegisterResourceOutputsRequest.outputs:type_name -> google.protobuf.Struct
	29, // 16: pulumirpc.ResourceInvokeRequest.args:type_name -> google.protobuf.Struct
	23, // 17: pulumirpc.ResourceInvokeRequest.pluginChecksums:type_name -> pulumirpc.ResourceInvokeRequest.PluginChecksumsEntry
	30, // 18: pulumirpc.ResourceInvokeRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	29, // 19: pulumirpc.ResourceCallRequest.args:type_name -> google.protobuf.Struct
	25, // 20: pulumirpc.ResourceCallRequest.argDependencies:type_name -> pulumirpc.ResourceCallRequest.ArgDependenciesEntry
	26, // 21: pulumirpc.ResourceCallRequest.pluginChecksums:type_name -> pulumirpc.ResourceCallRequest.PluginChecksumsEntry
	30, // 22: pulumirpc.ResourceCallRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	31, // 23: pulumirpc.TransformResourceOptions.aliases:type_name -> pulumirpc.Alias
	17, // 24: pulumirpc.TransformResourceOptions.custom_timeouts:type_name -> pulumirpc.RegisterResourceRequest.CustomTimeouts
	27, // 25: pulumirpc.TransformResourceOptions.providers:type_name -> pulumirpc.TransformResourceOptions.ProvidersEntry
	28, // 26: pulumirpc.TransformResourceOptions.plugin_checksums:type_name -> pulumirpc.TransformResourceOptions.PluginChecksumsEntry
	29, // 27: pulumirpc.TransformRequest.properties:type_name -> google.protobuf.Struct
	10, // 28: pulumirpc.TransformRequest.options:type_name -> pulumirpc.TransformResourceOptions
	29, // 29: pulumirpc.TransformResponse.properties:type_name -> google.protobuf.Struct
	10, // 30: pulumirpc.TransformResponse.options:type_name -> pulumirpc.TransformResourceOptions
	16, // 31: pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceRequest.PropertyDependencies
	21, // 32: pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceResponse.PropertyDependencies
	24, // 33: pulumirpc.ResourceCallRequest.ArgDependenciesEntry.value:type_name -> pulumirpc.ResourceCallRequest.ArgumentDependencies
	...
	32, // 41: pulumirpc.ResourceMonitor.RegisterStackTransform:input_type -> pulumirpc.Callback
	13, // 42: pulumirpc.ResourceMonitor.CreateNewContext:input_type -> pulumirpc.CreateNewContextRequest
	2,  // 43: pulumirpc.ResourceMonitor.SupportsFeature:output_type -> pulumirpc.SupportsFeatureResponse
	33, // 44: pulumirpc.ResourceMonitor.Invoke:output_type -> pulumirpc.InvokeResponse
	33, // 45: pulumirpc.ResourceMonitor.StreamInvoke:output_type -> pulumirpc.InvokeResponse
	34, // 46: pulumirpc.ResourceMonitor.Call:output_type -> pulumirpc.CallResponse
	4,  // 47: pulumirpc.ResourceMonitor.ReadResource:output_type -> pulumirpc.ReadResourceResponse
	6,  // 48: pulumirpc.ResourceMonitor.RegisterResource:output_type -> pulumirpc.RegisterResourceResponse
	35, // 49: pulumirpc.ResourceMonitor.RegisterResourceOutputs:output_type -> google.protobuf.Empty
	35, // 50: pulumirpc.ResourceMonitor.RegisterStackTransform:output_type -> google.protobuf.Empty
	14, // 51: pulumirpc.ResourceMonitor.CreateNewContext:output_type -> pulumirpc.CreateNewContextResponse
