...
type TransformationRequest struct {
	...
	Props *structpb.Struct `protobuf:"bytes,3,opt,name=props,proto3" json:"props,omitempty"` // the properties of the resource.
}
...
func (x *TransformationRequest) GetProps() *structpb.Struct {
	if x != nil {
		return x.Props
	}
	return nil
...
type TransformationResponse struct {
	...
	Props *structpb.Struct `protobuf:"bytes,1,opt,name=props,proto3" json:"props,omitempty"` // the transformed properties.
}
...
func (x *TransformationResponse) GetProps() *structpb.Struct {
	if x != nil {
		return x.Props
	}
	return nil
...
var file_pulumi_resource_proto_rawDesc = []byte{
	...
	0x22, 0x6e, 0x0a, 0x15, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69,
	...
	,
	...
	0x12, 0x4c, 0x0a, 0x1b, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x53, 0x74, 0x61, 0x63,
	0x6b, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12,
...
var file_pulumi_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_pulumi_resource_proto_goTypes = []interface{}{
	...
	(*TransformationRequest)(nil),                        // 8: pulumirpc.TransformationRequest
	(*TransformationResponse)(nil),                       // 9: pulumirpc.TransformationResponse
	nil,                                                  // 10: pulumirpc.ReadResourceRequest.PluginChecksumsEntry
	(*RegisterResourceRequest_PropertyDependencies)(nil), // 11: pulumirpc.RegisterResourceRequest.PropertyDependencies
	(*RegisterResourceRequest_CustomTimeouts)(nil),       // 12: pulumirpc.RegisterResourceRequest.CustomTimeouts
	nil, // 13: pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry
	nil, // 14: pulumirpc.RegisterResourceRequest.ProvidersEntry
	nil, // 15: pulumirpc.RegisterResourceRequest.PluginChecksumsEntry
	(*RegisterResourceResponse_PropertyDependencies)(nil), // 16: pulumirpc.RegisterResourceResponse.PropertyDependencies
	nil,                     // 17: pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry
	nil,                     // 18: pulumirpc.ResourceInvokeRequest.PluginChecksumsEntry
	(*structpb.Struct)(nil), // 19: google.protobuf.Struct
	(*SourcePosition)(nil),  // 20: pulumirpc.SourcePosition
	(*Alias)(nil),           // 21: pulumirpc.Alias
	(*Callback)(nil),        // 22: pulumirpc.Callback
	(*CallRequest)(nil),     // 23: pulumirpc.CallRequest
...
var file_pulumi_resource_proto_depIdxs = []int32{
	19, // 0: pulumirpc.ReadResourceRequest.properties:type_name -> google.protobuf.Struct
	10, // 1: pulumirpc.ReadResourceRequest.pluginChecksums:type_name -> pulumirpc.ReadResourceRequest.PluginChecksumsEntry
	20, // 2: pulumirpc.ReadResourceRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	19, // 3: pulumirpc.ReadResourceResponse.properties:type_name -> google.protobuf.Struct
	19, // 4: pulumirpc.RegisterResourceRequest.object:type_name -> google.protobuf.Struct
	13, // 5: pulumirpc.RegisterResourceRequest.propertyDependencies:type_name -> pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry
	12, // 6: pulumirpc.RegisterResourceRequest.customTimeouts:type_name -> pulumirpc.RegisterResourceRequest.CustomTimeouts
	14, // 7: pulumirpc.RegisterResourceRequest.providers:type_name -> pulumirpc.RegisterResourceRequest.ProvidersEntry
	15, // 8: pulumirpc.RegisterResourceRequest.pluginChecksums:type_name -> pulumirpc.RegisterResourceRequest.PluginChecksumsEntry
	21, // 9: pulumirpc.RegisterResourceRequest.aliases:type_name -> pulumirpc.Alias
	20, // 10: pulumirpc.RegisterResourceRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	22, // 11: pulumirpc.RegisterResourceRequest.transformations:type_name -> pulumirpc.Callback
	19, // 12: pulumirpc.RegisterResourceResponse.object:type_name -> google.protobuf.Struct
	17, // 13: pulumirpc.RegisterResourceResponse.propertyDependencies:type_name -> pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry
	19, // 14: pulumirpc.RegisterResourceOutputsRequest.outputs:type_name -> google.protobuf.Struct
	19, // 15: pulumirpc.ResourceInvokeRequest.args:type_name -> google.protobuf.Struct
	18, // 16: pulumirpc.ResourceInvokeRequest.pluginChecksums:type_name -> pulumirpc.ResourceInvokeRequest.PluginChecksumsEntry
	20, // 17: pulumirpc.ResourceInvokeRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	19, // 18: pulumirpc.TransformationRequest.props:type_name -> google.protobuf.Struct
	19, // 19: pulumirpc.TransformationResponse.props:type_name -> google.protobuf.Struct
	11, // 20: pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceRequest.PropertyDependencies
	16, // 21: pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceResponse.PropertyDependencies
	0,  // 22: pulumirpc.ResourceMonitor.SupportsFeature:input_type -> pulumirpc.SupportsFeatureRequest
	7,  // 23: pulumirpc.ResourceMonitor.Invoke:input_type -> pulumirpc.ResourceInvokeRequest
	7,  // 24: pulumirpc.ResourceMonitor.StreamInvoke:input_type -> pulumirpc.ResourceInvokeRequest
	23, // 25: pulumirpc.ResourceMonitor.Call:input_type -> pulumirpc.CallRequest
	2,  // 26: pulumirpc.ResourceMonitor.ReadResource:input_type -> pulumirpc.ReadResourceRequest
	4,  // 27: pulumirpc.ResourceMonitor.RegisterResource:input_type -> pulumirpc.RegisterResourceRequest
	6,  // 28: pulumirpc.ResourceMonitor.RegisterResourceOutputs:input_type -> pulumirpc.RegisterResourceOutputsRequest
	22, // 29: pulumirpc.ResourceMonitor.RegisterStackTransformation:input_type -> pulumirpc.Callback
	1,  // 30: pulumirpc.ResourceMonitor.SupportsFeature:output_type -> pulumirpc.SupportsFeatureResponse
	24, // 31: pulumirpc.ResourceMonitor.Invoke:output_type -> pulumirpc.InvokeResponse
	24, // 32: pulumirpc.ResourceMonitor.StreamInvoke:output_type -> pulumirpc.InvokeResponse
	25, // 33: pulumirpc.ResourceMonitor.Call:output_type -> pulumirpc.CallResponse
	3,  // 34: pulumirpc.ResourceMonitor.ReadResource:output_type -> pulumirpc.ReadResourceResponse
	5,  // 35: pulumirpc.ResourceMonitor.RegisterResource:output_type -> pulumirpc.RegisterResourceResponse
	26, // 36: pulumirpc.ResourceMonitor.RegisterResourceOutputs:output_type -> google.protobuf.Empty
	26, // 37: pulumirpc.ResourceMonitor.RegisterStackTransformation:output_type -> google.protobuf.Empty
