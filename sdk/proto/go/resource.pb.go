...
type RegisterDefaultProviderRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Provider string `protobuf:"bytes,1,opt,name=provider,proto3" json:"provider,omitempty"` // the provider ref to register as the default provider.
}

func (x *RegisterDefaultProviderRequest) Reset() {
	*x = RegisterDefaultProviderRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *RegisterDefaultProviderRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterDefaultProviderRequest) ProtoMessage() {}

func (x *RegisterDefaultProviderRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pulumi_resource_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterDefaultProviderRequest.ProtoReflect.Descriptor instead.
func (*RegisterDefaultProviderRequest) Descriptor() ([]byte, []int) {
	return file_pulumi_resource_proto_rawDescGZIP(), []int{12}
}

func (x *RegisterDefaultProviderRequest) GetProvider() string {
	if x != nil {
		return x.Provider
	}
	return ""
...
var file_pulumi_resource_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x52, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x3c, 0x0a, 0x1e,
	0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x50,
	...
	0x52, 0x08, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x2a, 0x29, 0x0a, 0x06, 0x52, 0x65,
	...
	0x4b, 0x49, 0x50, 0x10, 0x02, 0x32, 0x85, 0x06, 0x0a, 0x0f, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	...
	0x17, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x29, 0x2e, 0x70, 0x75, 0x6c, 0x75, 0x6d,
	0x69, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x44, 0x65, 0x66,
...
var file_pulumi_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_pulumi_resource_proto_goTypes = []interface{}{
	...
	(*RegisterDefaultProviderRequest)(nil),               // 13: pulumirpc.RegisterDefaultProviderRequest
	nil,                                                  // 14: pulumirpc.ReadResourceRequest.PluginChecksumsEntry
	(*RegisterResourceRequest_PropertyDependencies)(nil), // 15: pulumirpc.RegisterResourceRequest.PropertyDependencies
	(*RegisterResourceRequest_CustomTimeouts)(nil),       // 16: pulumirpc.RegisterResourceRequest.CustomTimeouts
	nil, // 17: pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry
	nil, // 18: pulumirpc.RegisterResourceRequest.ProvidersEntry
	nil, // 19: pulumirpc.RegisterResourceRequest.PluginChecksumsEntry
	(*RegisterResourceResponse_PropertyDependencies)(nil), // 20: pulumirpc.RegisterResourceResponse.PropertyDependencies
	nil, // 21: pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry
	nil, // 22: pulumirpc.ResourceInvokeRequest.PluginChecksumsEntry
	(*ResourceCallRequest_ArgumentDependencies)(nil), // 23: pulumirpc.ResourceCallRequest.ArgumentDependencies
	nil,                     // 24: pulumirpc.ResourceCallRequest.ArgDependenciesEntry
	nil,                     // 25: pulumirpc.ResourceCallRequest.PluginChecksumsEntry
	nil,                     // 26: pulumirpc.TransformResourceOptions.ProvidersEntry
	nil,                     // 27: pulumirpc.TransformResourceOptions.PluginChecksumsEntry
	(*structpb.Struct)(nil), // 28: google.protobuf.Struct
	(*SourcePosition)(nil),  // 29: pulumirpc.SourcePosition
	(*Alias)(nil),           // 30: pulumirpc.Alias
	(*Callback)(nil),        // 31: pulumirpc.Callback
	(*InvokeResponse)(nil),  // 32: pulumirpc.InvokeResponse
	(*CallResponse)(nil),    // 33: pulumirpc.CallResponse
	(*emptypb.Empty)(nil),   // 34: google.protobuf.Empty
}
var file_pulumi_resource_proto_depIdxs = []int32{
	28, // 0: pulumirpc.ReadResourceRequest.properties:type_name -> google.protobuf.Struct
	14, // 1: pulumirpc.ReadResourceRequest.pluginChecksums:type_name -> pulumirpc.ReadResourceRequest.PluginChecksumsEntry
	29, // 2: pulumirpc.ReadResourceRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	28, // 3: pulumirpc.ReadResourceResponse.properties:type_name -> google.protobuf.Struct
	28, // 4: pulumirpc.RegisterResourceRequest.object:type_name -> google.protobuf.Struct
	17, // 5: pulumirpc.RegisterResourceRequest.propertyDependencies:type_name -> pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry
	16, // 6: pulumirpc.RegisterResourceRequest.customTimeouts:type_name -> pulumirpc.RegisterResourceRequest.CustomTimeouts
	18, // 7: pulumirpc.RegisterResourceRequest.providers:type_name -> pulumirpc.RegisterResourceRequest.ProvidersEntry
	19, // 8: pulumirpc.RegisterResourceRequest.pluginChecksums:type_name -> pulumirpc.RegisterResourceRequest.PluginChecksumsEntry
	30, // 9: pulumirpc.RegisterResourceRequest.aliases:type_name -> pulumirpc.Alias
	29, // 10: pulumirpc.RegisterResourceRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	31, // 11: pulumirpc.RegisterResourceRequest.transforms:type_name -> pulumirpc.Callback
	28, // 12: pulumirpc.RegisterResourceResponse.object:type_name -> google.protobuf.Struct
	21, // 13: pulumirpc.RegisterResourceResponse.propertyDependencies:type_name -> pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry
	0,  // 14: pulumirpc.RegisterResourceResponse.result:type_name -> pulumirpc.Result
	28, // 15: pulumirpc.RegisterResourceOutputsRequest.outputs:type_name -> google.protobuf.Struct
	28, // 16: pulumirpc.ResourceInvokeRequest.args:type_name -> google.protobuf.Struct
	22, // 17: pulumirpc.ResourceInvokeRequest.pluginChecksums:type_name -> pulumirpc.ResourceInvokeRequest.PluginChecksumsEntry
	29, // 18: pulumirpc.ResourceInvokeRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	28, // 19: pulumirpc.ResourceCallRequest.args:type_name -> google.protobuf.Struct
	24, // 20: pulumirpc.ResourceCallRequest.argDependencies:type_name -> pulumirpc.ResourceCallRequest.ArgDependenciesEntry
	25, // 21: pulumirpc.ResourceCallRequest.pluginChecksums:type_name -> pulumirpc.ResourceCallRequest.PluginChecksumsEntry
	29, // 22: pulumirpc.ResourceCallRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	30, // 23: pulumirpc.TransformResourceOptions.aliases:type_name -> pulumirpc.Alias
	16, // 24: pulumirpc.TransformResourceOptions.custom_timeouts:type_name -> pulumirpc.RegisterResourceRequest.CustomTimeouts
	26, // 25: pulumirpc.TransformResourceOptions.providers:type_name -> pulumirpc.TransformResourceOptions.ProvidersEntry
	27, // 26: pulumirpc.TransformResourceOptions.plugin_checksums:type_name -> pulumirpc.TransformResourceOptions.PluginChecksumsEntry
	28, // 27: pulumirpc.TransformRequest.properties:type_name -> google.protobuf.Struct
	10, // 28: pulumirpc.TransformRequest.options:type_name -> pulumirpc.TransformResourceOptions
	28, // 29: pulumirpc.TransformResponse.properties:type_name -> google.protobuf.Struct
	10, // 30: pulumirpc.TransformResponse.options:type_name -> pulumirpc.TransformResourceOptions
	15, // 31: pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceRequest.PropertyDependencies
	20, // 32: pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceResponse.PropertyDependencies
	23, // 33: pulumirpc.ResourceCallRequest.ArgDependenciesEntry.value:type_name -> pulumirpc.ResourceCallRequest.ArgumentDependencies
	...
	31, // 41: pulumirpc.ResourceMonitor.RegisterStackTransform:input_type -> pulumirpc.Callback
	13, // 42: pulumirpc.ResourceMonitor.RegisterDefaultProvider:input_type -> pulumirpc.RegisterDefaultProviderRequest
	2,  // 43: pulumirpc.ResourceMonitor.SupportsFeature:output_type -> pulumirpc.SupportsFeatureResponse
	32, // 44: pulumirpc.ResourceMonitor.Invoke:output_type -> pulumirpc.InvokeResponse
	32, // 45: pulumirpc.ResourceMonitor.StreamInvoke:output_type -> pulumirpc.InvokeResponse
	33, // 46: pulumirpc.ResourceMonitor.Call:output_type -> pulumirpc.CallResponse
	...
	34, // 49: pulumirpc.ResourceMonitor.RegisterResourceOutputs:output_type -> google.protobuf.Empty
	34, // 50: pulumirpc.ResourceMonitor.RegisterStackTransform:output_type -> google.protobuf.Empty
	34, // 51: pulumirpc.ResourceMonitor.RegisterDefaultProvider:output_type -> google.protobuf.Empty
...
func file_pulumi_resource_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pulumi_resource_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RegisterDefaultProviderRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
