...
const (
	DeleteBehaviour_DELETE  DeleteBehaviour = 0
	DeleteBehaviour_DROP    DeleteBehaviour = 1
	DeleteBehaviour_PROTECT DeleteBehaviour = 2
)

var DeleteBehaviour_name = map[int32]string{
	0: "DELETE",
	1: "DROP",
	2: "PROTECT",
}

var DeleteBehaviour_value = map[string]int32{
	"DELETE":  0,
	"DROP":    1,
	"PROTECT": 2,
}

func (x DeleteBehaviour) String() string {
	return proto.EnumName(DeleteBehaviour_name, int32(x))
}

func (DeleteBehaviour) EnumDescriptor() ([]byte, []int) {
...
type RegisterResourceRequest struct {
	...
	DeleteBehaviour            DeleteBehaviour                                          `protobuf:"varint,25,opt,name=deleteBehaviour,proto3,enum=pulumirpc.DeleteBehaviour" json:"deleteBehaviour,omitempty"`
	XXX_NoUnkeyedLiteral       struct{}                                                 `json:"-"`
	XXX_unrecognized           []byte                                                   `json:"-"`
	XXX_sizecache              int32                                                    `json:"-"`
}
...
func (m *RegisterResourceRequest) GetDeleteBehaviour() DeleteBehaviour {
	if m != nil {
		return m.DeleteBehaviour
	}
	return DeleteBehaviour_DELETE
}
...
func init() {
	proto.RegisterEnum("pulumirpc.DeleteBehaviour", DeleteBehaviour_name, DeleteBehaviour_value)
...
var fileDescriptor_d1b72f771c35e3b8 = []byte{
	...
	,
}
