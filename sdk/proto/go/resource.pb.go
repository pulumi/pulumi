...
func (*ReadResourceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_422d9c60820b8eaa, []int{0}
}
...
func (*ReadResourceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_422d9c60820b8eaa, []int{1}
}
...
func (*RegisterResourceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_422d9c60820b8eaa, []int{2}
}
...
type RegisterResourceRequest_PropertyDependencies struct {
	Urn                  []string `protobuf:"bytes,1,rep,name=urn" json:"urn,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*RegisterResourceRequest_PropertyDependencies) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_422d9c60820b8eaa, []int{2, 0}
}
...
func (m *RegisterResourceRequest_PropertyDependencies) GetUrn() []string {
	if m != nil {
		return m.Urn
	}
	return nil
...
func (*RegisterResourceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_422d9c60820b8eaa, []int{3}
}
...
func (*RegisterResourceOutputsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_422d9c60820b8eaa, []int{4}
}
...
func init() { proto.RegisterFile("resource.proto", fileDescriptor_resource_422d9c60820b8eaa) }

var fileDescriptor_resource_422d9c60820b8eaa = []byte{
	// 573 bytes of a gzipped FileDescriptorProto
	,
}
