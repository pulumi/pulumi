...
const (
	...
	ResourceMonitorFeature_RESOURCE_MONITOR_FEATURE_STATE_MIGRATIONS ResourceMonitorFeature = 14
)
...
var (
	ResourceMonitorFeature_name = map[int32]string{
		...
		14: "RESOURCE_MONITOR_FEATURE_STATE_MIGRATIONS",
	}
...
const file_pulumi_resource_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tR\x04name\x12/\n" +
	"\bcallback\x18\x02 \x01(\v2\x13.pulumirpc.CallbackR\bcallback*\xbb\x05\n" +
...
var file_pulumi_resource_proto_goTypes = []any{
	...
	nil,                     // 50: pulumirpc.StateMigrationResponse.SuccessorsEntry
...
var file_pulumi_resource_proto_depIdxs = []int32{
	...
	52, // 7: pulumirpc.RegisterResourceRequest.object:type_name -> google.protobuf.Struct
	...
	55, // 12: pulumirpc.RegisterResourceRequest.aliases:type_name -> pulumirpc.Alias
	56, // 13: pulumirpc.RegisterResourceRequest.replacement_trigger:type_name -> google.protobuf.Value
	53, // 14: pulumirpc.RegisterResourceRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	54, // 15: pulumirpc.RegisterResourceRequest.stackTrace:type_name -> pulumirpc.StackTrace
	57, // 16: pulumirpc.RegisterResourceRequest.transforms:type_name -> pulumirpc.Callback
	...
	57, // 19: pulumirpc.RegisterResourceRequest.state_migrations:type_name -> pulumirpc.Callback
	52, // 20: pulumirpc.RegisterResourceResponse.object:type_name -> google.protobuf.Struct
	...
	52, // 23: pulumirpc.RegisterResourceOutputsRequest.outputs:type_name -> google.protobuf.Struct
	52, // 24: pulumirpc.ResourceInvokeRequest.args:type_name -> google.protobuf.Struct
	41, // 25: pulumirpc.ResourceInvokeRequest.pluginChecksums:type_name -> pulumirpc.ResourceInvokeRequest.PluginChecksumsEntry
	53, // 26: pulumirpc.ResourceInvokeRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	54, // 27: pulumirpc.ResourceInvokeRequest.stackTrace:type_name -> pulumirpc.StackTrace
	52, // 28: pulumirpc.ResourceCallRequest.args:type_name -> google.protobuf.Struct
	...
	53, // 31: pulumirpc.ResourceCallRequest.sourcePosition:type_name -> pulumirpc.SourcePosition
	54, // 32: pulumirpc.ResourceCallRequest.stackTrace:type_name -> pulumirpc.StackTrace
	55, // 33: pulumirpc.TransformResourceOptions.aliases:type_name -> pulumirpc.Alias
	...
	56, // 38: pulumirpc.TransformResourceOptions.replacement_trigger:type_name -> google.protobuf.Value
	55, // 39: pulumirpc.ResourceOptions.aliases:type_name -> pulumirpc.Alias
	...
	56, // 44: pulumirpc.ResourceOptions.replacement_trigger:type_name -> google.protobuf.Value
	52, // 45: pulumirpc.TransformRequest.properties:type_name -> google.protobuf.Struct
	12, // 46: pulumirpc.TransformRequest.options:type_name -> pulumirpc.TransformResourceOptions
	52, // 47: pulumirpc.TransformResponse.properties:type_name -> google.protobuf.Struct
	12, // 48: pulumirpc.TransformResponse.options:type_name -> pulumirpc.TransformResourceOptions
	52, // 49: pulumirpc.TransformInvokeRequest.args:type_name -> google.protobuf.Struct
	18, // 50: pulumirpc.TransformInvokeRequest.options:type_name -> pulumirpc.TransformInvokeOptions
	52, // 51: pulumirpc.TransformInvokeResponse.args:type_name -> google.protobuf.Struct
	...
	50, // 54: pulumirpc.StateMigrationResponse.successors:type_name -> pulumirpc.StateMigrationResponse.SuccessorsEntry
	...
	13, // 59: pulumirpc.ResourceHookRequest.old_options:type_name -> pulumirpc.ResourceOptions
	13, // 60: pulumirpc.ResourceHookRequest.new_options:type_name -> pulumirpc.ResourceOptions
	...
	13, // 64: pulumirpc.ErrorHookRequest.old_options:type_name -> pulumirpc.ResourceOptions
	13, // 65: pulumirpc.ErrorHookRequest.new_options:type_name -> pulumirpc.ResourceOptions
	...
	27, // 68: pulumirpc.RegisterPackageRequest.extension:type_name -> pulumirpc.Parameterization
	57, // 69: pulumirpc.RegisterResourceHookRequest.callback:type_name -> pulumirpc.Callback
	57, // 70: pulumirpc.RegisterErrorHookRequest.callback:type_name -> pulumirpc.Callback
	32, // 71: pulumirpc.RegisterResourceRequest.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceRequest.PropertyDependencies
	39, // 72: pulumirpc.RegisterResourceResponse.PropertyDependenciesEntry.value:type_name -> pulumirpc.RegisterResourceResponse.PropertyDependencies
	42, // 73: pulumirpc.ResourceCallRequest.ArgDependenciesEntry.value:type_name -> pulumirpc.ResourceCallRequest.ArgumentDependencies
	58, // 74: pulumirpc.ResourceMonitor.GetDeploymentInfo:input_type -> google.protobuf.Empty
	...
	11, // 77: pulumirpc.ResourceMonitor.Call:input_type -> pulumirpc.ResourceCallRequest
	...
	58, // 93: pulumirpc.ResourceMonitor.RegisterResourceOutputs:output_type -> google.protobuf.Empty
	58, // 94: pulumirpc.ResourceMonitor.RegisterStackTransform:output_type -> google.protobuf.Empty
	58, // 95: pulumirpc.ResourceMonitor.RegisterStackInvokeTransform:output_type -> google.protobuf.Empty
	58, // 96: pulumirpc.ResourceMonitor.RegisterResourceHook:output_type -> google.protobuf.Empty
	58, // 97: pulumirpc.ResourceMonitor.RegisterErrorHook:output_type -> google.protobuf.Empty
	26, // 98: pulumirpc.ResourceMonitor.RegisterPackage:output_type -> pulumirpc.RegisterPackageResponse
	58, // 99: pulumirpc.ResourceMonitor.SignalAndWaitForShutdown:output_type -> google.protobuf.Empty
