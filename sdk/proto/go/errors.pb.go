...
type InvalidInputPropertiesError struct {
	...
	Errors []*InvalidInputPropertiesError_PropertyError `protobuf:"bytes,1,rep,name=errors,proto3" json:"errors,omitempty"`
}
...
func (x *InvalidInputPropertiesError) GetErrors() []*InvalidInputPropertiesError_PropertyError {
	if x != nil {
		return x.Errors
	}
	return nil
...
type InvalidInputPropertiesError_PropertyError struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InvalidInputPropertiesError_PropertyError) Reset() {
	*x = InvalidInputPropertiesError_PropertyError{}
	if protoimpl.UnsafeEnabled {
...
func (x *InvalidInputPropertiesError_PropertyError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InvalidInputPropertiesError_PropertyError) ProtoMessage() {}

func (x *InvalidInputPropertiesError_PropertyError) ProtoReflect() protoreflect.Message {
	mi := &file_pulumi_errors_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InvalidInputPropertiesError_PropertyError.ProtoReflect.Descriptor instead.
func (*InvalidInputPropertiesError_PropertyError) Descriptor() ([]byte, []int) {
	return file_pulumi_errors_proto_rawDescGZIP(), []int{1, 0}
}

func (x *InvalidInputPropertiesError_PropertyError) GetPropertyPath() string {
	if x != nil {
...
func (x *InvalidInputPropertiesError_PropertyError) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
var file_pulumi_errors_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x6b, 0x54, 0x72, 0x61, 0x63, 0x65, 0x22, 0xb9, 0x01, 0x0a, 0x1b, 0x49, 0x6e, 0x76,
	0x61, 0x6c, 0x69, 0x64, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74,
	0x69, 0x65, 0x73, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x4c, 0x0a, 0x06, 0x65, 0x72, 0x72, 0x6f,
	0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x70, 0x75, 0x6c, 0x75, 0x6d,
	...
	0x2e, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x06,
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x1a, 0x4c, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72,
	0x74, 0x79, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x72, 0x6f, 0x70, 0x65,
	0x72, 0x74, 0x79, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c,
	0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x50, 0x61, 0x74, 0x68, 0x12, 0x16, 0x0a, 0x06,
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65,
	0x61, 0x73, 0x6f, 0x6e, 0x42, 0x34, 0x5a, 0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_pulumi_errors_proto_goTypes = []interface{}{
	...
	(*InvalidInputPropertiesError_PropertyError)(nil), // 2: pulumirpc.InvalidInputPropertiesError.PropertyError
}
var file_pulumi_errors_proto_depIdxs = []int32{
	2, // 0: pulumirpc.InvalidInputPropertiesError.errors:type_name -> pulumirpc.InvalidInputPropertiesError.PropertyError
...
func file_pulumi_errors_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pulumi_errors_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InvalidInputPropertiesError_PropertyError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
