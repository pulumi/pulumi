...
type PropertiesError struct {
	...
	Errors []*PropertiesError_PropertyError `protobuf:"bytes,1,rep,name=errors,proto3" json:"errors,omitempty"`
}

func (x *PropertiesError) Reset() {
	*x = PropertiesError{}
	if protoimpl.UnsafeEnabled {
...
func (x *PropertiesError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PropertiesError) ProtoMessage() {}

func (x *PropertiesError) ProtoReflect() protoreflect.Message {
	mi := &file_pulumi_errors_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PropertiesError.ProtoReflect.Descriptor instead.
func (*PropertiesError) Descriptor() ([]byte, []int) {
	return file_pulumi_errors_proto_rawDescGZIP(), []int{1}
}

func (x *PropertiesError) GetErrors() []*PropertiesError_PropertyError {
	if x != nil {
		return x.Errors
	}
	return nil
...
type PropertiesError_PropertyError struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PropertiesError_PropertyError) Reset() {
	*x = PropertiesError_PropertyError{}
	if protoimpl.UnsafeEnabled {
...
func (x *PropertiesError_PropertyError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PropertiesError_PropertyError) ProtoMessage() {}

func (x *PropertiesError_PropertyError) ProtoReflect() protoreflect.Message {
	mi := &file_pulumi_errors_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PropertiesError_PropertyError.ProtoReflect.Descriptor instead.
func (*PropertiesError_PropertyError) Descriptor() ([]byte, []int) {
	return file_pulumi_errors_proto_rawDescGZIP(), []int{1, 0}
}

func (x *PropertiesError_PropertyError) GetPropertyName() string {
	if x != nil {
...
func (x *PropertiesError_PropertyError) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
var file_pulumi_errors_proto_rawDesc = []byte{
	...
	0x61, 0x63, 0x6b, 0x54, 0x72, 0x61, 0x63, 0x65, 0x22, 0xa1, 0x01, 0x0a, 0x0f, 0x50, 0x72, 0x6f,
	0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x40, 0x0a, 0x06,
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x70,
	0x75, 0x6c, 0x75, 0x6d, 0x69, 0x72, 0x70, 0x63, 0x2e, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74,
	0x69, 0x65, 0x73, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74,
	0x79, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x1a, 0x4c,
...
var file_pulumi_errors_proto_goTypes = []interface{}{
	...
	(*PropertiesError)(nil),               // 1: pulumirpc.PropertiesError
	(*PropertiesError_PropertyError)(nil), // 2: pulumirpc.PropertiesError.PropertyError
}
var file_pulumi_errors_proto_depIdxs = []int32{
	2, // 0: pulumirpc.PropertiesError.errors:type_name -> pulumirpc.PropertiesError.PropertyError
...
func file_pulumi_errors_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pulumi_errors_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PropertiesError_PropertyError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
