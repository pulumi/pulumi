...
type InvalidInputProperties struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The list of invalid input properties.
	Errors []*InvalidInputProperties_InvalidInputProperty `protobuf:"bytes,1,rep,name=errors,proto3" json:"errors,omitempty"`
}

func (x *InvalidInputProperties) Reset() {
	*x = InvalidInputProperties{}
	if protoimpl.UnsafeEnabled {
...
func (x *InvalidInputProperties) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InvalidInputProperties) ProtoMessage() {}

func (x *InvalidInputProperties) ProtoReflect() protoreflect.Message {
	mi := &file_pulumi_errors_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InvalidInputProperties.ProtoReflect.Descriptor instead.
func (*InvalidInputProperties) Descriptor() ([]byte, []int) {
	return file_pulumi_errors_proto_rawDescGZIP(), []int{1}
}

func (x *InvalidInputProperties) GetErrors() []*InvalidInputProperties_InvalidInputProperty {
	if x != nil {
		return x.Errors
	}
	return nil
...
type InvalidInputProperties_InvalidInputProperty struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *InvalidInputProperties_InvalidInputProperty) Reset() {
	*x = InvalidInputProperties_InvalidInputProperty{}
	if protoimpl.UnsafeEnabled {
...
func (x *InvalidInputProperties_InvalidInputProperty) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InvalidInputProperties_InvalidInputProperty) ProtoMessage() {}

func (x *InvalidInputProperties_InvalidInputProperty) ProtoReflect() protoreflect.Message {
	mi := &file_pulumi_errors_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InvalidInputProperties_InvalidInputProperty.ProtoReflect.Descriptor instead.
func (*InvalidInputProperties_InvalidInputProperty) Descriptor() ([]byte, []int) {
	return file_pulumi_errors_proto_rawDescGZIP(), []int{1, 0}
}

func (x *InvalidInputProperties_InvalidInputProperty) GetPropertyKey() string {
	if x != nil {
...
func (x *InvalidInputProperties_InvalidInputProperty) GetPropertyPath() string {
	if x != nil {
...
func (x *InvalidInputProperties_InvalidInputProperty) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
var file_pulumi_errors_proto_rawDesc = []byte{
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x79, 0x50,
	0x61, 0x74, 0x68, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x42, 0x34, 0x5a, 0x32, 0x67,
...
var file_pulumi_errors_proto_goTypes = []interface{}{
	...
	(*InvalidInputProperties)(nil),                      // 1: pulumirpc.InvalidInputProperties
	(*InvalidInputProperties_InvalidInputProperty)(nil), // 2: pulumirpc.InvalidInputProperties.InvalidInputProperty
}
var file_pulumi_errors_proto_depIdxs = []int32{
	2, // 0: pulumirpc.InvalidInputProperties.errors:type_name -> pulumirpc.InvalidInputProperties.InvalidInputProperty
...
func file_pulumi_errors_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pulumi_errors_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InvalidInputProperties); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pulumi_errors_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InvalidInputProperties_InvalidInputProperty); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
