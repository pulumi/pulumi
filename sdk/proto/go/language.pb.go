...
var file_pulumi_language_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_pulumi_language_proto_goTypes = []interface{}{
	...
	nil,                                            // 28: pulumirpc.AboutResponse.MetadataEntry
	nil,                                            // 29: pulumirpc.RunRequest.ConfigEntry
	(*RuntimeOptionPrompt_RuntimeOptionValue)(nil), // 30: pulumirpc.RuntimeOptionPrompt.RuntimeOptionValue
	nil,                        // 31: pulumirpc.GenerateProgramRequest.SourceEntry
	nil,                        // 32: pulumirpc.GenerateProgramResponse.SourceEntry
	nil,                        // 33: pulumirpc.GenerateProjectRequest.LocalDependenciesEntry
	nil,                        // 34: pulumirpc.GeneratePackageRequest.ExtraFilesEntry
	nil,                        // 35: pulumirpc.GeneratePackageRequest.LocalDependenciesEntry
	(*structpb.Struct)(nil),    // 36: google.protobuf.Struct
	(*PluginDependency)(nil),   // 37: pulumirpc.PluginDependency
	(*PackageDependency)(nil),  // 38: pulumirpc.PackageDependency
	(*codegen.Diagnostic)(nil), // 39: pulumirpc.codegen.Diagnostic
	(*emptypb.Empty)(nil),      // 40: google.protobuf.Empty
	(*PluginInfo)(nil),         // 41: pulumirpc.PluginInfo
}
var file_pulumi_language_proto_depIdxs = []int32{
	36, // 0: pulumirpc.ProgramInfo.options:type_name -> google.protobuf.Struct
	1,  // 1: pulumirpc.AboutRequest.info:type_name -> pulumirpc.ProgramInfo
	28, // 2: pulumirpc.AboutResponse.metadata:type_name -> pulumirpc.AboutResponse.MetadataEntry
	...
	37, // 6: pulumirpc.GetRequiredPluginsResponse.plugins:type_name -> pulumirpc.PluginDependency
	1,  // 7: pulumirpc.GetRequiredPackagesRequest.info:type_name -> pulumirpc.ProgramInfo
	38, // 8: pulumirpc.GetRequiredPackagesResponse.packages:type_name -> pulumirpc.PackageDependency
	29, // 9: pulumirpc.RunRequest.config:type_name -> pulumirpc.RunRequest.ConfigEntry
	36, // 10: pulumirpc.RunRequest.configPropertyMap:type_name -> google.protobuf.Struct
	...
	30, // 15: pulumirpc.RuntimeOptionPrompt.choices:type_name -> pulumirpc.RuntimeOptionPrompt.RuntimeOptionValue
	30, // 16: pulumirpc.RuntimeOptionPrompt.default:type_name -> pulumirpc.RuntimeOptionPrompt.RuntimeOptionValue
	...
	31, // 19: pulumirpc.GenerateProgramRequest.source:type_name -> pulumirpc.GenerateProgramRequest.SourceEntry
	39, // 20: pulumirpc.GenerateProgramResponse.diagnostics:type_name -> pulumirpc.codegen.Diagnostic
	32, // 21: pulumirpc.GenerateProgramResponse.source:type_name -> pulumirpc.GenerateProgramResponse.SourceEntry
	33, // 22: pulumirpc.GenerateProjectRequest.local_dependencies:type_name -> pulumirpc.GenerateProjectRequest.LocalDependenciesEntry
	39, // 23: pulumirpc.GenerateProjectResponse.diagnostics:type_name -> pulumirpc.codegen.Diagnostic
	34, // 24: pulumirpc.GeneratePackageRequest.extra_files:type_name -> pulumirpc.GeneratePackageRequest.ExtraFilesEntry
	35, // 25: pulumirpc.GeneratePackageRequest.local_dependencies:type_name -> pulumirpc.GeneratePackageRequest.LocalDependenciesEntry
	39, // 26: pulumirpc.GeneratePackageResponse.diagnostics:type_name -> pulumirpc.codegen.Diagnostic
	...
	7,  // 28: pulumirpc.LanguageRuntime.GetRequiredPlugins:input_type -> pulumirpc.GetRequiredPluginsRequest
	9,  // 29: pulumirpc.LanguageRuntime.GetRequiredPackages:input_type -> pulumirpc.GetRequiredPackagesRequest
	11, // 30: pulumirpc.LanguageRuntime.Run:input_type -> pulumirpc.RunRequest
	40, // 31: pulumirpc.LanguageRuntime.GetPluginInfo:input_type -> google.protobuf.Empty
	13, // 32: pulumirpc.LanguageRuntime.InstallDependencies:input_type -> pulumirpc.InstallDependenciesRequest
	15, // 33: pulumirpc.LanguageRuntime.RuntimeOptionsPrompts:input_type -> pulumirpc.RuntimeOptionsRequest
	2,  // 34: pulumirpc.LanguageRuntime.About:input_type -> pulumirpc.AboutRequest
	4,  // 35: pulumirpc.LanguageRuntime.GetProgramDependencies:input_type -> pulumirpc.GetProgramDependenciesRequest
	18, // 36: pulumirpc.LanguageRuntime.RunPlugin:input_type -> pulumirpc.RunPluginRequest
	20, // 37: pulumirpc.LanguageRuntime.GenerateProgram:input_type -> pulumirpc.GenerateProgramRequest
	22, // 38: pulumirpc.LanguageRuntime.GenerateProject:input_type -> pulumirpc.GenerateProjectRequest
	24, // 39: pulumirpc.LanguageRuntime.GeneratePackage:input_type -> pulumirpc.GeneratePackageRequest
	26, // 40: pulumirpc.LanguageRuntime.Pack:input_type -> pulumirpc.PackRequest
	8,  // 41: pulumirpc.LanguageRuntime.GetRequiredPlugins:output_type -> pulumirpc.GetRequiredPluginsResponse
	10, // 42: pulumirpc.LanguageRuntime.GetRequiredPackages:output_type -> pulumirpc.GetRequiredPackagesResponse
	12, // 43: pulumirpc.LanguageRuntime.Run:output_type -> pulumirpc.RunResponse
	41, // 44: pulumirpc.LanguageRuntime.GetPluginInfo:output_type -> pulumirpc.PluginInfo
	14, // 45: pulumirpc.LanguageRuntime.InstallDependencies:output_type -> pulumirpc.InstallDependenciesResponse
	17, // 46: pulumirpc.LanguageRuntime.RuntimeOptionsPrompts:output_type -> pulumirpc.RuntimeOptionsResponse
	3,  // 47: pulumirpc.LanguageRuntime.About:output_type -> pulumirpc.AboutResponse
	6,  // 48: pulumirpc.LanguageRuntime.GetProgramDependencies:output_type -> pulumirpc.GetProgramDependenciesResponse
	19, // 49: pulumirpc.LanguageRuntime.RunPlugin:output_type -> pulumirpc.RunPluginResponse
	21, // 50: pulumirpc.LanguageRuntime.GenerateProgram:output_type -> pulumirpc.GenerateProgramResponse
	23, // 51: pulumirpc.LanguageRuntime.GenerateProject:output_type -> pulumirpc.GenerateProjectResponse
	25, // 52: pulumirpc.LanguageRuntime.GeneratePackage:output_type -> pulumirpc.GeneratePackageResponse
	27, // 53: pulumirpc.LanguageRuntime.Pack:output_type -> pulumirpc.PackResponse
