...
var file_pulumi_language_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x72, 0x72, 0x22, 0x94, 0x01, 0x0a, 0x10, 0x52, 0x75, 0x6e, 0x50, 0x6c, 0x75, 0x67,
	0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x70, 0x77, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x70, 0x77, 0x64, 0x12, 0x1c, 0x0a, 0x07, 0x70,
	0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x02, 0x18, 0x01,
	...
	0x2a, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e,
	0x70, 0x75, 0x6c, 0x75, 0x6d, 0x69, 0x72, 0x70, 0x63, 0x2e, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x61,
	0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x6f, 0x0a, 0x11, 0x52,
	...
	0x64, 0x65, 0x42, 0x08, 0x0a, 0x06, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0xbf, 0x01, 0x0a,
	...
	0x67, 0x65, 0x74, 0x1a, 0x39, 0x0a, 0x0b, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x45, 0x6e, 0x74,
	0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20,
	...
	0x73, 0x22, 0xb5, 0x03, 0x0a, 0x16, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x50, 0x61,
	...
	0x63, 0x69, 0x65, 0x73, 0x1a, 0x3d, 0x0a, 0x0f, 0x45, 0x78, 0x74, 0x72, 0x61, 0x46, 0x69, 0x6c,
	...
	0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x50, 0x61, 0x74, 0x68, 0x32, 0xa4, 0x07, 0x0a, 0x0f,
	...
	0x44, 0x65, 0x70, 0x65, 0x6e, 0x64, 0x65, 0x6e, 0x63, 0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x3c, 0x0a, 0x05, 0x41, 0x62, 0x6f, 0x75,
...
var file_pulumi_language_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_pulumi_language_proto_goTypes = []interface{}{
	(*ProgramInfo)(nil),                    // 0: pulumirpc.ProgramInfo
	(*AboutRequest)(nil),                   // 1: pulumirpc.AboutRequest
	(*AboutResponse)(nil),                  // 2: pulumirpc.AboutResponse
	(*GetProgramDependenciesRequest)(nil),  // 3: pulumirpc.GetProgramDependenciesRequest
	(*DependencyInfo)(nil),                 // 4: pulumirpc.DependencyInfo
	(*GetProgramDependenciesResponse)(nil), // 5: pulumirpc.GetProgramDependenciesResponse
	(*GetRequiredPluginsRequest)(nil),      // 6: pulumirpc.GetRequiredPluginsRequest
	(*GetRequiredPluginsResponse)(nil),     // 7: pulumirpc.GetRequiredPluginsResponse
	(*RunRequest)(nil),                     // 8: pulumirpc.RunRequest
	(*RunResponse)(nil),                    // 9: pulumirpc.RunResponse
	(*InstallDependenciesRequest)(nil),     // 10: pulumirpc.InstallDependenciesRequest
	(*InstallDependenciesResponse)(nil),    // 11: pulumirpc.InstallDependenciesResponse
	(*RunPluginRequest)(nil),               // 12: pulumirpc.RunPluginRequest
	(*RunPluginResponse)(nil),              // 13: pulumirpc.RunPluginResponse
	(*GenerateProgramRequest)(nil),         // 14: pulumirpc.GenerateProgramRequest
	(*GenerateProgramResponse)(nil),        // 15: pulumirpc.GenerateProgramResponse
	(*GenerateProjectRequest)(nil),         // 16: pulumirpc.GenerateProjectRequest
	(*GenerateProjectResponse)(nil),        // 17: pulumirpc.GenerateProjectResponse
	(*GeneratePackageRequest)(nil),         // 18: pulumirpc.GeneratePackageRequest
	(*GeneratePackageResponse)(nil),        // 19: pulumirpc.GeneratePackageResponse
	(*PackRequest)(nil),                    // 20: pulumirpc.PackRequest
	(*PackResponse)(nil),                   // 21: pulumirpc.PackResponse
	nil,                                    // 22: pulumirpc.AboutResponse.MetadataEntry
	nil,                                    // 23: pulumirpc.RunRequest.ConfigEntry
	nil,                                    // 24: pulumirpc.GenerateProgramRequest.SourceEntry
	nil,                                    // 25: pulumirpc.GenerateProgramResponse.SourceEntry
	nil,                                    // 26: pulumirpc.GenerateProjectRequest.LocalDependenciesEntry
	nil,                                    // 27: pulumirpc.GeneratePackageRequest.ExtraFilesEntry
	nil,                                    // 28: pulumirpc.GeneratePackageRequest.LocalDependenciesEntry
	(*structpb.Struct)(nil),                // 29: google.protobuf.Struct
	(*PluginDependency)(nil),               // 30: pulumirpc.PluginDependency
	(*codegen.Diagnostic)(nil),             // 31: pulumirpc.codegen.Diagnostic
	(*emptypb.Empty)(nil),                  // 32: google.protobuf.Empty
	(*PluginInfo)(nil),                     // 33: pulumirpc.PluginInfo
}
var file_pulumi_language_proto_depIdxs = []int32{
	29, // 0: pulumirpc.ProgramInfo.options:type_name -> google.protobuf.Struct
	0,  // 1: pulumirpc.AboutRequest.info:type_name -> pulumirpc.ProgramInfo
	22, // 2: pulumirpc.AboutResponse.metadata:type_name -> pulumirpc.AboutResponse.MetadataEntry
	0,  // 3: pulumirpc.GetProgramDependenciesRequest.info:type_name -> pulumirpc.ProgramInfo
	4,  // 4: pulumirpc.GetProgramDependenciesResponse.dependencies:type_name -> pulumirpc.DependencyInfo
	0,  // 5: pulumirpc.GetRequiredPluginsRequest.info:type_name -> pulumirpc.ProgramInfo
	30, // 6: pulumirpc.GetRequiredPluginsResponse.plugins:type_name -> pulumirpc.PluginDependency
	23, // 7: pulumirpc.RunRequest.config:type_name -> pulumirpc.RunRequest.ConfigEntry
	29, // 8: pulumirpc.RunRequest.configPropertyMap:type_name -> google.protobuf.Struct
	0,  // 9: pulumirpc.RunRequest.info:type_name -> pulumirpc.ProgramInfo
	0,  // 10: pulumirpc.InstallDependenciesRequest.info:type_name -> pulumirpc.ProgramInfo
	0,  // 11: pulumirpc.RunPluginRequest.info:type_name -> pulumirpc.ProgramInfo
	24, // 12: pulumirpc.GenerateProgramRequest.source:type_name -> pulumirpc.GenerateProgramRequest.SourceEntry
	31, // 13: pulumirpc.GenerateProgramResponse.diagnostics:type_name -> pulumirpc.codegen.Diagnostic
	25, // 14: pulumirpc.GenerateProgramResponse.source:type_name -> pulumirpc.GenerateProgramResponse.SourceEntry
	26, // 15: pulumirpc.GenerateProjectRequest.local_dependencies:type_name -> pulumirpc.GenerateProjectRequest.LocalDependenciesEntry
	31, // 16: pulumirpc.GenerateProjectResponse.diagnostics:type_name -> pulumirpc.codegen.Diagnostic
	27, // 17: pulumirpc.GeneratePackageRequest.extra_files:type_name -> pulumirpc.GeneratePackageRequest.ExtraFilesEntry
	28, // 18: pulumirpc.GeneratePackageRequest.local_dependencies:type_name -> pulumirpc.GeneratePackageRequest.LocalDependenciesEntry
	31, // 19: pulumirpc.GeneratePackageResponse.diagnostics:type_name -> pulumirpc.codegen.Diagnostic
	6,  // 20: pulumirpc.LanguageRuntime.GetRequiredPlugins:input_type -> pulumirpc.GetRequiredPluginsRequest
	8,  // 21: pulumirpc.LanguageRuntime.Run:input_type -> pulumirpc.RunRequest
	32, // 22: pulumirpc.LanguageRuntime.GetPluginInfo:input_type -> google.protobuf.Empty
	10, // 23: pulumirpc.LanguageRuntime.InstallDependencies:input_type -> pulumirpc.InstallDependenciesRequest
	1,  // 24: pulumirpc.LanguageRuntime.About:input_type -> pulumirpc.AboutRequest
	3,  // 25: pulumirpc.LanguageRuntime.GetProgramDependencies:input_type -> pulumirpc.GetProgramDependenciesRequest
	12, // 26: pulumirpc.LanguageRuntime.RunPlugin:input_type -> pulumirpc.RunPluginRequest
	14, // 27: pulumirpc.LanguageRuntime.GenerateProgram:input_type -> pulumirpc.GenerateProgramRequest
	16, // 28: pulumirpc.LanguageRuntime.GenerateProject:input_type -> pulumirpc.GenerateProjectRequest
	18, // 29: pulumirpc.LanguageRuntime.GeneratePackage:input_type -> pulumirpc.GeneratePackageRequest
	20, // 30: pulumirpc.LanguageRuntime.Pack:input_type -> pulumirpc.PackRequest
	7,  // 31: pulumirpc.LanguageRuntime.GetRequiredPlugins:output_type -> pulumirpc.GetRequiredPluginsResponse
	9,  // 32: pulumirpc.LanguageRuntime.Run:output_type -> pulumirpc.RunResponse
	33, // 33: pulumirpc.LanguageRuntime.GetPluginInfo:output_type -> pulumirpc.PluginInfo
	11, // 34: pulumirpc.LanguageRuntime.InstallDependencies:output_type -> pulumirpc.InstallDependenciesResponse
	2,  // 35: pulumirpc.LanguageRuntime.About:output_type -> pulumirpc.AboutResponse
	5,  // 36: pulumirpc.LanguageRuntime.GetProgramDependencies:output_type -> pulumirpc.GetProgramDependenciesResponse
	13, // 37: pulumirpc.LanguageRuntime.RunPlugin:output_type -> pulumirpc.RunPluginResponse
	15, // 38: pulumirpc.LanguageRuntime.GenerateProgram:output_type -> pulumirpc.GenerateProgramResponse
	17, // 39: pulumirpc.LanguageRuntime.GenerateProject:output_type -> pulumirpc.GenerateProjectResponse
	19, // 40: pulumirpc.LanguageRuntime.GeneratePackage:output_type -> pulumirpc.GeneratePackageResponse
	21, // 41: pulumirpc.LanguageRuntime.Pack:output_type -> pulumirpc.PackResponse
...
func file_pulumi_language_proto_init() {
	...
	file_pulumi_language_proto_msgTypes[13].OneofWrappers = []interface{}{
