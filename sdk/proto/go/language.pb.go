...
type PackPackageRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Stderr      uint64 `protobuf:"varint,3,opt,name=stderr,proto3" json:"stderr,omitempty"`
}

func (x *PackPackageRequest) Reset() {
	*x = PackPackageRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *PackPackageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PackPackageRequest) ProtoMessage() {}

func (x *PackPackageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pulumi_language_proto_msgTypes[12]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PackPackageRequest.ProtoReflect.Descriptor instead.
func (*PackPackageRequest) Descriptor() ([]byte, []int) {
	return file_pulumi_language_proto_rawDescGZIP(), []int{12}
}

func (x *PackPackageRequest) GetPackagePath() string {
	if x != nil {
...
func (x *PackPackageRequest) GetOutPath() string {
	if x != nil {
		return x.OutPath
	}
	return ""
...
func (x *PackPackageRequest) GetStderr() uint64 {
	if x != nil {
		return x.Stderr
	}
	return 0
...
type PackPackageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PackPackageResponse) Reset() {
	*x = PackPackageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *PackPackageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PackPackageResponse) ProtoMessage() {}

func (x *PackPackageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pulumi_language_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PackPackageResponse.ProtoReflect.Descriptor instead.
func (*PackPackageResponse) Descriptor() ([]byte, []int) {
	return file_pulumi_language_proto_rawDescGZIP(), []int{13}
}

func (x *PackPackageResponse) GetArtifactPath() string {
	if x != nil {
...
type PublishPackageRequest struct {
	...
	ArtifactPath string `protobuf:"bytes,1,opt,name=artifact_path,json=artifactPath,proto3" json:"artifact_path,omitempty"`
	Stderr       uint64 `protobuf:"varint,2,opt,name=stderr,proto3" json:"stderr,omitempty"`
}
...
func (x *PublishPackageRequest) GetArtifactPath() string {
	if x != nil {
		return x.ArtifactPath
	}
	return ""
...
func (x *PublishPackageRequest) GetStderr() uint64 {
	if x != nil {
		return x.Stderr
	}
	return 0
...
var file_pulumi_language_proto_rawDesc = []byte{
	...
	0x64, 0x0a, 0x10, 0x52, 0x75, 0x6e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x12,
	0x12, 0x0a, 0x04, 0x61, 0x72, 0x67, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x61,
	0x72, 0x67, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x65, 0x6e, 0x76, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09,
	0x52, 0x03, 0x65, 0x6e, 0x76, 0x22, 0x6f, 0x0a, 0x11, 0x52, 0x75, 0x6e, 0x50, 0x6c, 0x75, 0x67,
	...
	0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x6a, 0x0a, 0x12, 0x50, 0x61, 0x63, 0x6b, 0x50, 0x61,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x3b, 0x0a, 0x05, 0x41,
	0x62, 0x6f, 0x75, 0x74, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x6f, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x50,
	0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x44, 0x65, 0x70, 0x65, 0x6e, 0x64, 0x65, 0x6e, 0x63, 0x69,
	0x65, 0x73, 0x12, 0x28, 0x2e, 0x70, 0x75, 0x6c, 0x75, 0x6d, 0x69, 0x72, 0x70, 0x63, 0x2e, 0x47,
	0x65, 0x74, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x44, 0x65, 0x70, 0x65, 0x6e, 0x64, 0x65,
	0x6e, 0x63, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x70,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x4a, 0x0a, 0x09, 0x52, 0x75, 0x6e,
	0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x12, 0x1b, 0x2e, 0x70, 0x75, 0x6c, 0x75, 0x6d, 0x69, 0x72,
	0x70, 0x63, 0x2e, 0x52, 0x75, 0x6e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75,
	...
	,
...
var file_pulumi_language_proto_goTypes = []interface{}{
	...
	(*PackPackageRequest)(nil),             // 12: pulumirpc.PackPackageRequest
	(*PackPackageResponse)(nil),            // 13: pulumirpc.PackPackageResponse
	(*PublishPackageRequest)(nil),          // 14: pulumirpc.PublishPackageRequest
	(*PublishPackageResponse)(nil),         // 15: pulumirpc.PublishPackageResponse
	nil,                                    // 16: pulumirpc.AboutResponse.MetadataEntry
	nil,                                    // 17: pulumirpc.RunRequest.ConfigEntry
...
var file_pulumi_language_proto_depIdxs = []int32{
	16, // 0: pulumirpc.AboutResponse.metadata:type_name -> pulumirpc.AboutResponse.MetadataEntry
	...
	17, // 3: pulumirpc.RunRequest.config:type_name -> pulumirpc.RunRequest.ConfigEntry
	...
	19, // 6: pulumirpc.LanguageRuntime.GetPluginInfo:input_type -> google.protobuf.Empty
	8,  // 7: pulumirpc.LanguageRuntime.InstallDependencies:input_type -> pulumirpc.InstallDependenciesRequest
	19, // 8: pulumirpc.LanguageRuntime.About:input_type -> google.protobuf.Empty
	1,  // 9: pulumirpc.LanguageRuntime.GetProgramDependencies:input_type -> pulumirpc.GetProgramDependenciesRequest
	10, // 10: pulumirpc.LanguageRuntime.RunPlugin:input_type -> pulumirpc.RunPluginRequest
	14, // 11: pulumirpc.LanguageRuntime.PublishPackage:input_type -> pulumirpc.PublishPackageRequest
	12, // 12: pulumirpc.LanguageRuntime.PackPackage:input_type -> pulumirpc.PackPackageRequest
	5,  // 13: pulumirpc.LanguageRuntime.GetRequiredPlugins:output_type -> pulumirpc.GetRequiredPluginsResponse
	7,  // 14: pulumirpc.LanguageRuntime.Run:output_type -> pulumirpc.RunResponse
	20, // 15: pulumirpc.LanguageRuntime.GetPluginInfo:output_type -> pulumirpc.PluginInfo
	9,  // 16: pulumirpc.LanguageRuntime.InstallDependencies:output_type -> pulumirpc.InstallDependenciesResponse
	0,  // 17: pulumirpc.LanguageRuntime.About:output_type -> pulumirpc.AboutResponse
	3,  // 18: pulumirpc.LanguageRuntime.GetProgramDependencies:output_type -> pulumirpc.GetProgramDependenciesResponse
	11, // 19: pulumirpc.LanguageRuntime.RunPlugin:output_type -> pulumirpc.RunPluginResponse
	15, // 20: pulumirpc.LanguageRuntime.PublishPackage:output_type -> pulumirpc.PublishPackageResponse
	13, // 21: pulumirpc.LanguageRuntime.PackPackage:output_type -> pulumirpc.PackPackageResponse
...
func file_pulumi_language_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pulumi_language_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PackPackageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pulumi_language_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PackPackageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
