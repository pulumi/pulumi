...
func (x *RunPluginRequest) GetExecutionId() string {
	if x != nil {
...
func (x *RuntimeOptionPrompt_RuntimeOptionValue) Reset() {
	*x = RuntimeOptionPrompt_RuntimeOptionValue{}
	mi := &file_pulumi_language_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *LinkRequest_LinkDependency) Reset() {
	*x = LinkRequest_LinkDependency{}
	mi := &file_pulumi_language_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LinkRequest_LinkDependency) Descriptor() ([]byte, []int) {
	return file_pulumi_language_proto_rawDescGZIP(), []int{32, 0}
}
...
const file_pulumi_language_proto_rawDesc = "" +
	...
	"\rloader_target\x18\t \x01(\tR\floaderTarget\x12!\n" +
	"\fexecution_id\x18\n" +
	" \x01(\tR\vexecutionId\"o\n" +
	...
	"\x06output\"2\n" +
	"\rCancelRequest\x12!\n" +
	"\fexecution_id\x18\x01 \x01(\tR\vexecutionId\"\xd7\x01\n" +
	...
	"\fLinkResponse\x12/\n" +
	"\x13import_instructions\x18\x01 \x01(\tR\x12importInstructions2\x89\v\n" +
	...
	"\x06Cancel\x12\x18.pulumirpc.CancelRequest\x1a\x16.google.protobuf.Empty\"\x00B4Z2github.com/pulumi/pulumi/sdk/v3/proto/go;pulumirpcb\x06proto3"
...
var file_pulumi_language_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_pulumi_language_proto_goTypes = []any{
	...
	(*CancelRequest)(nil),                          // 22: pulumirpc.CancelRequest
	(*GenerateProgramRequest)(nil),                 // 23: pulumirpc.GenerateProgramRequest
	(*GenerateProgramResponse)(nil),                // 24: pulumirpc.GenerateProgramResponse
	(*GenerateProjectRequest)(nil),                 // 25: pulumirpc.GenerateProjectRequest
	(*GenerateProjectResponse)(nil),                // 26: pulumirpc.GenerateProjectResponse
	(*GeneratePackageRequest)(nil),                 // 27: pulumirpc.GeneratePackageRequest
	(*GeneratePackageResponse)(nil),                // 28: pulumirpc.GeneratePackageResponse
	(*PackRequest)(nil),                            // 29: pulumirpc.PackRequest
	(*PackResponse)(nil),                           // 30: pulumirpc.PackResponse
	(*LanguageHandshakeRequest)(nil),               // 31: pulumirpc.LanguageHandshakeRequest
	(*LanguageHandshakeResponse)(nil),              // 32: pulumirpc.LanguageHandshakeResponse
	(*LinkRequest)(nil),                            // 33: pulumirpc.LinkRequest
	(*LinkResponse)(nil),                           // 34: pulumirpc.LinkResponse
	nil,                                            // 35: pulumirpc.AboutResponse.MetadataEntry
	nil,                                            // 36: pulumirpc.RunRequest.ConfigEntry
	(*RuntimeOptionPrompt_RuntimeOptionValue)(nil), // 37: pulumirpc.RuntimeOptionPrompt.RuntimeOptionValue
	nil,                                // 38: pulumirpc.GenerateProgramRequest.SourceEntry
	nil,                                // 39: pulumirpc.GenerateProgramResponse.SourceEntry
	nil,                                // 40: pulumirpc.GenerateProjectRequest.LocalDependenciesEntry
	nil,                                // 41: pulumirpc.GeneratePackageRequest.ExtraFilesEntry
	nil,                                // 42: pulumirpc.GeneratePackageRequest.LocalDependenciesEntry
	(*LinkRequest_LinkDependency)(nil), // 43: pulumirpc.LinkRequest.LinkDependency
	(*structpb.Struct)(nil),            // 44: google.protobuf.Struct
	(*PluginDependency)(nil),           // 45: pulumirpc.PluginDependency
	(*PackageDependency)(nil),          // 46: pulumirpc.PackageDependency
...
var file_pulumi_language_proto_depIdxs = []int32{
	44, // 0: pulumirpc.ProgramInfo.options:type_name -> google.protobuf.Struct
	1,  // 1: pulumirpc.AboutRequest.info:type_name -> pulumirpc.ProgramInfo
	35, // 2: pulumirpc.AboutResponse.metadata:type_name -> pulumirpc.AboutResponse.MetadataEntry
	...
	45, // 6: pulumirpc.GetRequiredPluginsResponse.plugins:type_name -> pulumirpc.PluginDependency
	1,  // 7: pulumirpc.GetRequiredPackagesRequest.info:type_name -> pulumirpc.ProgramInfo
	46, // 8: pulumirpc.GetRequiredPackagesResponse.packages:type_name -> pulumirpc.PackageDependency
	36, // 9: pulumirpc.RunRequest.config:type_name -> pulumirpc.RunRequest.ConfigEntry
	44, // 10: pulumirpc.RunRequest.configPropertyMap:type_name -> google.protobuf.Struct
	...
	37, // 15: pulumirpc.RuntimeOptionPrompt.choices:type_name -> pulumirpc.RuntimeOptionPrompt.RuntimeOptionValue
	37, // 16: pulumirpc.RuntimeOptionPrompt.default:type_name -> pulumirpc.RuntimeOptionPrompt.RuntimeOptionValue
	...
	38, // 20: pulumirpc.GenerateProgramRequest.source:type_name -> pulumirpc.GenerateProgramRequest.SourceEntry
	47, // 21: pulumirpc.GenerateProgramResponse.diagnostics:type_name -> pulumirpc.codegen.Diagnostic
	39, // 22: pulumirpc.GenerateProgramResponse.source:type_name -> pulumirpc.GenerateProgramResponse.SourceEntry
	40, // 23: pulumirpc.GenerateProjectRequest.local_dependencies:type_name -> pulumirpc.GenerateProjectRequest.LocalDependenciesEntry
	47, // 24: pulumirpc.GenerateProjectResponse.diagnostics:type_name -> pulumirpc.codegen.Diagnostic
	41, // 25: pulumirpc.GeneratePackageRequest.extra_files:type_name -> pulumirpc.GeneratePackageRequest.ExtraFilesEntry
	42, // 26: pulumirpc.GeneratePackageRequest.local_dependencies:type_name -> pulumirpc.GeneratePackageRequest.LocalDependenciesEntry
	47, // 27: pulumirpc.GeneratePackageResponse.diagnostics:type_name -> pulumirpc.codegen.Diagnostic
	1,  // 28: pulumirpc.LinkRequest.info:type_name -> pulumirpc.ProgramInfo
	43, // 29: pulumirpc.LinkRequest.packages:type_name -> pulumirpc.LinkRequest.LinkDependency
	...
	46, // 31: pulumirpc.LinkRequest.LinkDependency.package:type_name -> pulumirpc.PackageDependency
	31, // 32: pulumirpc.LanguageRuntime.Handshake:input_type -> pulumirpc.LanguageHandshakeRequest
	...
	48, // 36: pulumirpc.LanguageRuntime.GetPluginInfo:input_type -> google.protobuf.Empty
	...
	18, // 39: pulumirpc.LanguageRuntime.Template:input_type -> pulumirpc.TemplateRequest
	2,  // 40: pulumirpc.LanguageRuntime.About:input_type -> pulumirpc.AboutRequest
	4,  // 41: pulumirpc.LanguageRuntime.GetProgramDependencies:input_type -> pulumirpc.GetProgramDependenciesRequest
	20, // 42: pulumirpc.LanguageRuntime.RunPlugin:input_type -> pulumirpc.RunPluginRequest
	23, // 43: pulumirpc.LanguageRuntime.GenerateProgram:input_type -> pulumirpc.GenerateProgramRequest
	25, // 44: pulumirpc.LanguageRuntime.GenerateProject:input_type -> pulumirpc.GenerateProjectRequest
	27, // 45: pulumirpc.LanguageRuntime.GeneratePackage:input_type -> pulumirpc.GeneratePackageRequest
	29, // 46: pulumirpc.LanguageRuntime.Pack:input_type -> pulumirpc.PackRequest
	33, // 47: pulumirpc.LanguageRuntime.Link:input_type -> pulumirpc.LinkRequest
	22, // 48: pulumirpc.LanguageRuntime.Cancel:input_type -> pulumirpc.CancelRequest
	32, // 49: pulumirpc.LanguageRuntime.Handshake:output_type -> pulumirpc.LanguageHandshakeResponse
	8,  // 50: pulumirpc.LanguageRuntime.GetRequiredPlugins:output_type -> pulumirpc.GetRequiredPluginsResponse
	10, // 51: pulumirpc.LanguageRuntime.GetRequiredPackages:output_type -> pulumirpc.GetRequiredPackagesResponse
	12, // 52: pulumirpc.LanguageRuntime.Run:output_type -> pulumirpc.RunResponse
	49, // 53: pulumirpc.LanguageRuntime.GetPluginInfo:output_type -> pulumirpc.PluginInfo
	14, // 54: pulumirpc.LanguageRuntime.InstallDependencies:output_type -> pulumirpc.InstallDependenciesResponse
	17, // 55: pulumirpc.LanguageRuntime.RuntimeOptionsPrompts:output_type -> pulumirpc.RuntimeOptionsResponse
	19, // 56: pulumirpc.LanguageRuntime.Template:output_type -> pulumirpc.TemplateResponse
	3,  // 57: pulumirpc.LanguageRuntime.About:output_type -> pulumirpc.AboutResponse
	6,  // 58: pulumirpc.LanguageRuntime.GetProgramDependencies:output_type -> pulumirpc.GetProgramDependenciesResponse
	21, // 59: pulumirpc.LanguageRuntime.RunPlugin:output_type -> pulumirpc.RunPluginResponse
	24, // 60: pulumirpc.LanguageRuntime.GenerateProgram:output_type -> pulumirpc.GenerateProgramResponse
	26, // 61: pulumirpc.LanguageRuntime.GenerateProject:output_type -> pulumirpc.GenerateProjectResponse
	28, // 62: pulumirpc.LanguageRuntime.GeneratePackage:output_type -> pulumirpc.GeneratePackageResponse
	30, // 63: pulumirpc.LanguageRuntime.Pack:output_type -> pulumirpc.PackResponse
	34, // 64: pulumirpc.LanguageRuntime.Link:output_type -> pulumirpc.LinkResponse
	48, // 65: pulumirpc.LanguageRuntime.Cancel:output_type -> google.protobuf.Empty
...
func file_pulumi_language_proto_init() {
	...
	file_pulumi_language_proto_msgTypes[30].OneofWrappers = []any{}
	type x struct{}
