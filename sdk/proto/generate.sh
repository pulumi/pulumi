...
GO_PULUMIRPC=./go
echo -e "\tGo: $GO_PULUMIRPC"
mkdir -p $GO_PULUMIRPC
$PROTOC --go_out=$GO_PULUMIRPC --go_opt=paths=source_relative --go-grpc_out=$GO_PULUMIRPC --go-grpc_opt=require_unimplemented_servers=false,paths=source_relative  $PROTO_FILES
