...
import (
	...
	"errors"
	"example.com/pulumi-simple-component/sdk/go/v15/simplecomponent/internal"
...
func NewResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("simple-component:index:Resource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
