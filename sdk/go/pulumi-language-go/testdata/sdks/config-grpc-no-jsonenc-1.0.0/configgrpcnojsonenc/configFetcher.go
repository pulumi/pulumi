...
func NewConfigFetcher(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("config-grpc-no-jsonenc:index:ConfigFetcher", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetConfigFetcher(ctx *pulumi.Context,
	...
	var resource ConfigFetcher
	err := ctx.ReadResource("config-grpc-no-jsonenc:index:ConfigFetcher", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
