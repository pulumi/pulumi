...
func NewFoo(ctx *pulumi.Context,
	...
	var resource Foo
	err := ctx.RegisterResource("nestedcollections:index:Foo", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFoo(ctx *pulumi.Context,
	...
	var resource Foo
	err := ctx.ReadResource("nestedcollections:index:Foo", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
