...
func NewElementType(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nestedcollections:elementType:ElementType", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetElementType(ctx *pulumi.Context,
	...
	var resource ElementType
	err := ctx.ReadResource("nestedcollections:elementType:ElementType", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
