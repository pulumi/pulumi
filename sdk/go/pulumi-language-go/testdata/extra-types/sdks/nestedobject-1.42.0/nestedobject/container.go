...
func ContainerExists(ctx *pulumi.Context,
	id pulumi.IDInput, state *ContainerState, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("nestedobject:index:Container", id, state, opts...)
}
