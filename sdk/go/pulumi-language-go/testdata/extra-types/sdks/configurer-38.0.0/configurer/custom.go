...
func NewCustom(ctx *pulumi.Context,
	...
	var resource Custom
	err := ctx.RegisterResource("configurer:index:Custom", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustom(ctx *pulumi.Context,
	...
	var resource Custom
	err := ctx.ReadResource("configurer:index:Custom", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func CustomExists(ctx *pulumi.Context,
	id pulumi.IDInput, state *CustomState, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("configurer:index:Custom", id, state, opts...)
}
...
func (o CustomOutput) Config() pulumi.StringOutput {
	return o.ApplyT(func(v *Custom) pulumi.StringOutput { return v.Config }).(pulumi.StringOutput)
}
