...
func NewLambda(ctx *pulumi.Context,
	...
	var resource Lambda
	err := ctx.RegisterResource("keywords:module:Lambda", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLambda(ctx *pulumi.Context,
	...
	var resource Lambda
	err := ctx.ReadResource("keywords:module:Lambda", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func LambdaExists(ctx *pulumi.Context,
	id pulumi.IDInput, state *LambdaState, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("keywords:module:Lambda", id, state, opts...)
}
