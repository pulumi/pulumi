...
func NewResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("optional-primitive-ref:index:Resource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResource(ctx *pulumi.Context,
	...
	var resource Resource
	err := ctx.ReadResource("optional-primitive-ref:index:Resource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func ResourceExists(ctx *pulumi.Context,
	...
	return ctx.ExistsResource("optional-primitive-ref:index:Resource", id, state, opts...)
}
