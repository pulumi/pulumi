...
func NewResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("module-format:mod_Resource:Resource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResource(ctx *pulumi.Context,
	...
	var resource Resource
	err := ctx.ReadResource("module-format:mod_Resource:Resource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func ResourceExists(ctx *pulumi.Context,
	...
	return ctx.ExistsResource("module-format:mod_Resource:Resource", name, id, state, opts...)
}
...
func (r *Resource) Call(ctx *pulumi.Context, args *ResourceCallArgs) (ResourceCallResultOutput, error) {
	out, err := ctx.Call("module-format:mod_Resource:Resource/call", args, ResourceCallResultOutput{}, r)
	if err != nil {
