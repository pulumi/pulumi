...
func NewResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("index-mod:indexMine/nested:Resource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetResource(ctx *pulumi.Context,
	...
	var resource Resource
	err := ctx.ReadResource("index-mod:indexMine/nested:Resource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func ResourceExists(ctx *pulumi.Context,
	...
	return ctx.ExistsResource("index-mod:indexMine/nested:Resource", name, id, state, opts...)
}
...
func (r *Resource) Call(ctx *pulumi.Context, args *ResourceCallArgs) (ResourceCallResultOutput, error) {
	out, err := ctx.Call("index-mod:indexMine/nested:Resource/call", args, ResourceCallResultOutput{}, r)
	if err != nil {
