...
func NewStringResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("simple-invoke-with-scalar-return:index:StringResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStringResource(ctx *pulumi.Context,
	...
	var resource StringResource
	err := ctx.ReadResource("simple-invoke-with-scalar-return:index:StringResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
