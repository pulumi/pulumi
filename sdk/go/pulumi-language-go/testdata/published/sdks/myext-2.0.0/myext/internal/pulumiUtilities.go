...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-myext/sdk(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	return ctx.GetOrRegisterPackageRef("myext:2.0.0", func() (*pulumirpc.RegisterPackageRequest, error) {
		parameter, err := base64.StdEncoding.DecodeString("SGVsbG8=")
		if err != nil {
			return nil, err
		}
