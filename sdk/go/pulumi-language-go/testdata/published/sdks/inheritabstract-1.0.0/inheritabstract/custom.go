...
func NewCustom(ctx *pulumi.Context,
	...
	var resource Custom
	err := ctx.RegisterResource("inheritabstract:index:Custom", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCustom(ctx *pulumi.Context,
	...
	var resource Custom
	err := ctx.ReadResource("inheritabstract:index:Custom", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
