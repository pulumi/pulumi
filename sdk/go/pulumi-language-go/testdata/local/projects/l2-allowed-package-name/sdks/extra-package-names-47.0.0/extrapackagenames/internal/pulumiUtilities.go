...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-extra-package-names/sdk(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	return ctx.GetOrRegisterPackageRef("extra-package-names:47.0.0", func() (*pulumirpc.RegisterPackageRequest, error) {

		return &pulumirpc.RegisterPackageRequest{
			Name:        "extra-package-names",
			Version:     "47.0.0",
			DownloadUrl: "",
		}, nil
	})
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	version := semver.MustParse("47.0.0")
