...
func NewSomeResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("keywords:lambda:SomeResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSomeResource(ctx *pulumi.Context,
	...
	var resource SomeResource
	err := ctx.ReadResource("keywords:lambda:SomeResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func SomeResourceExists(ctx *pulumi.Context,
	...
	return ctx.ExistsResource("keywords:lambda:SomeResource", name, id, state, opts...)
}
