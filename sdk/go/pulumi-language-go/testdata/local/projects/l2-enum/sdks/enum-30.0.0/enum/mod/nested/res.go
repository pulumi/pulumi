...
func NewRes(ctx *pulumi.Context,
	...
	var resource Res
	err := ctx.RegisterResource("enum:mod/nested:Res", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRes(ctx *pulumi.Context,
	...
	var resource Res
	err := ctx.ReadResource("enum:mod/nested:Res", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func ResExists(ctx *pulumi.Context,
	...
	return ctx.ExistsResource("enum:mod/nested:Res", name, id, state, opts...)
}
