...
replace example.com/pulumi-conformance-component/sdk/go/v22 => /ROOT/projects/l2-resource-option-replace-on-changes/0/sdks/conformance-component-22.0.0
...
replace example.com/pulumi-simple/sdk/go/v2 => /ROOT/projects/l2-resource-option-replace-on-changes/0/sdks/simple-2.0.0
