...
func NewStringResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("multi-argument-invoke:index:StringResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStringResource(ctx *pulumi.Context,
	...
	var resource StringResource
	err := ctx.ReadResource("multi-argument-invoke:index:StringResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// StringResourceExists checks whether an existing StringResource resource with the given ID exists.
func StringResourceExists(ctx *pulumi.Context,
	id pulumi.IDInput, state *StringResourceState, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("multi-argument-invoke:index:StringResource", id, state, opts...)
}
