...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		ctx.Export("out3", callCall2.Output())
		// Next use just the module name as defined by the module format
		...
		ctx.Export("out4", callCall3.Output())
		...
		ctx.Export("out5", callCall4.Output())
		// Next use just the module name as defined by the module format
		...
		ctx.Export("out6", callCall5.Output())
		...
		ctx.Export("out7", callCall6.Output())
		return nil
	})
}
