...
func GetResource(ctx *pulumi.Context,
	...
	var resource Resource
	err := ctx.ReadResource("output:index:Resource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func ResourceExists(ctx *pulumi.Context,
	...
	return ctx.ExistsResource("output:index:Resource", id, state, opts...)
}
...
func (o ResourceOutput) Value() pulumi.Float64Output {
	return o.ApplyT(func(v *Resource) pulumi.Float64Output { return v.Value }).(pulumi.Float64Output)
}
