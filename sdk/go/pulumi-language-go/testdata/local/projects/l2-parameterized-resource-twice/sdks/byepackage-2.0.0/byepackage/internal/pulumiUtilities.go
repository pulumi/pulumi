...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-byepackage/sdk(/v\\d+)?")
...
func PkgGetPackageRef(ctx *pulumi.Context) (string, error) {
	return ctx.GetOrRegisterPackageRef("byepackage:2.0.0", func() (*pulumirpc.RegisterPackageRequest, error) {
		parameter, err := base64.StdEncoding.DecodeString("R29vZGJ5ZVdvcmxk")
		if err != nil {
			return nil, err
		}
