...
var expectedFailures = map[string]string{
	"l2-discriminated-union-internal": "pulumi#16744: __type renders as an unexported field; program-gen emits `cannot refer to unexported field __type in struct literal`", //nolint:lll
