...
func (ctx *Context) getOpts(t string, providers map[string]ProviderResource, opts *resourceOptions, remote bool,
	...
	return parentURN, depURNs, opts.Protect, providerRef, providerRefs, opts.DeleteBeforeReplace,
...
func (ctx *Context) ToOutput(v interface{}) Output {
	return ctx.ToOutputWithContext(context.Background(), v)
}

// ToOutputWithContext returns an Output that will resolve when all Outputs contained in the given value have
// resolved.
func (ctx *Context) ToOutputWithContext(context context.Context, v interface{}) Output {
	return toOutputWithContext(context, &ctx.join, v, nil)
}

func (ctx *Context) Any(v interface{}) AnyOutput {
	return ctx.AnyWithContext(context.Background(), v)
}

func (ctx *Context) AnyWithContext(context context.Context, v interface{}) AnyOutput {
	return anyWithContext(context, &ctx.join, v)
}
...
func (ctx *Context) ToSecret(input interface{}) Output {
	return ctx.ToSecretWithContext(context.Background(), input)
}

// ToSecretWithContext wraps the input in an Output marked as secret
// that will resolve when all Inputs contained in the given value have resolved.
func (ctx *Context) ToSecretWithContext(context context.Context, input interface{}) Output {
	x := true
	o := toOutputWithContext(context, &ctx.join, input, &x)
...
// is rejected.
func (ctx *Context) All(inputs ...interface{}) ArrayOutput {
	return ctx.AllWithContext(context.Background(), inputs...)
}
...
func (ctx *Context) AllWithContext(context context.Context, inputs ...interface{}) ArrayOutput {
	return ctx.ToOutputWithContext(context, inputs).(ArrayOutput)
}
