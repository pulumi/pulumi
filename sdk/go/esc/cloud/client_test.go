...
func TestCreateEnvironment(t *testing.T) {
	t.Run("OK", func(t *testing.T) {
		...
		err := client.CreateEnvironmentWithProject(t.Context(), "test-org", "test-project", "test-env")
...
func TestGetEnvironment(t *testing.T) {
	t.Run("OK", func(t *testing.T) {
		...
		actualYAML, actualTag, revision, err := client.GetEnvironment(t.Context(), "test-org", "test-project", "test-env", "", false)
		require.NoError(t, err)
	...
	t.Run("Revision", func(t *testing.T) {
		...
		actualYAML, actualTag, revision, err := client.GetEnvironment(t.Context(), "test-org", "test-project", "test-env", "42", false)
		require.NoError(t, err)
		assert.Equal(t, string(expectedYAML), string(actualYAML))
		assert.Equal(t, expectedTag, actualTag)
		assert.Equal(t, 1, revision)
	...
	t.Run("Tag", func(t *testing.T) {
		...
		actualYAML, actualTag, revision, err := client.GetEnvironment(t.Context(), "test-org", "test-project", "test-env", "stable", false)
		require.NoError(t, err)
		assert.Equal(t, string(expectedYAML), string(actualYAML))
		assert.Equal(t, expectedTag, actualTag)
		assert.Equal(t, 1, revision)
	...
	t.Run("Decrypt", func(t *testing.T) {
		...
		actualYAML, actualTag, revision, err := client.GetEnvironment(t.Context(), "test-org", "test-project", "test-env", "", true)
		require.NoError(t, err)
		assert.Equal(t, string(expectedYAML), string(actualYAML))
		assert.Equal(t, expectedTag, actualTag)
		assert.Equal(t, 1, revision)
...
func TestUpdateEnvironment(t *testing.T) {
	t.Run("OK", func(t *testing.T) {
		...
		diags, revision, err := client.UpdateEnvironmentWithRevision(t.Context(), "test-org", "test-project", "test-env", yaml, tag)
		require.NoError(t, err)
		assert.Equal(t, 1, revision)
	...
	t.Run("Diags", func(t *testing.T) {
		...
		diags, revision, err := client.UpdateEnvironmentWithRevision(t.Context(), "test-org", "test-project", "test-env", nil, "")
	...
	t.Run("Conflict", func(t *testing.T) {
		...
		_, revision, err := client.UpdateEnvironmentWithRevision(t.Context(), "test-org", "test-project", "test-env", nil, "")
		require.Equal(t, 0, revision)
		assert.ErrorContains(t, err, "conflict")
	})
}
...
func TestCreateEnvironmentDraft(t *testing.T) {
	t.Run("OK", func(t *testing.T) {
		...
		changeRequestID, diags, err := client.CreateEnvironmentDraft(t.Context(), "test-org", "test-project", "test-env", yaml, tag)
		require.NoError(t, err)
	...
	t.Run("Diags", func(t *testing.T) {
		...
		changeRequestID, diags, err := client.CreateEnvironmentDraft(t.Context(), "test-org", "test-project", "test-env", nil, "")
	...
	t.Run("Conflict", func(t *testing.T) {
		...
		changeRequestID, _, err := client.CreateEnvironmentDraft(t.Context(), "test-org", "test-project", "test-env", nil, "")
		require.Equal(t, "", changeRequestID)
		assert.ErrorContains(t, err, "conflict")
	})
}
...
func TestOpenEnvironment(t *testing.T) {
	...
	t.Run("Tag", func(t *testing.T) {
		...
		id, diags, err := client.OpenEnvironment(t.Context(), "test-org", "test-project", "test-env", "stable", duration)
		require.NoError(t, err)
		assert.Equal(t, expectedID, id)
		assert.Empty(t, diags)
	})
...
func TestGetOpenEnvironment(t *testing.T) {
	t.Run("OK", func(t *testing.T) {
		...
		env, err := client.GetOpenEnvironmentWithProject(t.Context(), "test-org", "test-project", "test-env", "session")
		require.NoError(t, err)
		assert.Equal(t, expected, env)
	})
	...
	t.Run("Not found", func(t *testing.T) {
		...
		_, err := client.GetOpenEnvironmentWithProject(t.Context(), "test-org", "test-project", "test-env", "session")
		assert.ErrorContains(t, err, "not found")
	})
}
...
func TestListEnvironmentTags(t *testing.T) {
	t.Run("OK", func(t *testing.T) {
		...
		val, next, err := client.ListEnvironmentTags(t.Context(), "test-org", "test-project", "test-env", ListEnvironmentTagsOptions{
			After: after,
			Count: &count,
		})
		tag := val[0]
	...
	t.Run("Not found", func(t *testing.T) {
		...
		_, _, err := client.ListEnvironmentTags(t.Context(), "test-org", "test-project", "test-env", ListEnvironmentTagsOptions{})
		assert.ErrorContains(t, err, http.StatusText(http.StatusNotFound))
	})
}
...
func TestUpdateEnvironmentTags(t *testing.T) {
	t.Run("OK - value only", func(t *testing.T) {
		...
		val, err := client.UpdateEnvironmentTag(t.Context(), "test-org", "test-project", "test-env", "owner", "pulumi", "", "pulumipus")
		require.NoError(t, err)
		assert.Equal(t, expectedTag.ID, val.ID)
		assert.Equal(t, expectedTag.Created.UTC(), val.Created.UTC())
		assert.Equal(t, expectedTag.Modified.UTC(), val.Modified.UTC())
	...
	t.Run("OK - key only", func(t *testing.T) {
		...
		val, err := client.UpdateEnvironmentTag(t.Context(), "test-org", "test-project", "test-env", "owner", "pulumi", "team", "")
		require.NoError(t, err)
		assert.Equal(t, expectedTag.ID, val.ID)
		assert.Equal(t, expectedTag.Created.UTC(), val.Created.UTC())
		assert.Equal(t, expectedTag.Modified.UTC(), val.Modified.UTC())
	...
	t.Run("Not found", func(t *testing.T) {
		...
		_, err := client.UpdateEnvironmentTag(t.Context(), "test-org", "test-project", "test-env", "owner", "pulumi", "team", "")
		assert.ErrorContains(t, err, http.StatusText(http.StatusNotFound))
	})
}
