...
func TestDeploymentSettingsRoundTrip(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			want: DeploymentSettings{
				Version:        3,
				SettingsSource: ptr(DeploymentSettingsSourceConsole),
		...
		},
		{
			...
			want: DeploymentSettings{
				Version:        4,
				SettingsSource: ptr(DeploymentSettingsSourceGitLabReviewStack),
				VCS: &DeploymentSettingsVCS{
					Provider:            VCSProviderGitLab,
					Repository:          "acme/infra",
					DeployTags:          true,
		...
		},
		{
			...
			want: DeploymentSettings{
				SettingsSource: ptr(DeploymentSettingsSourceAzureDevOpsReviewStack),
				VCS: &DeploymentSettingsVCS{
		...
		},
		{
			...
			want: DeploymentSettings{
				SettingsSource: ptr(DeploymentSettingsSourceBitBucketReviewStack),
		...
		},
		{
			...
			want: DeploymentSettings{
				SettingsSource: ptr(DeploymentSettingsSourceAPI),
				VCS: &DeploymentSettingsVCS{
		...
		},
		{
			...
			want: DeploymentSettings{
				SettingsSource: ptr(DeploymentSettingsSourceGitHubGitOps),
