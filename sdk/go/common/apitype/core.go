...
type ResourceV3 struct {
	...
	IgnoreChanges []resource.BackCompatPropertyPath `json:"ignoreChanges,omitempty" yaml:"ignoreChanges,omitempty"`
	...
	ReplaceOnChanges []resource.BackCompatPropertyPath `json:"replaceOnChanges,omitempty" yaml:"replaceOnChanges,omitempty"`
