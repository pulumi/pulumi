...
type MockHost struct {
	...
	CloseF              func() error
	ShouldDebugPluginF  func(workspace.PluginSpec) bool
...
func (m *MockHost) ShouldDebugPlugin(spec workspace.PluginSpec) bool {
	if m.ShouldDebugPluginF != nil {
		return m.ShouldDebugPluginF(spec)
	}
	return false
}
