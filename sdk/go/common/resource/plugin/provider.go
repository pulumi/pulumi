...
// Invert flips the kind of the diff to the opposite change (Add -> Delete, Delete ->Add, Update->Update)
...
// Invert flips the diff to the opposite diff that would be needed
// to "undo" this diff.
