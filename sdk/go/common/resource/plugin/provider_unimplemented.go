...
func (p *UnimplementedProvider) Migrate(context.Context, MigrateRequest) (MigrateResponse, error) {
	return MigrateResponse{}, status.Error(codes.Unimplemented, "Migrate is not yet implemented")
}
