...
func TestObjectPropertyValueDiffs(t *testing.T) {
	...
	// add two (1 missing key, 1 null), update one, keep two, delete two (1 missing key, 1 null).
	{
		...
		require.Len(t, d4.Updates, 3)
		assert.Equal(t, obj1[PropertyKey("prop-a-2")], d4.Updates[PropertyKey("prop-a-2")].Old)
		assert.Equal(t, obj2[PropertyKey("prop-a-2")], d4.Updates[PropertyKey("prop-a-2")].New)
		...
		assert.Equal(t, obj1[PropertyKey("prop-d-2")], d4.Updates[PropertyKey("prop-d-2")].Old)
		assert.Equal(t, obj2[PropertyKey("prop-d-2")], d4.Updates[PropertyKey("prop-d-2")].New)
	}
}
