...
func TestNonExistentFieldFormatterMessageBody(t *testing.T) {
	...
	tests := []struct {
		...
		{
			NonExistentFieldFormatter{ParentLabel: "parent", Fields: []string{"a", "b"}},
			"field",
			"Existing fields are: a, b",
		},
		{
			NonExistentFieldFormatter{ParentLabel: "parent", Fields: []string{"field3", "field2", "field1"}},
			"field",
			"Existing fields are: field3, field2, field1",
		},
		{
			NonExistentFieldFormatter{
				ParentLabel: "parent",
				Fields:      []string{"field1", "field2", "field3"},
				MaxElements: 4,
			},
			"field",
			"Existing fields are: field1, field2, field3",
		},
		{
			NonExistentFieldFormatter{
				ParentLabel: "parent",
		...
		},
		{
			...
			"field",
			"Existing fields are: field1, field2 and 1 other",
		},
		{
			NonExistentFieldFormatter{
				ParentLabel: "parent",
			...
			"field",
			"Existing fields are: field1 and 2 others",
		},
	}
	for _, tt := range tests {
...
func TestNonExistentFieldFormatterMessage(t *testing.T) {
	...
	tests := []struct {
		...
		{
			NonExistentFieldFormatter{ParentLabel: "parent", Fields: []string{}},
			"field",
			"label",
			"label does not exist on parent. parent has no fields",
		},
		{
			NonExistentFieldFormatter{ParentLabel: "parent", Fields: []string{"a", "b"}},
			"field",
			"label",
			"label does not exist on parent. Existing fields are: a, b",
		},
		{
			NonExistentFieldFormatter{ParentLabel: "parent", Fields: []string{"field3", "field2", "field1"}},
			"field",
			"label",
			"label does not exist on parent. Existing fields are: field3, field2, field1",
		},
		{
			NonExistentFieldFormatter{
				ParentLabel: "parent",
			...
			"field",
			"label",
			"label does not exist on parent. Existing fields are: field1, field2 and 1 other",
		},
	}
	for _, tt := range tests {
		assert.Equalf(
			t,
			tt.want,
			tt.formatter.Message(tt.field, tt.fieldLabel),
			"Message(%s, %s)",
			tt.field,
			tt.fieldLabel,
		)
...
func TestNonExistentFieldFormatterMessageWithDetail(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			"field",
			"label",
			"label does not exist on parent",
