...
func TestGoString(t *testing.T) {
	...
	assert.Equal(
		t,
		"syntax.Object(syntax.ObjectProperty(syntax.String(\"hello\"), syntax.String(\"world\")), syntax.ObjectProperty(syntax.String(\"adieu\"), syntax.String(\"monde cruel\")))", //nolint:lll
		Object(
			ObjectProperty(String("hello"), String("world")),
			ObjectProperty(String("adieu"), String("monde cruel")),
		).GoString(),
	)
}
