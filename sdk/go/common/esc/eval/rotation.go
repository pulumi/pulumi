...
import "github.com/pulumi/pulumi/sdk/v3/go/common/esc/syntax"
...
type Rotation struct {
	...
	// Patch is updated rotation state generated during evaluation, to be written
	// back to the environment definition.
	Patch *Patch
}
