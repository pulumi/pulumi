...
// RunPluginSender is an interface satisfied by both LanguageRuntime_RunPluginServer and
// LanguageRuntime_RunPlugin2Server for streaming RunPluginResponse messages.
type RunPluginSender interface {
	Send(*pulumirpc.RunPluginResponse) error
}

// MakeRunPluginStreams returns a pair of streams for use with the language runtimes RunPlugin or RunPlugin2 methods.
