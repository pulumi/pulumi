...
// This is the language plugin for Bun. This shim around pulumi-language-nodejs exists so that the engine can load
// programs that have the runtime name `bun` specified. The actual LanguageRuntime RPC methods are implemented in
// pulumi-language-nodejs. pulumi-language-nodejs is started as a childprocess with the additional arguments
// `-runtime bun`. Signals are forwarded to this child process.
package main
