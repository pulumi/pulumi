...
export class Res extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'other:mod:Res';
    ...
    declare public readonly choice: pulumi.Output<enums.mod.Choice | undefined>;
    declare public readonly obj: pulumi.Output<outputs.mod.Obj | undefined>;
    ...
    constructor(name: string, args?: ResArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["choice"] = args?.choice;
            resourceInputs["obj"] = args?.obj;
        } else {
            resourceInputs["choice"] = undefined /*out*/;
            resourceInputs["obj"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(Res.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
...
export interface ResArgs {
    choice?: pulumi.Input<enums.mod.Choice | undefined>;
    obj?: pulumi.Input<inputs.mod.ObjArgs | undefined>;
}
