...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "configurer:index:Configurer":
...
pulumi.runtime.registerResourceModule("configurer", "index", _module)
pulumi.runtime.registerResourcePackage("configurer", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:configurer") {
