...
pulumi.runtime.registerResourceModule("discriminated-union-many", "index", _module)
pulumi.runtime.registerResourcePackage("discriminated-union-many", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:discriminated-union-many") {
