...
export class HelloWorld extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing HelloWorld resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("subpackage:index:HelloWorld", id, {}, { ...opts }, utilities.getPackage());
    }
