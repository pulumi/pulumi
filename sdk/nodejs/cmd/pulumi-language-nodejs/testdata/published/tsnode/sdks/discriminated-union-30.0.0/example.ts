...
export class Example extends pulumi.CustomResource {
    ...
    declare public readonly pet: pulumi.Output<outputs.Cat | outputs.Dog | undefined>;
    declare public readonly pets: pulumi.Output<(outputs.Cat | outputs.Dog)[] | undefined>;
...
export interface ExampleArgs {
    pet?: pulumi.Input<inputs.CatArgs | inputs.DogArgs>;
    pets?: pulumi.Input<pulumi.Input<inputs.CatArgs | inputs.DogArgs>[]>;
}
