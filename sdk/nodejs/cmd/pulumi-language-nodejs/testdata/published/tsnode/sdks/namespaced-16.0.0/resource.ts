...
export class Resource extends pulumi.CustomResource {
    ...
    public static exists(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("namespaced:index:Resource", name, id, undefined, opts);
    }

    /** @internal */
    public static readonly __pulumiType = 'namespaced:index:Resource';
    ...
    declare public readonly resourceRef: pulumi.Output<pulumiComponent.Custom | undefined>;
    ...
    constructor(name: string, args: ResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["resourceRef"] = args?.resourceRef;
