...
export class Custom extends pulumi.CustomResource {
    ...
    public static exists(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("plaincomponent:index:Custom", name, id, undefined, opts);
    }

    /** @internal */
    public static readonly __pulumiType = 'plaincomponent:index:Custom';
