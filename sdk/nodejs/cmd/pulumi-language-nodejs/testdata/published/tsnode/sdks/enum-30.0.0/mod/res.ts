...
export class Res extends pulumi.CustomResource {
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("enum:mod:Res", id, {}, { ...opts }, undefined);
    }

    /** @internal */
    public static readonly __pulumiType = 'enum:mod:Res';
    ...
    declare public readonly intEnum: pulumi.Output<enums.mod.IntEnum | undefined>;
    declare public readonly stringEnum: pulumi.Output<enums.mod.StringEnum | undefined>;
