...
export class Receiver extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing Receiver resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("nestedobject:index:Receiver", id, {}, { ...opts }, undefined);
    }
