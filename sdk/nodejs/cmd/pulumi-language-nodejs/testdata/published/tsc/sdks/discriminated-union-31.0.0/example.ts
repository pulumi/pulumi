...
export class Example extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'discriminated-union:index:Example';
    ...
    declare public readonly arrayOfUnionOf: pulumi.Output<(outputs.VariantOne | outputs.VariantTwo)[] | undefined>;
    declare public readonly unionOf: pulumi.Output<outputs.VariantOne | outputs.VariantTwo | undefined>;
    ...
    constructor(name: string, args?: ExampleArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["arrayOfUnionOf"] = args?.arrayOfUnionOf;
            resourceInputs["unionOf"] = args?.unionOf;
        } else {
            resourceInputs["arrayOfUnionOf"] = undefined /*out*/;
