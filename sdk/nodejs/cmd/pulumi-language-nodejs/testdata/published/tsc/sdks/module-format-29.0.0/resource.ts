...
export class Resource extends pulumi.CustomResource {
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("module-format:index_Resource:Resource", id, {}, { ...opts }, undefined);
    }

    /** @internal */
    public static readonly __pulumiType = 'module-format:index_Resource:Resource';
    ...
    call(args: Resource.CallArgs): pulumi.Output<Resource.CallResult> {
        return pulumi.runtime.call("module-format:index_Resource:Resource/call", {
            "__self__": this,
            "input": args.input,
        }, this);
    }
