...
export class Custom extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing Custom resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("configurer:index:Custom", id, {}, { ...opts }, undefined);
    }

    /** @internal */
    public static readonly __pulumiType = 'configurer:index:Custom';
