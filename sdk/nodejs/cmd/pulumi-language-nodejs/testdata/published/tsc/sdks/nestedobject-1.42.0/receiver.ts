...
export class Receiver extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing Receiver resource exists with the given name and ID.
     *
     * @param name The _unique_ name of the resulting resource.
     * @param id The _unique_ provider ID of the resource to lookup.
     * @param opts Optional settings to control the behavior of the CustomResource.
    ...
    public static exists(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("nestedobject:index:Receiver", name, id, undefined, opts);
    }

    /** @internal */
    public static readonly __pulumiType = 'nestedobject:index:Receiver';
    ...
    declare public readonly details: pulumi.Output<outputs.Detail[]>;
...
export interface ReceiverArgs {
    details: pulumi.Input<pulumi.Input<inputs.DetailArgs>[]>;
}
