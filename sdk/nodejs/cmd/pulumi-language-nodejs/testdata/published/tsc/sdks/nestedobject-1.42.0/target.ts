...
export class Target extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing Target resource exists with the given name and ID.
     *
     * @param name The _unique_ name of the resulting resource.
     * @param id The _unique_ provider ID of the resource to lookup.
     * @param opts Optional settings to control the behavior of the CustomResource.
    ...
    public static exists(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("nestedobject:index:Target", name, id, undefined, opts);
    }
