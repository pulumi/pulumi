...
export class Resource extends pulumi.CustomResource {
    ...
    public static exists(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("plain:index:Resource", name, id, undefined, opts);
    }

    /** @internal */
    public static readonly __pulumiType = 'plain:index:Resource';
    ...
    declare public readonly dataList: pulumi.Output<outputs.InnerData[] | undefined>;
    /**
    ...
    constructor(name: string, args: ResourceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["dataList"] = args?.dataList;
            resourceInputs["nonPlainData"] = args?.nonPlainData;
        } else {
            resourceInputs["data"] = undefined /*out*/;
            resourceInputs["dataList"] = undefined /*out*/;
