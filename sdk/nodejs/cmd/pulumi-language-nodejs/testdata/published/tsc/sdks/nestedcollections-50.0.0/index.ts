...
pulumi.runtime.registerResourceModule("nestedcollections", "index", _module)
pulumi.runtime.registerResourcePackage("nestedcollections", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:nestedcollections") {
