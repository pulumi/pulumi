...
export class Goodbye extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing Goodbye resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("goodbye:index:Goodbye", id, {}, { ...opts }, utilities.getPackage());
    }
