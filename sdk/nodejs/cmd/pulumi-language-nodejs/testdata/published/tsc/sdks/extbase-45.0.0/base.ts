...
export class Base extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Base {
        return new Base(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'extbase:index:Base';
    ...
    declare public /*out*/ readonly baseValue: pulumi.Output<string>;
    ...
    constructor(name: string, args?: BaseArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["baseValue"] = undefined /*out*/;
        } else {
            resourceInputs["baseValue"] = undefined /*out*/;
        }
