...
export class SomeResource extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing SomeResource resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("camelNames:CoolModule:SomeResource", id, {}, { ...opts }, undefined);
    }
