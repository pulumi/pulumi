...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "hipackage:index:HelloWorld":
                return new HelloWorld(name, <any>undefined, { urn })
            case "hipackage:index:HelloWorldComponent":
...
pulumi.runtime.registerResourceModule("hipackage", "index", _module)
pulumi.runtime.registerResourcePackage("hipackage", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:hipackage") {
