...
utilities.lazyLoad(exports, ["myInvokeOutput"], () => require("./myInvoke"));
...
utilities.lazyLoad(exports, ["secretInvokeOutput"], () => require("./secretInvoke"));
...
utilities.lazyLoad(exports, ["unitOutput"], () => require("./unit"));
...
pulumi.runtime.registerResourceModule("output-only-invoke", "index", _module)
pulumi.runtime.registerResourcePackage("output-only-invoke", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:output-only-invoke") {
