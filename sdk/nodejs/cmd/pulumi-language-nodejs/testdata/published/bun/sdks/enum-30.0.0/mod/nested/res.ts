...
export class Res extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing Res resource exists with the given name and ID.
     *
     * @param name The _unique_ name of the resulting resource.
     * @param id The _unique_ provider ID of the resource to lookup.
     * @param opts Optional settings to control the behavior of the CustomResource.
    ...
    public static exists(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("enum:mod/nested:Res", name, id, undefined, opts);
    }

    /** @internal */
    public static readonly __pulumiType = 'enum:mod/nested:Res';
    ...
    declare public readonly intEnum: pulumi.Output<enums.mod.nested.IntEnum | undefined>;
    declare public readonly stringEnum: pulumi.Output<enums.mod.nested.StringEnum | undefined>;
    ...
    constructor(name: string, args?: ResArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["intEnum"] = args?.intEnum;
            resourceInputs["stringEnum"] = args?.stringEnum;
        } else {
            resourceInputs["intEnum"] = undefined /*out*/;
...
export interface ResArgs {
    intEnum?: pulumi.Input<enums.mod.nested.IntEnum | undefined>;
    stringEnum?: pulumi.Input<enums.mod.nested.StringEnum | undefined>;
}
