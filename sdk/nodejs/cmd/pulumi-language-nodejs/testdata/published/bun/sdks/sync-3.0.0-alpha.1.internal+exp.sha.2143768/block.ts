...
export class Block extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Block {
        return new Block(name, undefined as any, { ...opts, id: id });
    }

    /**
     * Check whether an existing Block resource exists with the given name and ID.
     *
     * @param name The _unique_ name of the resulting resource.
     * @param id The _unique_ provider ID of the resource to lookup.
     * @param opts Optional settings to control the behavior of the CustomResource.
    ...
    public static exists(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("sync:index:Block", name, id, undefined, opts);
    }

    /** @internal */
    public static readonly __pulumiType = 'sync:index:Block';
    ...
    constructor(name: string, args?: BlockArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Block.__pulumiType, name, resourceInputs, opts);
    }
}
