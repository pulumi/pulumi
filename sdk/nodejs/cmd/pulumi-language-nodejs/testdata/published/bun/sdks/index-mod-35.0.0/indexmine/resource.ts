...
export class Resource extends pulumi.CustomResource {
    ...
    public static exists(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("index-mod:indexMine:Resource", name, id, undefined, opts);
    }

    /** @internal */
    public static readonly __pulumiType = 'index-mod:indexMine:Resource';
    ...
    call(args: Resource.CallArgs): pulumi.Output<Resource.CallResult> {
        return pulumi.runtime.call("index-mod:indexMine:Resource/call", {
            "__self__": this,
            "input": args.input,
        }, this);
    }
