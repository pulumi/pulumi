...
export class Resource extends pulumi.CustomResource {
    ...
    public static exists(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("optionalprimitive:index:Resource", name, id, undefined, opts);
    }

    /** @internal */
    public static readonly __pulumiType = 'optionalprimitive:index:Resource';
    ...
    declare public readonly booleanMap: pulumi.Output<{[key: string]: boolean} | undefined>;
    ...
    declare public readonly numberArray: pulumi.Output<number[] | undefined>;
