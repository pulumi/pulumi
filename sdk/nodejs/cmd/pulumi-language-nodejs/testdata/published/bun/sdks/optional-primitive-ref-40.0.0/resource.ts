...
export class Resource extends pulumi.CustomResource {
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("optional-primitive-ref:index:Resource", id, {}, { ...opts }, undefined);
    }

    /** @internal */
    public static readonly __pulumiType = 'optional-primitive-ref:index:Resource';
