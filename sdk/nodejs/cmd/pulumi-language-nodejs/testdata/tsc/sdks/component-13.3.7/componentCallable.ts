...
export class ComponentCallable extends pulumi.ComponentResource {
    /** @internal */
    public static readonly __pulumiType = 'component:index:ComponentCallable';
     ...
     */
    identity(): pulumi.Output<ComponentCallable.IdentityResult> {
        return pulumi.runtime.call("component:index:ComponentCallable/identity", {
            "__self__": this,
        }, this);
    }
     ...
     */
    prefixed(args: ComponentCallable.PrefixedArgs): pulumi.Output<ComponentCallable.PrefixedResult> {
        return pulumi.runtime.call("component:index:ComponentCallable/prefixed", {
            "__self__": this,
            "prefix": args.prefix,
        }, this);
    }
...
export namespace ComponentCallable {
    ...
    /**
     * The results of the ComponentCallable.prefixed method.
     */
