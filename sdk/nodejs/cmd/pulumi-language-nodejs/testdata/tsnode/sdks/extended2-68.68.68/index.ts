...
pulumi.runtime.registerResourceModule("extended2", "index", _module)
pulumi.runtime.registerResourcePackage("extended2", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:extended2") {
