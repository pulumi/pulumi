...
pulumi.runtime.registerResourceModule("config-grpc-no-jsonenc", "index", _module)
pulumi.runtime.registerResourcePackage("config-grpc-no-jsonenc", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:config-grpc-no-jsonenc") {
