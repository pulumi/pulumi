...
pulumi.runtime.registerResourceModule("extended1", "index", _module)
pulumi.runtime.registerResourcePackage("extended1", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:extended1") {
