...
export class Custom extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'call:index:Custom';
     ...
     */
    providerValue(): pulumi.Output<Custom.ProviderValueResult> {
        return pulumi.runtime.call("call:index:Custom/providerValue", {
            "__self__": this,
        }, this);
    }
}
...
export namespace Custom {
    /**
     * The results of the Custom.providerValue method.
     */
    export interface ProviderValueResult {
