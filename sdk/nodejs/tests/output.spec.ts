...
import { Output, OutputData, all, concat, interpolate, output, unknown } from "../output";
...
describe("output", () => {
    it("propagates true isKnown bit from inner Output", asyncTest(async () => {
        ...
        const output1 = new Output(Promise.resolve(new OutputData(new Set(), "outer", true, false)));
        const output2 = output1.apply(v => new Output(new OutputData(new Set(), "inner", true, false)));
    ...
    it("propagates false isKnown bit from inner Output", asyncTest(async () => {
        ...
        const output1 = new Output(new OutputData(new Set(), "outer", true, false));
        const output2 = output1.apply(v => new Output(new OutputData(new Set(), "inner", false, false)));
    ...
    it("can not await if isKnown is a rejected promise.", asyncTest(async () => {
        ...
        const output1 = new Output(new OutputData(new Set(), "outer", true, false));
        const output2 = output1.apply(v => new Output(Promise.reject(new Error("foo"))));
    ...
    it("propagates true isSecret bit from inner Output", asyncTest(async () => {
        ...
        const output1 = new Output(new OutputData(new Set(), "outer", true, false));
        const output2 = output1.apply(v => new Output(new OutputData(new Set(), "inner", true, true)));
     ...
     it("retains true isSecret bit from outer Output", asyncTest(async () => {
        ...
        const output1 = new Output(new OutputData(new Set(), "outer", true, true));
        const output2 = output1.apply(v => new Output(new OutputData(new Set(), "inner", true, false)));
    ...
    describe("isKnown", () => {
        ...
        function or<T>(output1: any, output2: any): any {
            ...
            return new Output(Promise.all([output1.__data, output2.__data]).then(([d1, d2]) => {
                const data1: OutputData<any> = d1;
                const data2: OutputData<any> = d2;
                return new OutputData(
                    new Set([...data1.resources, ...data2.resources]),
                    data1.value || data2.value,
                    data1.value ? data1.isKnown : data2.isKnown,
                    data1.value ? data1.isSecret : data2.isSecret);
            }));
        }
        ...
        it("choose between known and known output, non-secret", asyncTest(async () => {
            ...
            const o1 = new Output(new OutputData(new Set(), "foo", true, false));
            const o2 = new Output(new OutputData(new Set(), "bar", true, false));
        ...
        it("choose between known and known output, secret", asyncTest(async () => {
            ...
            const o1 = new Output(new OutputData(new Set(), "foo", true, true));
            const o2 = new Output(new OutputData(new Set(), "bar", true, false));
        ...
        it("choose between known and unknown output, non-secret", asyncTest(async () => {
            ...
            const o1 = new Output(new OutputData(new Set(), "foo", true, false));
            const o2 = new Output(new OutputData(new Set(), undefined, false, false));
        ...
        it("choose between unknown and known output, non-secret", asyncTest(async () => {
            ...
            const o1 = new Output(new OutputData(new Set(), undefined, false, false));
            const o2 = new Output(new OutputData(new Set(), "bar", true, false));
        ...
        it("choose between unknown and known output, secret", asyncTest(async () => {
            ...
            const o1 = new Output(new OutputData(new Set(), undefined, false, false));
            const o2 = new Output(new OutputData(new Set(), "bar", true, true));
        ...
        it("choose between unknown and unknown output, secret1", asyncTest(async () => {
            ...
            const o1 = new Output(new OutputData(new Set(), undefined, false, true));
            const o2 = new Output(new OutputData(new Set(), undefined, false, false));
        ...
        it("choose between unknown and unknown output, secret2", asyncTest(async () => {
            ...
            const o1 = new Output(new OutputData(new Set(), undefined, false, false));
            const o2 = new Output(new OutputData(new Set(), undefined, false, true));
        ...
        it("is unknown if the value is or contains unknowns", asyncTest(async () => {
            ...
            const o1 = new Output(new OutputData(new Set(), unknown, true, false));
            const o2 = new Output(new OutputData(new Set(), ["foo", unknown], true, false));
            const o3 = new Output(new OutputData(new Set(), {"foo": "foo", unknown}, true, false));
