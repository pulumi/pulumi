...
goog.exportSymbol('proto.pulumirpc.TransformStackResponse', null, global);
/**
 ...
 * @constructor
 */
proto.pulumirpc.TransformStackResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.pulumirpc.TransformStackResponse.repeatedFields_, null);
};
goog.inherits(proto.pulumirpc.TransformStackResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.TransformStackResponse.displayName = 'proto.pulumirpc.TransformStackResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {string}
 */
proto.pulumirpc.TransformResponse.prototype.getUrn = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.pulumirpc.TransformResponse.prototype.setUrn = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @const
 */
proto.pulumirpc.TransformStackResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.pulumirpc.TransformStackResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.TransformStackResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.TransformStackResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.TransformStackResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    transformsList: jspb.Message.toObjectList(msg.getTransformsList(),
    proto.pulumirpc.TransformResponse.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.TransformStackResponse}
 */
proto.pulumirpc.TransformStackResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.TransformStackResponse;
  return proto.pulumirpc.TransformStackResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.TransformStackResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.TransformStackResponse}
 */
proto.pulumirpc.TransformStackResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.pulumirpc.TransformResponse;
      reader.readMessage(value,proto.pulumirpc.TransformResponse.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.TransformStackResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.TransformStackResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.TransformStackResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.TransformStackResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * repeated TransformResponse transforms = 1;
 * @return {!Array<!proto.pulumirpc.TransformResponse>}
 */
proto.pulumirpc.TransformStackResponse.prototype.getTransformsList = function() {
  return /** @type{!Array<!proto.pulumirpc.TransformResponse>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pulumirpc.TransformResponse, 1));
};


/**
 * @param {!Array<!proto.pulumirpc.TransformResponse>} value
 * @return {!proto.pulumirpc.TransformStackResponse} returns this
*/
proto.pulumirpc.TransformStackResponse.prototype.setTransformsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.pulumirpc.TransformResponse=} opt_value
 * @param {number=} opt_index
 * @return {!proto.pulumirpc.TransformResponse}
 */
proto.pulumirpc.TransformStackResponse.prototype.addTransforms = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.pulumirpc.TransformResponse, opt_index);
};
 ...
 * @return {!proto.pulumirpc.TransformStackResponse} returns this
 */
proto.pulumirpc.TransformStackResponse.prototype.clearTransformsList = function() {
