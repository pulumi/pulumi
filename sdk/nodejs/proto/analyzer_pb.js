...
goog.exportSymbol('proto.pulumirpc.AnalyzeAnnotationChange', null, global);
 ...
 * @constructor
 */
proto.pulumirpc.AnalyzeAnnotationChange = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pulumirpc.AnalyzeAnnotationChange, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.AnalyzeAnnotationChange.displayName = 'proto.pulumirpc.AnalyzeAnnotationChange';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
annotationsMap: (f = msg.getAnnotationsMap()) ? f.toObject(includeInstance, proto.google.protobuf.Struct.toObject) : []
  };
...
proto.pulumirpc.AnalyzerResourceOptions.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(9, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.google.protobuf.Struct.serializeBinaryToWriter);
  }
};
...
/**
 * map<string, google.protobuf.Struct> annotations = 9;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.google.protobuf.Struct>}
 */
proto.pulumirpc.AnalyzerResourceOptions.prototype.getAnnotationsMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.pulumirpc.AnalyzerResourceOptions} returns this
 */
proto.pulumirpc.AnalyzerResourceOptions.prototype.clearAnnotationsMap = function() {
 ...
 * @return {!Object}
 */
proto.pulumirpc.AnalyzeAnnotationChange.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.AnalyzeAnnotationChange.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.AnalyzeAnnotationChange} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.AnalyzeAnnotationChange.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.AnalyzeAnnotationChange}
 */
proto.pulumirpc.AnalyzeAnnotationChange.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.AnalyzeAnnotationChange;
  return proto.pulumirpc.AnalyzeAnnotationChange.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.AnalyzeAnnotationChange} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.AnalyzeAnnotationChange}
 */
proto.pulumirpc.AnalyzeAnnotationChange.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.AnalyzeAnnotationChange.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.AnalyzeAnnotationChange.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.AnalyzeAnnotationChange} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.AnalyzeAnnotationChange.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUrn();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.pulumirpc.AnalyzeAnnotationChange.prototype.getUrn = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pulumirpc.AnalyzeAnnotationChange} returns this
 */
proto.pulumirpc.AnalyzeAnnotationChange.prototype.setUrn = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.AnalyzeAnnotationChange.prototype.getKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pulumirpc.AnalyzeAnnotationChange} returns this
 */
proto.pulumirpc.AnalyzeAnnotationChange.prototype.setKey = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {?proto.google.protobuf.Struct}
 */
proto.pulumirpc.AnalyzeAnnotationChange.prototype.getData = function() {
  return /** @type{?proto.google.protobuf.Struct} */ (
 ...
 * @return {!proto.pulumirpc.AnalyzeAnnotationChange} returns this
*/
proto.pulumirpc.AnalyzeAnnotationChange.prototype.setData = function(value) {
 ...
 * @return {!proto.pulumirpc.AnalyzeAnnotationChange} returns this
 */
proto.pulumirpc.AnalyzeAnnotationChange.prototype.clearData = function() {
 ...
 * @return {boolean}
 */
proto.pulumirpc.AnalyzeAnnotationChange.prototype.hasData = function() {
  return jspb.Message.getField(this, 3) != null;
};
 ...
 * @const
 */
proto.pulumirpc.AnalyzeResponse.repeatedFields_ = [2,3,4];
...
annotationsList: jspb.Message.toObjectList(msg.getAnnotationsList(),
    proto.pulumirpc.AnalyzeAnnotationChange.toObject, includeInstance)
  };
...
proto.pulumirpc.AnalyzeResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.pulumirpc.AnalyzeAnnotationChange;
      reader.readMessage(value,proto.pulumirpc.AnalyzeAnnotationChange.deserializeBinaryFromReader);
...
proto.pulumirpc.AnalyzeResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
      proto.pulumirpc.AnalyzeAnnotationChange.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated AnalyzeAnnotationChange annotations = 4;
 * @return {!Array<!proto.pulumirpc.AnalyzeAnnotationChange>}
 */
proto.pulumirpc.AnalyzeResponse.prototype.getAnnotationsList = function() {
  return /** @type{!Array<!proto.pulumirpc.AnalyzeAnnotationChange>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pulumirpc.AnalyzeAnnotationChange, 4));
};


/**
 * @param {!Array<!proto.pulumirpc.AnalyzeAnnotationChange>} value
 * @return {!proto.pulumirpc.AnalyzeResponse} returns this
*/
proto.pulumirpc.AnalyzeResponse.prototype.setAnnotationsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 4, value);
};


/**
 * @param {!proto.pulumirpc.AnalyzeAnnotationChange=} opt_value
 * @param {number=} opt_index
 * @return {!proto.pulumirpc.AnalyzeAnnotationChange}
 */
proto.pulumirpc.AnalyzeResponse.prototype.addAnnotations = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.pulumirpc.AnalyzeAnnotationChange, opt_index);
};
 ...
 * @return {!proto.pulumirpc.AnalyzeResponse} returns this
 */
proto.pulumirpc.AnalyzeResponse.prototype.clearAnnotationsList = function() {
