...
goog.exportSymbol('pulumirpc.AnalyzeDiagnostic', null, proto);
goog.exportSymbol('pulumirpc.AnalyzeRequest', null, proto);
goog.exportSymbol('pulumirpc.AnalyzeResponse', null, proto);
goog.exportSymbol('pulumirpc.AnalyzeStackRequest', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerHandshakeRequest', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerHandshakeResponse', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerInfo', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerPropertyDependencies', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerProviderResource', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerResource', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerResourceOptions', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerResourceOptions.CustomTimeouts', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerStackConfigureRequest', null, proto);
goog.exportSymbol('pulumirpc.AnalyzerStackConfigureResponse', null, proto);
goog.exportSymbol('pulumirpc.ConfigureAnalyzerRequest', null, proto);
goog.exportSymbol('pulumirpc.EnforcementLevel', null, proto);
goog.exportSymbol('pulumirpc.PolicyComplianceFramework', null, proto);
goog.exportSymbol('pulumirpc.PolicyConfig', null, proto);
goog.exportSymbol('pulumirpc.PolicyConfigSchema', null, proto);
goog.exportSymbol('pulumirpc.PolicyInfo', null, proto);
goog.exportSymbol('pulumirpc.PolicyNotApplicable', null, proto);
goog.exportSymbol('pulumirpc.PolicySeverity', null, proto);
goog.exportSymbol('pulumirpc.PolicyType', null, proto);
goog.exportSymbol('pulumirpc.RemediateResponse', null, proto);
goog.exportSymbol('pulumirpc.Remediation', null, proto);
/**
