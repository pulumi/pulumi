...
goog.exportSymbol('proto.pulumirpc.TransformResult', null, global);
/**
 ...
 * @constructor
 */
proto.pulumirpc.TransformResult = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pulumirpc.TransformResult, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.TransformResult.displayName = 'proto.pulumirpc.TransformResult';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.pulumirpc.TransformResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.pulumirpc.TransformResponse.repeatedFields_, null);
};
 ...
 * @return {!Object}
 */
proto.pulumirpc.TransformResult.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.TransformResult.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.TransformResult} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.TransformResult.toObject = function(includeInstance, msg) {
  var f, obj = {
    transformname: jspb.Message.getFieldWithDefault(msg, 1, ""),
    policypackname: jspb.Message.getFieldWithDefault(msg, 2, ""),
    policypackversion: jspb.Message.getFieldWithDefault(msg, 3, ""),
    description: jspb.Message.getFieldWithDefault(msg, 4, ""),
    properties: (f = msg.getProperties()) && google_protobuf_struct_pb.Struct.toObject(includeInstance, f)
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.TransformResult}
 */
proto.pulumirpc.TransformResult.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.TransformResult;
  return proto.pulumirpc.TransformResult.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.TransformResult} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.TransformResult}
 */
proto.pulumirpc.TransformResult.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.TransformResult.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.TransformResult.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.TransformResult} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.TransformResult.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTransformname();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string transformName = 1;
 * @return {string}
 */
proto.pulumirpc.TransformResult.prototype.getTransformname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.pulumirpc.TransformResult.prototype.setTransformname = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.TransformResult.prototype.getPolicypackname = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pulumirpc.TransformResult} returns this
 */
proto.pulumirpc.TransformResult.prototype.setPolicypackname = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.TransformResult.prototype.getPolicypackversion = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.pulumirpc.TransformResult} returns this
 */
proto.pulumirpc.TransformResult.prototype.setPolicypackversion = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.TransformResult.prototype.getDescription = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.pulumirpc.TransformResult} returns this
 */
proto.pulumirpc.TransformResult.prototype.setDescription = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {!proto.pulumirpc.TransformResult} returns this
 */
proto.pulumirpc.TransformResult.prototype.clearProperties = function() {
  return this.setProperties(undefined);
};
 ...
 * @const
 */
proto.pulumirpc.TransformResponse.repeatedFields_ = [1];
...
proto.pulumirpc.TransformResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.pulumirpc.TransformResult.toObject, includeInstance)
  };
...
proto.pulumirpc.TransformResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.pulumirpc.TransformResult;
      reader.readMessage(value,proto.pulumirpc.TransformResult.deserializeBinaryFromReader);
...
proto.pulumirpc.TransformResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.pulumirpc.TransformResult.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated TransformResult transforms = 1;
 * @return {!Array<!proto.pulumirpc.TransformResult>}
 */
proto.pulumirpc.TransformResponse.prototype.getTransformsList = function() {
  return /** @type{!Array<!proto.pulumirpc.TransformResult>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pulumirpc.TransformResult, 1));
};


/**
 * @param {!Array<!proto.pulumirpc.TransformResult>} value
 * @return {!proto.pulumirpc.TransformResponse} returns this
*/
proto.pulumirpc.TransformResponse.prototype.setTransformsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.pulumirpc.TransformResult=} opt_value
 * @param {number=} opt_index
 * @return {!proto.pulumirpc.TransformResult}
 */
proto.pulumirpc.TransformResponse.prototype.addTransforms = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.pulumirpc.TransformResult, opt_index);
};
 ...
 * @return {!proto.pulumirpc.TransformResponse} returns this
 */
proto.pulumirpc.TransformResponse.prototype.clearTransformsList = function() {
