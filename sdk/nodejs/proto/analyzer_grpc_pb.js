...
function serialize_pulumirpc_TransformResponse(arg) {
  if (!(arg instanceof pulumi_analyzer_pb.TransformResponse)) {
    throw new Error('Expected argument of type pulumirpc.TransformResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_pulumirpc_TransformResponse(buffer_arg) {
...
analyzeStack: {
  ...
  // Transform optionally transforms a single resource object. This effectively rewrites
// a single resource object's properties instead of using what was generated by the program.
transform: {
    path: '/pulumirpc.Analyzer/Transform',
    requestStream: false,
    responseStream: false,
    requestType: pulumi_analyzer_pb.AnalyzeRequest,
  ...
  // TransformStack optionally transforms an entire stack's worth of resources. This effectively
// rewrites all resource properties instead of using what was generated by the program.
transformStack: {
    path: '/pulumirpc.Analyzer/TransformStack',
    requestStream: false,
    responseStream: false,
    requestType: pulumi_analyzer_pb.AnalyzeStackRequest,
    responseType: pulumi_analyzer_pb.TransformResponse,
