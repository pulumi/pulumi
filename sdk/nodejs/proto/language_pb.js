...
goog.object.extend(proto, pulumi_codegen_workflow_pb);
...
goog.exportSymbol('proto.pulumirpc.GenerateWorkflowPackageRequest', null, global);
goog.exportSymbol('proto.pulumirpc.GenerateWorkflowPackageResponse', null, global);
 ...
 * @constructor
 */
proto.pulumirpc.GenerateWorkflowPackageRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pulumirpc.GenerateWorkflowPackageRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.GenerateWorkflowPackageRequest.displayName = 'proto.pulumirpc.GenerateWorkflowPackageRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pulumirpc.GenerateWorkflowPackageResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.pulumirpc.GenerateWorkflowPackageResponse.repeatedFields_, null);
};
goog.inherits(proto.pulumirpc.GenerateWorkflowPackageResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.GenerateWorkflowPackageResponse.displayName = 'proto.pulumirpc.GenerateWorkflowPackageResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.GenerateWorkflowPackageRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.GenerateWorkflowPackageRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
pb_package: (f = msg.getPackage()) && pulumi_codegen_workflow_pb.WorkflowPackageDescriptor.toObject(includeInstance, f),
directory: jspb.Message.getFieldWithDefault(msg, 2, ""),
workflowLoaderTarget: jspb.Message.getFieldWithDefault(msg, 3, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.GenerateWorkflowPackageRequest}
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.GenerateWorkflowPackageRequest;
  return proto.pulumirpc.GenerateWorkflowPackageRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.GenerateWorkflowPackageRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.GenerateWorkflowPackageRequest}
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new pulumi_codegen_workflow_pb.WorkflowPackageDescriptor;
      reader.readMessage(value,pulumi_codegen_workflow_pb.WorkflowPackageDescriptor.deserializeBinaryFromReader);
    ...
    case 3:
      var value = /** @type {string} */ (reader.readString());
      msg.setWorkflowLoaderTarget(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.GenerateWorkflowPackageRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.GenerateWorkflowPackageRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      pulumi_codegen_workflow_pb.WorkflowPackageDescriptor.serializeBinaryToWriter
    );
  }
  f = message.getDirectory();
  if (f.length > 0) {
  ...
  f = message.getWorkflowLoaderTarget();
  if (f.length > 0) {
    writer.writeString(
      3,
      f
...
/**
 * optional codegen.WorkflowPackageDescriptor package = 1;
 * @return {?proto.codegen.WorkflowPackageDescriptor}
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.getPackage = function() {
  return /** @type{?proto.codegen.WorkflowPackageDescriptor} */ (
    jspb.Message.getWrapperField(this, pulumi_codegen_workflow_pb.WorkflowPackageDescriptor, 1));
};


/**
 * @param {?proto.codegen.WorkflowPackageDescriptor|undefined} value
 * @return {!proto.pulumirpc.GenerateWorkflowPackageRequest} returns this
*/
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.setPackage = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.pulumirpc.GenerateWorkflowPackageRequest} returns this
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.clearPackage = function() {
 ...
 * @return {boolean}
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.hasPackage = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.getDirectory = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pulumirpc.GenerateWorkflowPackageRequest} returns this
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.setDirectory = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional string workflow_loader_target = 3;
 * @return {string}
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.getWorkflowLoaderTarget = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.pulumirpc.GenerateWorkflowPackageRequest} returns this
 */
proto.pulumirpc.GenerateWorkflowPackageRequest.prototype.setWorkflowLoaderTarget = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @const
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.GenerateWorkflowPackageResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.GenerateWorkflowPackageResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
diagnosticsList: jspb.Message.toObjectList(msg.getDiagnosticsList(),
    pulumi_codegen_hcl_pb.Diagnostic.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.GenerateWorkflowPackageResponse}
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.GenerateWorkflowPackageResponse;
  return proto.pulumirpc.GenerateWorkflowPackageResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.GenerateWorkflowPackageResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.GenerateWorkflowPackageResponse}
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.GenerateWorkflowPackageResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.GenerateWorkflowPackageResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDiagnosticsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.pulumirpc.codegen.Diagnostic>}
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.prototype.getDiagnosticsList = function() {
  return /** @type{!Array<!proto.pulumirpc.codegen.Diagnostic>} */ (
    jspb.Message.getRepeatedWrapperField(this, pulumi_codegen_hcl_pb.Diagnostic, 1));
};
...
/**
 * @param {!Array<!proto.pulumirpc.codegen.Diagnostic>} value
 * @return {!proto.pulumirpc.GenerateWorkflowPackageResponse} returns this
*/
proto.pulumirpc.GenerateWorkflowPackageResponse.prototype.setDiagnosticsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.pulumirpc.codegen.Diagnostic}
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.prototype.addDiagnostics = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.pulumirpc.codegen.Diagnostic, opt_index);
};
 ...
 * @return {!proto.pulumirpc.GenerateWorkflowPackageResponse} returns this
 */
proto.pulumirpc.GenerateWorkflowPackageResponse.prototype.clearDiagnosticsList = function() {
  return this.setDiagnosticsList([]);
};
