...
goog.exportSymbol('proto.pulumirpc.RunPlugin2Request', null, global);
goog.exportSymbol('proto.pulumirpc.RunPlugin2Request.RequestCase', null, global);
goog.exportSymbol('proto.pulumirpc.RunPluginCancelRequest', null, global);
 ...
 * @constructor
 */
proto.pulumirpc.RunPlugin2Request = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.pulumirpc.RunPlugin2Request.oneofGroups_);
};
goog.inherits(proto.pulumirpc.RunPlugin2Request, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.RunPlugin2Request.displayName = 'proto.pulumirpc.RunPlugin2Request';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.pulumirpc.RunPluginCancelRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pulumirpc.RunPluginCancelRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.RunPluginCancelRequest.displayName = 'proto.pulumirpc.RunPluginCancelRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.pulumirpc.RunPlugin2Request.oneofGroups_ = [[1,2]];

/**
 * @enum {number}
 */
proto.pulumirpc.RunPlugin2Request.RequestCase = {
  REQUEST_NOT_SET: 0,
  START: 1,
  CANCEL: 2
};
...
/**
 * @return {proto.pulumirpc.RunPlugin2Request.RequestCase}
 */
proto.pulumirpc.RunPlugin2Request.prototype.getRequestCase = function() {
  return /** @type {proto.pulumirpc.RunPlugin2Request.RequestCase} */(jspb.Message.computeOneofCase(this, proto.pulumirpc.RunPlugin2Request.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.pulumirpc.RunPlugin2Request.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.RunPlugin2Request.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.RunPlugin2Request} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.RunPlugin2Request.toObject = function(includeInstance, msg) {
  var f, obj = {
start: (f = msg.getStart()) && proto.pulumirpc.RunPluginRequest.toObject(includeInstance, f),
cancel: (f = msg.getCancel()) && proto.pulumirpc.RunPluginCancelRequest.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.RunPlugin2Request}
 */
proto.pulumirpc.RunPlugin2Request.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.RunPlugin2Request;
  return proto.pulumirpc.RunPlugin2Request.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.RunPlugin2Request} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.RunPlugin2Request}
 */
proto.pulumirpc.RunPlugin2Request.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.pulumirpc.RunPluginRequest;
      reader.readMessage(value,proto.pulumirpc.RunPluginRequest.deserializeBinaryFromReader);
      msg.setStart(value);
      break;
    case 2:
      var value = new proto.pulumirpc.RunPluginCancelRequest;
      reader.readMessage(value,proto.pulumirpc.RunPluginCancelRequest.deserializeBinaryFromReader);
      msg.setCancel(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.RunPlugin2Request.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.RunPlugin2Request.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.RunPlugin2Request} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.RunPlugin2Request.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStart();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.pulumirpc.RunPluginRequest.serializeBinaryToWriter
    );
  }
  f = message.getCancel();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.pulumirpc.RunPluginCancelRequest.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional RunPluginRequest start = 1;
 * @return {?proto.pulumirpc.RunPluginRequest}
 */
proto.pulumirpc.RunPlugin2Request.prototype.getStart = function() {
  return /** @type{?proto.pulumirpc.RunPluginRequest} */ (
    jspb.Message.getWrapperField(this, proto.pulumirpc.RunPluginRequest, 1));
};


/**
 * @param {?proto.pulumirpc.RunPluginRequest|undefined} value
 * @return {!proto.pulumirpc.RunPlugin2Request} returns this
*/
proto.pulumirpc.RunPlugin2Request.prototype.setStart = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.pulumirpc.RunPlugin2Request.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pulumirpc.RunPlugin2Request} returns this
 */
proto.pulumirpc.RunPlugin2Request.prototype.clearStart = function() {
 ...
 * @return {boolean}
 */
proto.pulumirpc.RunPlugin2Request.prototype.hasStart = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional RunPluginCancelRequest cancel = 2;
 * @return {?proto.pulumirpc.RunPluginCancelRequest}
 */
proto.pulumirpc.RunPlugin2Request.prototype.getCancel = function() {
  return /** @type{?proto.pulumirpc.RunPluginCancelRequest} */ (
    jspb.Message.getWrapperField(this, proto.pulumirpc.RunPluginCancelRequest, 2));
};


/**
 * @param {?proto.pulumirpc.RunPluginCancelRequest|undefined} value
 * @return {!proto.pulumirpc.RunPlugin2Request} returns this
*/
proto.pulumirpc.RunPlugin2Request.prototype.setCancel = function(value) {
  return jspb.Message.setOneofWrapperField(this, 2, proto.pulumirpc.RunPlugin2Request.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pulumirpc.RunPlugin2Request} returns this
 */
proto.pulumirpc.RunPlugin2Request.prototype.clearCancel = function() {
 ...
 * @return {boolean}
 */
proto.pulumirpc.RunPlugin2Request.prototype.hasCancel = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {!Object}
 */
proto.pulumirpc.RunPluginCancelRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.RunPluginCancelRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.RunPluginCancelRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.RunPluginCancelRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.pulumirpc.RunPluginCancelRequest}
 */
proto.pulumirpc.RunPluginCancelRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.RunPluginCancelRequest;
  return proto.pulumirpc.RunPluginCancelRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.RunPluginCancelRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.RunPluginCancelRequest}
 */
proto.pulumirpc.RunPluginCancelRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.RunPluginCancelRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.RunPluginCancelRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.RunPluginCancelRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.RunPluginCancelRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getForce();
  if (f) {
    writer.writeBool(
 ...
 * @return {boolean}
 */
proto.pulumirpc.RunPluginCancelRequest.prototype.getForce = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.pulumirpc.RunPluginCancelRequest} returns this
 */
proto.pulumirpc.RunPluginCancelRequest.prototype.setForce = function(value) {
