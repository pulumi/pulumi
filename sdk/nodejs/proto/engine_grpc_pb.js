...
function serialize_pulumirpc_StartDebuggerResponse(arg) {
  if (!(arg instanceof pulumi_engine_pb.StartDebuggerResponse)) {
    throw new Error('Expected argument of type pulumirpc.StartDebuggerResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_pulumirpc_StartDebuggerResponse(buffer_arg) {
  return pulumi_engine_pb.StartDebuggerResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
setRootResource: {
  ...
  startDebugger: {
    ...
    responseType: pulumi_engine_pb.StartDebuggerResponse,
    requestSerialize: serialize_pulumirpc_StartDebuggerRequest,
    requestDeserialize: deserialize_pulumirpc_StartDebuggerRequest,
    responseSerialize: serialize_pulumirpc_StartDebuggerResponse,
    responseDeserialize: deserialize_pulumirpc_StartDebuggerResponse,
  },
};
