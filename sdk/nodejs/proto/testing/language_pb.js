...
goog.exportSymbol('proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride', null, global);
 ...
 * @constructor
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.displayName = 'proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.pulumirpc.testing.PrepareLanguageTestsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    providerOverridesMap: (f = msg.getProviderOverridesMap()) ? f.toObject(includeInstance, proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.toObject) : []
  };
...
proto.pulumirpc.testing.PrepareLanguageTestsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 10:
      var value = msg.getProviderOverridesMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.deserializeBinaryFromReader, "", new proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride());
         });
      break;
    default:
      reader.skipField();
...
proto.pulumirpc.testing.PrepareLanguageTestsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getProviderOverridesMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(10, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.serializeBinaryToWriter);
  }
};
 ...
 * @return {!Object}
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride}
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride;
  return proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride}
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.prototype.getRootDirectory = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride} returns this
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.prototype.setRootDirectory = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.prototype.getProgramDirectory = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride} returns this
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.prototype.setProgramDirectory = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.prototype.getEntryPoint = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride} returns this
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride.prototype.setEntryPoint = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
...
/**
 * map<string, ProviderOverride> provider_overrides = 10;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride>}
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.prototype.getProviderOverridesMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride>} */ (
      jspb.Message.getMapField(this, 10, opt_noLazyCreate,
      proto.pulumirpc.testing.PrepareLanguageTestsRequest.ProviderOverride));
};
 ...
 * @return {!proto.pulumirpc.testing.PrepareLanguageTestsRequest} returns this
 */
proto.pulumirpc.testing.PrepareLanguageTestsRequest.prototype.clearProviderOverridesMap = function() {
  this.getProviderOverridesMap().clear();
  return this;};
