...
proto.pulumirpc.ConfigureRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    acceptresources: jspb.Message.getFieldWithDefault(msg, 4, false)
  };
...
proto.pulumirpc.ConfigureResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    supportspreview: jspb.Message.getFieldWithDefault(msg, 2, false),
    acceptresources: jspb.Message.getFieldWithDefault(msg, 3, false),
    acceptoutputs: jspb.Message.getFieldWithDefault(msg, 4, false)
  };
...
proto.pulumirpc.CallRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    configsecretkeysList: jspb.Message.getRepeatedField(msg, 9),
    dryrun: jspb.Message.getFieldWithDefault(msg, 10, false),
...
proto.pulumirpc.CallRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pulumirpc.CallRequest.ArgumentDependencies.deserializeBinaryFromReader, "");
         });
      break;
    case 4:
      var value = /** @type {string} */ (reader.readString());
...
proto.pulumirpc.CallResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pulumirpc.CallResponse.ReturnDependencies.deserializeBinaryFromReader, "");
         });
      break;
    case 3:
      var value = new proto.pulumirpc.CheckFailure;
...
proto.pulumirpc.CreateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    preview: jspb.Message.getFieldWithDefault(msg, 4, false)
  };
...
proto.pulumirpc.UpdateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    preview: jspb.Message.getFieldWithDefault(msg, 7, false)
  };
...
proto.pulumirpc.ConstructRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    protect: jspb.Message.getFieldWithDefault(msg, 12, false),
    providersMap: (f = msg.getProvidersMap()) ? f.toObject(includeInstance, undefined) : [],
    aliasesList: jspb.Message.getRepeatedField(msg, 14),
    dependenciesList: jspb.Message.getRepeatedField(msg, 15),
    configsecretkeysList: jspb.Message.getRepeatedField(msg, 16)
  };
...
proto.pulumirpc.ConstructRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 11:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pulumirpc.ConstructRequest.PropertyDependencies.deserializeBinaryFromReader, "");
         });
      break;
    case 12:
      var value = /** @type {boolean} */ (reader.readBool());
...
proto.pulumirpc.ConstructResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pulumirpc.ConstructResponse.PropertyDependencies.deserializeBinaryFromReader, "");
         });
      break;
    default:
      reader.skipField();
