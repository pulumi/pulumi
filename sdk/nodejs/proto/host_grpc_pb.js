...
var pulumi_host_pb = require('./host_pb.js');
...
function serialize_pulumirpc_GetRootResourceRequest(arg) {
  if (!(arg instanceof pulumi_host_pb.GetRootResourceRequest)) {
...
function deserialize_pulumirpc_GetRootResourceRequest(buffer_arg) {
  return pulumi_host_pb.GetRootResourceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pulumirpc_GetRootResourceResponse(arg) {
  if (!(arg instanceof pulumi_host_pb.GetRootResourceResponse)) {
...
function deserialize_pulumirpc_GetRootResourceResponse(buffer_arg) {
  return pulumi_host_pb.GetRootResourceResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pulumirpc_LogRequest(arg) {
  if (!(arg instanceof pulumi_host_pb.LogRequest)) {
...
function deserialize_pulumirpc_LogRequest(buffer_arg) {
  return pulumi_host_pb.LogRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pulumirpc_SetRootResourceRequest(arg) {
  if (!(arg instanceof pulumi_host_pb.SetRootResourceRequest)) {
...
function deserialize_pulumirpc_SetRootResourceRequest(buffer_arg) {
  return pulumi_host_pb.SetRootResourceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pulumirpc_SetRootResourceResponse(arg) {
  if (!(arg instanceof pulumi_host_pb.SetRootResourceResponse)) {
...
function deserialize_pulumirpc_SetRootResourceResponse(buffer_arg) {
  return pulumi_host_pb.SetRootResourceResponse.deserializeBinary(new Uint8Array(buffer_arg));
}


// Host is an auxiliary service offered to language and resource provider plugins. Its main purpose today is
...
var HostService = exports.HostService = {
  // Log logs a global message in the engine, including errors and warnings.
log: {
    path: '/pulumirpc.Host/Log',
    requestStream: false,
    responseStream: false,
    requestType: pulumi_host_pb.LogRequest,
...
getRootResource: {
    path: '/pulumirpc.Host/GetRootResource',
    requestStream: false,
    responseStream: false,
    requestType: pulumi_host_pb.GetRootResourceRequest,
    responseType: pulumi_host_pb.GetRootResourceResponse,
...
setRootResource: {
    path: '/pulumirpc.Host/SetRootResource',
    requestStream: false,
    responseStream: false,
    requestType: pulumi_host_pb.SetRootResourceRequest,
    responseType: pulumi_host_pb.SetRootResourceResponse,
...
exports.HostClient = grpc.makeGenericClientConstructor(HostService);
