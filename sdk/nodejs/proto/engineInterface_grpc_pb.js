...
var pulumi_engineInterface_pb = require('./engineInterface_pb.js');
var google_protobuf_empty_pb = require('google-protobuf/google/protobuf/empty_pb.js');

function serialize_pulumirpc_engine_AboutRequest(arg) {
  if (!(arg instanceof pulumi_engineInterface_pb.AboutRequest)) {
...
function deserialize_pulumirpc_engine_AboutRequest(buffer_arg) {
  return pulumi_engineInterface_pb.AboutRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_pulumirpc_engine_AboutResponse(arg) {
  if (!(arg instanceof pulumi_engineInterface_pb.AboutResponse)) {
...
function deserialize_pulumirpc_engine_AboutResponse(buffer_arg) {
  return pulumi_engineInterface_pb.AboutResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
about: {
    ...
    requestType: pulumi_engineInterface_pb.AboutRequest,
    responseType: pulumi_engineInterface_pb.AboutResponse,
