...
goog.exportSymbol('proto.pulumirpc.Parameter', null, global);
 ...
 * @constructor
 */
proto.pulumirpc.Parameter = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pulumirpc.Parameter, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.Parameter.displayName = 'proto.pulumirpc.Parameter';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.pulumirpc.Parameter.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.Parameter.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.Parameter} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.Parameter.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.Parameter}
 */
proto.pulumirpc.Parameter.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.Parameter;
  return proto.pulumirpc.Parameter.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.Parameter} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.Parameter}
 */
proto.pulumirpc.Parameter.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.Parameter.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.Parameter.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.Parameter} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.Parameter.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKey();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.pulumirpc.Parameter.prototype.getKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pulumirpc.Parameter} returns this
 */
proto.pulumirpc.Parameter.prototype.setKey = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 */
proto.pulumirpc.Parameter.prototype.getValue = function() {
 ...
 * @return {!proto.pulumirpc.Parameter} returns this
*/
proto.pulumirpc.Parameter.prototype.setValue = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.pulumirpc.Parameter} returns this
 */
proto.pulumirpc.Parameter.prototype.clearValue = function() {
 ...
 * @return {boolean}
 */
proto.pulumirpc.Parameter.prototype.hasValue = function() {
  return jspb.Message.getField(this, 2) != null;
};
 ...
 * @return {boolean}
 */
proto.pulumirpc.Parameter.prototype.getExtension$ = function() {
 ...
 * @return {!proto.pulumirpc.Parameter} returns this
 */
proto.pulumirpc.Parameter.prototype.setExtension$ = function(value) {
...
proto.pulumirpc.RegisterResourceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    sourceposition: (f = msg.getSourceposition()) && pulumi_source_pb.SourcePosition.toObject(includeInstance, f),
    parameter: (f = msg.getParameter()) && proto.pulumirpc.Parameter.toObject(includeInstance, f)
  };
...
proto.pulumirpc.RegisterResourceRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 29:
      ...
      break;
    case 31:
      var value = new proto.pulumirpc.Parameter;
      reader.readMessage(value,proto.pulumirpc.Parameter.deserializeBinaryFromReader);
...
proto.pulumirpc.RegisterResourceRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      31,
      f,
      proto.pulumirpc.Parameter.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional Parameter parameter = 31;
 * @return {?proto.pulumirpc.Parameter}
 */
proto.pulumirpc.RegisterResourceRequest.prototype.getParameter = function() {
  return /** @type{?proto.pulumirpc.Parameter} */ (
    jspb.Message.getWrapperField(this, proto.pulumirpc.Parameter, 31));
};


/**
 * @param {?proto.pulumirpc.Parameter|undefined} value
 * @return {!proto.pulumirpc.RegisterResourceRequest} returns this
*/
