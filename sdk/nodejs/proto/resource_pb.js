...
proto.pulumirpc.RegisterPackageRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    parameterization: (f = msg.getParameterization()) && pulumi_plugin_pb.Parameterization.toObject(includeInstance, f)
  };
...
proto.pulumirpc.RegisterPackageRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 5:
      var value = new pulumi_plugin_pb.Parameterization;
      reader.readMessage(value,pulumi_plugin_pb.Parameterization.deserializeBinaryFromReader);
...
proto.pulumirpc.RegisterPackageRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      pulumi_plugin_pb.Parameterization.serializeBinaryToWriter
    );
  }
};
...
proto.pulumirpc.RegisterPackageRequest.prototype.getParameterization = function() {
  return /** @type{?proto.pulumirpc.Parameterization} */ (
    jspb.Message.getWrapperField(this, pulumi_plugin_pb.Parameterization, 5));
};
