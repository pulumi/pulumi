...
goog.exportSymbol('proto.pulumirpc.Alias.SmartAlias', null, global);
goog.exportSymbol('proto.pulumirpc.Alias.SmartAlias.ParentCase', null, global);
 ...
 * @constructor
 */
proto.pulumirpc.Alias.SmartAlias = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.pulumirpc.Alias.SmartAlias.oneofGroups_);
};
goog.inherits(proto.pulumirpc.Alias.SmartAlias, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.Alias.SmartAlias.displayName = 'proto.pulumirpc.Alias.SmartAlias';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.pulumirpc.Alias.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    smartalias: (f = msg.getSmartalias()) && proto.pulumirpc.Alias.SmartAlias.toObject(includeInstance, f)
  };
...
proto.pulumirpc.Alias.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.pulumirpc.Alias.SmartAlias;
      reader.readMessage(value,proto.pulumirpc.Alias.SmartAlias.deserializeBinaryFromReader);
      msg.setSmartalias(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.pulumirpc.Alias.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getSmartalias();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.pulumirpc.Alias.SmartAlias.serializeBinaryToWriter
    );
  }
};
 ...
 * @const
 */
proto.pulumirpc.Alias.SmartAlias.oneofGroups_ = [[5,6]];

/**
 * @enum {number}
 */
proto.pulumirpc.Alias.SmartAlias.ParentCase = {
  PARENT_NOT_SET: 0,
  PARENTURN: 5,
  NOPARENT: 6
};
...
/**
 * @return {proto.pulumirpc.Alias.SmartAlias.ParentCase}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.getParentCase = function() {
  return /** @type {proto.pulumirpc.Alias.SmartAlias.ParentCase} */(jspb.Message.computeOneofCase(this, proto.pulumirpc.Alias.SmartAlias.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.Alias.SmartAlias.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.Alias.SmartAlias} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.Alias.SmartAlias.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.Alias.SmartAlias}
 */
proto.pulumirpc.Alias.SmartAlias.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.Alias.SmartAlias;
  return proto.pulumirpc.Alias.SmartAlias.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.Alias.SmartAlias} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.Alias.SmartAlias}
 */
proto.pulumirpc.Alias.SmartAlias.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.Alias.SmartAlias.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.Alias.SmartAlias} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.Alias.SmartAlias.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pulumirpc.Alias.SmartAlias} returns this
 */
proto.pulumirpc.Alias.SmartAlias.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.getType = function() {
 ...
 * @return {!proto.pulumirpc.Alias.SmartAlias} returns this
 */
proto.pulumirpc.Alias.SmartAlias.prototype.setType = function(value) {
 ...
 * @return {string}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.getStack = function() {
 ...
 * @return {!proto.pulumirpc.Alias.SmartAlias} returns this
 */
proto.pulumirpc.Alias.SmartAlias.prototype.setStack = function(value) {
 ...
 * @return {string}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.getProject = function() {
 ...
 * @return {!proto.pulumirpc.Alias.SmartAlias} returns this
 */
proto.pulumirpc.Alias.SmartAlias.prototype.setProject = function(value) {
 ...
 * @return {string}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.getParenturn = function() {
 ...
 * @return {!proto.pulumirpc.Alias.SmartAlias} returns this
 */
proto.pulumirpc.Alias.SmartAlias.prototype.setParenturn = function(value) {
  return jspb.Message.setOneofField(this, 5, proto.pulumirpc.Alias.SmartAlias.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pulumirpc.Alias.SmartAlias} returns this
 */
proto.pulumirpc.Alias.SmartAlias.prototype.clearParenturn = function() {
  return jspb.Message.setOneofField(this, 5, proto.pulumirpc.Alias.SmartAlias.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.hasParenturn = function() {
 ...
 * @return {boolean}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.getNoparent = function() {
 ...
 * @return {!proto.pulumirpc.Alias.SmartAlias} returns this
 */
proto.pulumirpc.Alias.SmartAlias.prototype.setNoparent = function(value) {
  return jspb.Message.setOneofField(this, 6, proto.pulumirpc.Alias.SmartAlias.oneofGroups_[0], value);
};
 ...
 * @return {!proto.pulumirpc.Alias.SmartAlias} returns this
 */
proto.pulumirpc.Alias.SmartAlias.prototype.clearNoparent = function() {
  return jspb.Message.setOneofField(this, 6, proto.pulumirpc.Alias.SmartAlias.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.pulumirpc.Alias.SmartAlias.prototype.hasNoparent = function() {
...
/**
 * optional SmartAlias smartAlias = 2;
 * @return {?proto.pulumirpc.Alias.SmartAlias}
 */
proto.pulumirpc.Alias.prototype.getSmartalias = function() {
  return /** @type{?proto.pulumirpc.Alias.SmartAlias} */ (
    jspb.Message.getWrapperField(this, proto.pulumirpc.Alias.SmartAlias, 2));
};


/**
 * @param {?proto.pulumirpc.Alias.SmartAlias|undefined} value
 * @return {!proto.pulumirpc.Alias} returns this
*/
proto.pulumirpc.Alias.prototype.setSmartalias = function(value) {
 ...
 * @return {!proto.pulumirpc.Alias} returns this
 */
proto.pulumirpc.Alias.prototype.clearSmartalias = function() {
  return this.setSmartalias(undefined);
};
 ...
 * @return {boolean}
 */
proto.pulumirpc.Alias.prototype.hasSmartalias = function() {
 ...
 * @const
 */
proto.pulumirpc.ReadResourceRequest.repeatedFields_ = [6,10,11,14];
...
proto.pulumirpc.ReadResourceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    smartaliasesList: jspb.Message.toObjectList(msg.getSmartaliasesList(),
...
/**
 * repeated Alias smartAliases = 14;
 * @return {!Array<!proto.pulumirpc.Alias>}
 */
proto.pulumirpc.ReadResourceRequest.prototype.getSmartaliasesList = function() {
  return /** @type{!Array<!proto.pulumirpc.Alias>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pulumirpc.Alias, 14));
};
 ...
 * @return {!proto.pulumirpc.ReadResourceRequest} returns this
*/
proto.pulumirpc.ReadResourceRequest.prototype.setSmartaliasesList = function(value) {
 ...
 * @return {!proto.pulumirpc.Alias}
 */
proto.pulumirpc.ReadResourceRequest.prototype.addSmartaliases = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 14, opt_value, proto.pulumirpc.Alias, opt_index);
};
 ...
 * @return {!proto.pulumirpc.ReadResourceRequest} returns this
 */
proto.pulumirpc.ReadResourceRequest.prototype.clearSmartaliasesList = function() {
  return this.setSmartaliasesList([]);
};
...
/**
 * repeated Alias smartAliases = 26;
 * @return {!Array<!proto.pulumirpc.Alias>}
 */
proto.pulumirpc.RegisterResourceRequest.prototype.getSmartaliasesList = function() {
  return /** @type{!Array<!proto.pulumirpc.Alias>} */ (
 ...
 * @return {!proto.pulumirpc.RegisterResourceRequest} returns this
*/
proto.pulumirpc.RegisterResourceRequest.prototype.setSmartaliasesList = function(value) {
 ...
 * @return {!proto.pulumirpc.Alias}
 */
proto.pulumirpc.RegisterResourceRequest.prototype.addSmartaliases = function(opt_value, opt_index) {
 ...
 * @return {!proto.pulumirpc.RegisterResourceRequest} returns this
 */
proto.pulumirpc.RegisterResourceRequest.prototype.clearSmartaliasesList = function() {
  return this.setSmartaliasesList([]);
};
