...
proto.pulumirpc.ReadResourceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    acceptresources: jspb.Message.getFieldWithDefault(msg, 12, false),
...
proto.pulumirpc.RegisterResourceRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    remote: jspb.Message.getFieldWithDefault(msg, 20, false),
    acceptresources: jspb.Message.getFieldWithDefault(msg, 21, false),
    providersMap: (f = msg.getProvidersMap()) ? f.toObject(includeInstance, undefined) : [],
    replaceonchangesList: jspb.Message.getRepeatedField(msg, 23),
    plugindownloadurl: jspb.Message.getFieldWithDefault(msg, 24, ""),
    retainondelete: jspb.Message.getFieldWithDefault(msg, 25, false)
  };
...
proto.pulumirpc.RegisterResourceResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      var value = msg.getPropertydependenciesMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.pulumirpc.RegisterResourceResponse.PropertyDependencies.deserializeBinaryFromReader, "");
         });
      break;
    default:
      reader.skipField();
...
proto.pulumirpc.ResourceInvokeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    acceptresources: jspb.Message.getFieldWithDefault(msg, 5, false),
