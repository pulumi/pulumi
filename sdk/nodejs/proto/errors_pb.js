...
goog.exportSymbol('proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError', null, global);
/**
 ...
 * @constructor
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.displayName = 'proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError';
}
...
proto.pulumirpc.InvalidInputPropertiesError.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.toObject, includeInstance)
  };
...
proto.pulumirpc.InvalidInputPropertiesError.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError;
      reader.readMessage(value,proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.deserializeBinaryFromReader);
      msg.addErrors(value);
      break;
    default:
      reader.skipField();
...
proto.pulumirpc.InvalidInputPropertiesError.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.prototype.toObject = function(opt_includeInstance) {
  return proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError}
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError;
  return proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError}
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {string}
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.prototype.getPropertyKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError} returns this
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.prototype.setPropertyKey = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.prototype.getPropertyPath = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError} returns this
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.prototype.setPropertyPath = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.prototype.getReason = function() {
 ...
 * @return {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError} returns this
 */
proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError.prototype.setReason = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};


/**
 * repeated InvalidInputPropertyError errors = 1;
 * @return {!Array<!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError>}
 */
proto.pulumirpc.InvalidInputPropertiesError.prototype.getErrorsList = function() {
  return /** @type{!Array<!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError, 1));
};


/**
 * @param {!Array<!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError>} value
...
/**
 * @param {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError=} opt_value
 * @param {number=} opt_index
 * @return {!proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError}
 */
proto.pulumirpc.InvalidInputPropertiesError.prototype.addErrors = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.pulumirpc.InvalidInputPropertiesError.InvalidInputPropertyError, opt_index);
};
