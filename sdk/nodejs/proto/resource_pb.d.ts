...
export class ResourceExtension extends jspb.Message { 
    getPackage(): string;
    setPackage(value: string): ResourceExtension;
    getVersion(): string;
    setVersion(value: string): ResourceExtension;

    hasParameter(): boolean;
    clearParameter(): void;
    getParameter(): ResourceParameter | undefined;
    setParameter(value?: ResourceParameter): ResourceExtension;
...
export namespace ResourceExtension {
    export type AsObject = {
        pb_package: string,
        version: string,
        parameter?: ResourceParameter.AsObject,
    }
}

export class ResourceParameter extends jspb.Message { 

    hasValue(): boolean;
    clearValue(): void;
    getValue(): google_protobuf_struct_pb.Value | undefined;
    setValue(value?: google_protobuf_struct_pb.Value): ResourceParameter;
    getAdditive(): boolean;
    setAdditive(value: boolean): ResourceParameter;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): ResourceParameter.AsObject;
    static toObject(includeInstance: boolean, msg: ResourceParameter): ResourceParameter.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: ResourceParameter, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): ResourceParameter;
    static deserializeBinaryFromReader(message: ResourceParameter, reader: jspb.BinaryReader): ResourceParameter;
}

export namespace ResourceParameter {
    export type AsObject = {
...
export class RegisterResourceRequest extends jspb.Message { 
    ...
    setExtension$(value?: ResourceExtension): RegisterResourceRequest;
