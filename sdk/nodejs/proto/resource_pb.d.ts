...
export class StateMigrationResponse extends jspb.Message { 
    ...
    clearForgottenList(): void;
    getForgottenList(): Array<string>;
    setForgottenList(value: Array<string>): StateMigrationResponse;
    addForgotten(value: string, index?: number): string;
