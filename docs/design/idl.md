...
This note describes an approach to using IDL for defining resource packages that addresses these short-comings.
...
A type is a resource if it embeds one of the standard Coconut IDL resource types: either `pkg/cocoidl/Resource` or
