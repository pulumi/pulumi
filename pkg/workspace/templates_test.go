...
func TestTemplates(t *testing.T) {
	...
	t.Run("TestGetValidDefaultProjectName", func(t *testing.T) {
	...
	t.Run("TestValidateStackName", func(t *testing.T) {
		t.Parallel()
	...
	t.Run("TestRetrieveHttpsTemplate", func(t *testing.T) {
	...
	t.Run("TestRetrieveHttpsTemplateOffline", func(t *testing.T) {
		templateURL := "https://github.com/pulumi/pulumi-aws/tree/master/examples/minimal"
		_, err := RetrieveTemplates(templateURL, true)
		assert.NotNil(t, err)
	})

	t.Run("TestRetrieveFileTemplate", func(t *testing.T) {
