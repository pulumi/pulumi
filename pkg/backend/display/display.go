...
// isRootStack returns true if the step pertains to the rootmost stack component. Stack-typed resources
// with a parent are not the root: workflow node deployments contribute parented pulumi:pulumi:Stack
