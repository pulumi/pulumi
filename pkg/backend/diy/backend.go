...
func (b *diyBackend) BeginApply(
	...
	u, err := b.newUpdate(ctx, op.SecretsProvider, diyStackRef, *op)
	if err != nil {
		return nil, nil, nil, err
	}
...
func (a *diyApplication) UpdateInfo() engine.UpdateInfo {
	return a.update
}
...
func (a *diyApplication) CreateParentSpanContext() (opentracing.SpanContext, error) {
	return nil, nil
}
