...
type MockBackend struct {
	...
	ListTemplatesF     func(_ context.Context, orgName string) (apitype.ListTemplatesResult, error)
...
func (be *MockBackend) ListTemplates(ctx context.Context, orgName string) (apitype.ListTemplatesResult, error) {
