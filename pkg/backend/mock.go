...
type MockStack struct {
	...
	SaveF             func(ctx context.Context, project *workspace.ProjectStack, fileNameOverride string) error
...
func (ms *MockStack) Save(ctx context.Context, project *workspace.ProjectStack, fileNameOverride string) error {
	if ms.SaveF != nil {
		return ms.SaveF(ctx, project, fileNameOverride)
	}
