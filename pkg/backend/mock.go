...
type MockBackend struct {
	...
	RemoveStackF func(context.Context, Stack, bool, bool) (RemoveStackResult, error)
...
func (be *MockBackend) RemoveStack(ctx context.Context, stack Stack, force, removeBackups bool) (RemoveStackResult, error) {
