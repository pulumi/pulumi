...
type MockStack struct {
	...
	ConfigSourceF func() StackConfigSource
...
func (ms *MockStack) ConfigSource() StackConfigSource {
	if ms.ConfigSourceF != nil {
		return ms.ConfigSourceF()
	}
	return StackConfigSourceFile
}
