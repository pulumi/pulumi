...
type MockBackend struct {
	...
	RenameStackF            func(context.Context, Stack, string) (StackReference, error)
...
func (be *MockBackend) RenameStack(ctx context.Context, stack Stack,
	newName string) (StackReference, error) {
...
type MockStack struct {
	...
	RenameF  func(ctx context.Context, newName string) (StackReference, error)
...
func (ms *MockStack) Rename(ctx context.Context, newName string) (StackReference, error) {
	if ms.RenameF != nil {
