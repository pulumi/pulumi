...
type Journal interface {
	...
	// Rebase updates the base snapshot for this journal. This is used e.g. when providers have
...
// Rebase sets the base snapshot for this SnapshotManager. This is used to rebase the journal
