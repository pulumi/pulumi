...
import (
	...
	"github.com/pulumi/pulumi/pkg/v3/plugins/gensdk"
...
func LinkInto(
	...
	return linkPackage(ctx, pluginOrProject, pluginOrProjectDir, sdkDir, pkg, sink, host)
}
...
func linkPackage(
	...
	defer contract.IgnoreClose(languagePlugin)
