...
type iamClient interface {
	...
	GetServiceAccount(ctx context.Context, saResource string) (*iam.ServiceAccount, error)
...
func (c *realIAMClient) GetServiceAccount(ctx context.Context, saResource string) (*iam.ServiceAccount, error) {
	return c.iam.Projects.ServiceAccounts.
		Get(saResource).
		Context(ctx).Do()
}
