...
type stepGenerator struct {
	...
	// stepExecLock gives state migrations exclusive access to deployment state while they run. It is set by the
	// deployment executor and may be nil in tests that drive the step generator directly.
...
// generateURN generates a resource's canonical URN after its parent has been normalized and confirms we haven't seen
// it before in this deployment.
