...
// ContinueResourceCheckEvent is an event that asks the engine to continue step generation for a
// resource whose provider Check call has completed.
type ContinueResourceCheckEvent interface {
	...
	// CheckResponse is the response from the provider Check call. Only valid when Provider is
	// non-nil and Error is nil.
...
var _ ContinueResourceCheckEvent = (*continueCheckResourceEvent)(nil)
...
func (e *continueCheckResourceEvent) CheckResponse() plugin.CheckResponse   { return e.resp }
