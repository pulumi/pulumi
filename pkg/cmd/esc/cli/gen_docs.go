...
func generateMetaDescription(title, commandName string) string {
	...
	descriptions := map[string]string{
		"esc":          "Pulumi ESC (Environments, Secrets, and Configuration) - manage environments, secrets, and configuration.", //nolint:lll
	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			for _, file := range files {
				...
				// #nosec G703 -- developer tool writing to user-supplied output dir
