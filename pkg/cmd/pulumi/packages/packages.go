...
func ProviderFromSource(
	...
	f, err := packageinstallation.InstallPlugin(pctx.Request(), packageSpec, nil, "", packageinstallation.Options{
		Options:     packageresolution.Options{},
		Concurrency: concurrency,
	}, reg, packageworkspace.New(pctx.Host, nil, nil, pctx.Diag, pctx.StatusDiag, nil, packageworkspace.Options{}))
	if err == nil {
	...
	_ = p
	panic("TODO: Change packageinstallation.InstallPlugin to return the workspace.PackageSpec that it resolved into")
}
