...
Examples:
  pulumi package new
  pulumi package new --type distributable
  pulumi package new --name my-component --dir ./my-component`,
		Args: cmdutil.NoArgs,
...
func runPackageNew(args *packageNewArgs) error {
	...
	// Prompt for component name (only in interactive mode, after type and language are known)
