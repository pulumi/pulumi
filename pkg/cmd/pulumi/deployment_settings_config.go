...
func configureGit(d *deploymentSettingsCommandDependencies, gitSSHPrivateKeyPath string,
	...
	repoDir, err := promptForValue(d.Yes, "repo directory", defaultRepoDir, false,
		ValidateRelativeDirectory(repoRoot), *d.DisplayOptions)
	if err != nil {
		return err
	}
	...
	if useGiHub {
		useGiHub = askForConfirmation("A GitHub repository was detected, do you want to use the Pulumi GitHub App?",
