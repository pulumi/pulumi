...
func TestPulumiNewWithOrgTemplates(t *testing.T) {
	...
	ctx := cmdBackend.InjectMockBackend(context.Background(), &backend.MockBackend{
		...
		ListTemplatesF: func(_ context.Context, orgName string) (apitype.ListTemplatesResult, error) {
			switch orgName {
			case "org1":
				return apitype.ListTemplatesResult{
						...
						"github.com/example/foo": {
							{
								SourceName: "Foo",
								Name:       "template-1",
								SourceURL:  "github.com/example/foo/template-1",
							...
							},
							{
								SourceName: "Foo",
								Name:       "template-2",
								SourceURL:  "github.com/example/foo/template-2",
								ProjectTemplate: apitype.ProjectTemplate{
			...
			case "personal":
				return apitype.ListTemplatesResult{OrgHasTemplates: false}, nil
			default:
				return apitype.ListTemplatesResult{}, fmt.Errorf("unknown org %q", orgName)
			}
		},
	})
						...
						"github.com/example/foo": {
							{
								SourceName: "Foo",
								Name:       "template-1",
								SourceURL:  "https://github.com/example/foo/template-1",
								ProjectTemplate: apitype.ProjectTemplate{
									DisplayName: "Display 1",
									Description: "Describe 1",
								},
