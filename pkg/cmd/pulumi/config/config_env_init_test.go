...
func TestConfigEnvInit_ServiceBacked_AllSecretsDecrypted(t *testing.T) {
	t.Parallel()
	...
	cmd := &configEnvInitCmd{parent: parent, serviceBacked: true, yes: true}
...
func TestConfigEnvInit_ServiceBacked_DecryptionFailure(t *testing.T) {
	t.Parallel()
...
func TestConfigEnvInit_ServiceBacked_IdempotentMerge(t *testing.T) {
	t.Parallel()
...
func TestConfigEnvInit_ServiceBacked_EmptyExistingEnvironmentUpdates(t *testing.T) {
	t.Parallel()
...
func TestConfigEnvInit_ServiceBacked_AlreadyServiceBacked(t *testing.T) {
	t.Parallel()
	...
	err := cmd.run(context.Background(), nil)
	require.Error(t, err)
	assert.Contains(t, err.Error(), "already uses service-backed configuration")
