...
func TestConfigEnvInit_Migrate_AllSecretsDecrypted(t *testing.T) {
	t.Parallel()
...
func TestConfigEnvInit_Migrate_DecryptionFailure(t *testing.T) {
	t.Parallel()
...
func TestConfigEnvInit_Migrate_IdempotentMerge(t *testing.T) {
	t.Parallel()
