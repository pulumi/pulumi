...
// newServiceBackedConfigEnvCmd creates a configEnvCmd backed by a mock
// service-backed stack. envYAML holds the current ESC environment definition;
// savedYAML captures what was written on save.
func newServiceBackedConfigEnvCmd(
	stdin io.Reader,
	stdout io.Writer,
	envYAML string,
	savedYAML *string,
