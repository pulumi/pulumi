...
type ResourceSpec struct {
	...
	// A set of tags associated with the resource. These are not propagated to actual resource state and have no bearing
	// on any tests but are included to aid in debugging and identifying the causes of snapshot integrity issues.
	Tags map[string]bool
}

// Adds the given tag to the given ResourceSpec.
...
// A default set of ResourceSpecOptions.
...
// Given a set of StackSpecOptions, returns a rapid.Generator that yields random provider resource specs with no
