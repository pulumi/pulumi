...
func TestSmartAliases(t *testing.T) {
	// This is pretty much a copy of TestAliases above but using the alias objects rather than URNs.
	t.Parallel()
	...
	snap = updateProgramWithResource(snap, []Resource{{
		t:            "pkgA:index:t1",
		name:         "n2",
		smartAliases: []resource.Alias{{Name: "n1"}},
	}}, []deploy.StepOp{deploy.OpSame}, false)
