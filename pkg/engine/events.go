...
func NewEvent1(typ EventType, payload interface{}) Event1 {
	ok := false
	switch typ {
	case CancelEvent:
		ok = payload == nil
...
func (e Event1) Payload() interface{} {
	return e.payload
}

func (e Event1) DeepCopy() Event1 {
	return Event1{e.Type, deepcopy.Copy(e.payload)}
}

func cancelEvent() Event1 {
	return Event1{Type: CancelEvent}
}
...
func makeEventEmitter(events chan<- Event1, update UpdateInfo) (eventEmitter, error) {
	...
	buffer, done := make(chan Event1), make(chan bool)
...
func makeQueryEventEmitter(events chan<- Event1) (eventEmitter, error) {
	buffer, done := make(chan Event1), make(chan bool)
...
func queueEvents(events chan<- Event1, buffer chan Event1, done chan bool) {
...
func (e *eventEmitter) resourceOperationFailedEvent(
	...
	e.ch1 <- NewEvent1(ResourceOperationFailed, ResourceOperationFailedPayload{
...
func (e *eventEmitter) resourceOutputsEvent(op display.StepOp, step deploy.Step, planning bool, debug bool) {
	...
	e.ch1 <- NewEvent1(ResourceOutputsEvent, ResourceOutputsEventPayload{
...
func (e *eventEmitter) resourcePreEvent(
	...
	e.ch1 <- NewEvent1(ResourcePreEvent, ResourcePreEventPayload{
		Metadata: makeStepEventMetadata(step.Op(), step, debug),
		Planning: planning,
		Debug:    debug,
	}).DeepCopy()
...
func (e *eventEmitter) preludeEvent(isPreview bool, cfg config.Map) {
	...
	e.ch1 <- NewEvent1(PreludeEvent, PreludeEventPayload{
		IsPreview: isPreview,
...
func (e *eventEmitter) summaryEvent(preview, maybeCorrupt bool, duration time.Duration,
	...
	e.ch1 <- NewEvent1(SummaryEvent, SummaryEventPayload{
		IsPreview:       preview,
...
func (e *eventEmitter) policyViolationEvent(urn resource.URN, d plugin.AnalyzeDiagnostic) {
	...
	e.ch1 <- NewEvent1(PolicyViolationEvent, PolicyViolationEventPayload{
		ResourceURN:       urn,
...
func diagEvent(e *eventEmitter, d *diag.Diag, prefix, msg string, sev diag.Severity,
	...
	e.ch1 <- NewEvent1(DiagEvent, DiagEventPayload{
		URN:       d.URN,
