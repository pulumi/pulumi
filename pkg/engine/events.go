...
func makeStepEventStateMetadata(state *pkgresource.State, debug bool, showSecrets bool) *StepEventStateMetadata {
	...
	return &StepEventStateMetadata{
		...
		Inputs:         filterResourceProperties(resource.ToResourcePropertyMap(state.Inputs), debug, showSecrets),
		Outputs:        filterResourceProperties(resource.ToResourcePropertyMap(state.Outputs), debug, showSecrets),
