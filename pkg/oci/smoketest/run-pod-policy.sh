...
# head -1: the yaml carries a second `image:` under build:; without it the extracted
# "ref" is two lines, and only cobra's CSV value parsing (which reads a single
# record) has been silently discarding the stray line.
