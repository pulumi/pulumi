...
namespace Pulumi.NewNames
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.NewNames.version.txt");
    ...
    internal sealed class NewNamesResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NewNamesResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
