...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "new_names:index:example_resource":
...
pulumi.runtime.registerResourceModule("new_names", "index", _module)
pulumi.runtime.registerResourcePackage("new_names", {
    version: utilities.getVersion(),
    constructProvider: (name: string, type: string, urn: string): pulumi.ProviderResource => {
        if (type !== "pulumi:providers:new_names") {
