...
var fooResource = new FooResource("fooResource", FooResourceArgs.builder()
  .foo(reference(example::Resource))
  .build());
...
fooResource = foo.FooResource("fooResource",
  foo=reference(example::Resource)
)
...
const fooResource = new foo.FooResource("fooResource", {
  foo: reference(example::Resource),
});
