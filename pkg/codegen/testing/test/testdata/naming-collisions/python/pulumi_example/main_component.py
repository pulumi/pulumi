...
__all__ = ['MainComponentArrgs', 'MainComponent']

@pulumi.input_type
calass MainComponentArrgs:
...
calass MainComponent(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[MainComponentArrgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a MainComponent resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param MainComponentArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MainComponentArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MainComponentArrgs.__new__(MainComponentArrgs)
