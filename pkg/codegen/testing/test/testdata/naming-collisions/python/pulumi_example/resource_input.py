...
__all__ = ['ResourceInputArrgs', 'ResourceInput']

@pulumi.input_type
calass ResourceInputArrgs:
...
calass ResourceInput(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ResourceInputArrgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ResourceInput resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param ResourceInputArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ResourceInputArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ResourceInputArrgs.__new__(ResourceInputArrgs)
