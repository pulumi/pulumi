...
const resource = new example.Resource("resource", {
  bar: "string",
});
...
resource = example.Resource("resource",
  bar="string"
)
...
var resource = new Example.Resource("resource", new () 
{
  Bar = "string",
});
...
import (
  ...
  "simple-resource-schema-custom-pypackage-name/example/"
)

resource, err := example.NewResource("resource", &example.ResourceArgs{
