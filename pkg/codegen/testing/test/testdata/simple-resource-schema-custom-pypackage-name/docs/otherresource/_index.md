...
otherResource, err := example.NewOtherResource("otherResource", &example.OtherResourceArgs{
  Foo: reference(example::Resource),
})
...
var otherResource = new OtherResource("otherResource", OtherResourceArgs.builder()
  .foo(reference(example::Resource))
  .build());
