...
import pulumi
import pulumi_provider_type as provider_type

provider = provider_type.submod.Provider("provider",
  a=True|False
)
...
import * as providerType from "@pulumi/providerType";

const provider = new providerType.submod.provider("provider", {
  a: true|false,
});
