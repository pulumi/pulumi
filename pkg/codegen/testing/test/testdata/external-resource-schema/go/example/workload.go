...
type Workload struct {
	...
	Pod corev1.PodTypePtrOutput `pulumi:"pod"`
}
...
func (o WorkloadOutput) Pod() corev1.PodTypePtrOutput {
	return o.ApplyT(func(v *Workload) corev1.PodTypePtrOutput { return v.Pod }).(corev1.PodTypePtrOutput)
}
