...
var PulumiPulumiComponentResourceTests = []ProgramTest{
	{
		Directory:   "terraform-child-module",
		Description: "Local Terraform Child Module",
	},
}
...
//nolint: revive
func TestProgramCodegen(  // TODO: THE TEST GOES OVER A COMPLETELY DIFFERENT CODE PATH THAN TF2PULUMI
	t *testing.T,
		...
		t.Run(tt.Description, func(t *testing.T) {
			...
			if !skipCompile && testcase.Check != nil && !tt.SkipCompile.Has(testcase.Language) {
				...
				for _, n := range program.Nodes {
					if r, isResource := n.(*pcl.Resource); isResource && !r.IsModule {
