...
class RubberTreeArgs:
    def __init__(__self__, *,
                 ...
                 farm: Optional[pulumi.Input[Union['Farm', _builtins.str]]] = None,
    ...
    @pulumi.getter
    @_utilities.deprecated("""Dear future maintainer, if there are changes here, make sure that this is printed before the value is set to the default or else this will always print.""")
    def farm(self) -> Optional[pulumi.Input[Union['Farm', _builtins.str]]]:
        return pulumi.get(self, "farm")

    @farm.setter
    def farm(self, value: Optional[pulumi.Input[Union['Farm', _builtins.str]]]):
...
class RubberTree(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            farm: Optional[pulumi.Input[Union['Farm', _builtins.str]]] = None) -> 'RubberTree':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def farm(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "farm")
