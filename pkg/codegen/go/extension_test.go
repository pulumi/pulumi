...
// schema generates a Go SDK that registers via the Extension proto field rather
// than a replacement Parameterization.
func TestExtensionParameterizationCodegen(t *testing.T) {
	...
	assert.Contains(t, utilities, "Extension: &pulumirpc.Parameterization{",
		"an extension SDK should register via the Extension proto field")
