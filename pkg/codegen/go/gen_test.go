...
func TestConvertHyphens(t *testing.T) {
	...
	assert.Equal("", removeHyphens(""))
	assert.Equal("plugh", removeHyphens("plugh"))
	assert.Equal("waldoThudFred", removeHyphens("waldo-thud-Fred"))
	assert.Equal("GarlpyCorgeFred", removeHyphens("Garlpy-Corge-Fred"))
	assert.Equal("thud", removeHyphens("thud-"))
	assert.Equal("Thud", removeHyphens("-thud"))
}
