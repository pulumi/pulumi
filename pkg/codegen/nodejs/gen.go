...
func genPackageMetadata(pkg *schema.Package, info NodePackageInfo, fs codegen.Fs, localDependencies map[string]string) error {
	...
	fs.Add("package.json", []byte(genNPMPackageMetadata(pkg, info, localDependencies)))
...
func genNPMPackageMetadata(pkg *schema.Package, info NodePackageInfo, localDependencies map[string]string) string {
