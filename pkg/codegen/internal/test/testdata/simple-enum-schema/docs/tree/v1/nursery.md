...
<span class="k">def </span><span class="nx">Nursery</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
            ...
            <span class="nx">sizes</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Mapping[str, pulumi.Input[_tree_v1.TreeSize]]]]</span> = None<span class="p">,</span>
            <span class="nx">varieties</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[Sequence[pulumi.Input[_tree_v1.RubberTreeVariety]]]]</span> = None<span class="p">)</span>
...
<a href="#varieties_nodejs" style="color: inherit; text-decoration: inherit;">varieties</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#rubbertreevariety">pulumi.<wbr>Input<pulumi.<wbr>Input<Rubber<wbr>Tree<wbr>Variety>[]></a></span>
    </dt>
    <dd>{{% md %}}The varieties available{{% /md %}}</dd><dt class="property-optional"
            title="Optional">
...
<a href="#sizes_nodejs" style="color: inherit; text-decoration: inherit;">sizes</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type">pulumi.<wbr>Input<{[key: string]: pulumi.<wbr>Input<Tree<wbr>Size>}></span>
    </dt>
    <dd>{{% md %}}The sizes of trees available{{% /md %}}</dd></dl>
{{% /choosable %}}
