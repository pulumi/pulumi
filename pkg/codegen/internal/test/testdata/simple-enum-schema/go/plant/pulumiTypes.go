...
type ContainerArgs struct {
	Color    pulumi.Input          `pulumi:"color"`
...
func (o ContainerOutput) Color() pulumi.AnyOutput {
	return o.ApplyT(func(v Container) interface{} { return v.Color }).(pulumi.AnyOutput)
}
...
func (o ContainerPtrOutput) Color() pulumi.AnyOutput {
	return o.ApplyT(func(v *Container) interface{} {
		if v == nil {
			return nil
		}
		return v.Color
