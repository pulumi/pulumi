...
export class Foo extends pulumi.CustomResource {
    ...
    public readonly key!: pulumi.Output<pulumiGoogleNative.iam.v1.Key>;
    public readonly policy!: pulumi.Output<pulumiGoogleNative.dns.v1.Policy>;
    ...
    constructor(name: string, args: FooArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            if ((!args || args.dnsKeySpec === undefined) && !opts.urn) {
                throw new Error("Missing required property 'dnsKeySpec'");
            }
            ...
            resourceInputs["dnsKeySpec"] = args ? args.dnsKeySpec : undefined;
...
export interface FooArgs {
    ...
    dnsKeySpec: pulumi.Input<pulumiGoogleNative.types.input.dns.v1.DnsKeySpecArgs>;
    key: pulumi.Input<pulumiGoogleNative.iam.v1.Key>;
    policy: pulumi.Input<pulumiGoogleNative.dns.v1.Policy>;
}
