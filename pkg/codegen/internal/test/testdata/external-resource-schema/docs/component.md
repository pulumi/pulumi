...
<span class="k">def </span><span class="nx">Component</span><span class="p">(</span><span class="nx">resource_name</span><span class="p">:</span> <span class="nx">str</span><span class="p">,</span>
              ...
              <span class="nx">metadata</span><span class="p">:</span> <span class="nx">Optional[pulumi.Input[pulumi_kubernetes.meta.v1.ObjectMeta]]</span> = None<span class="p">)</span>
...
<a href="#metadata_nodejs" style="color: inherit; text-decoration: inherit;">metadata</a>
        ...
        <span class="property-indicator"></span>
        <span class="property-type"><a href="#objectmeta">pulumi<wbr>Input<kubernetestypesinputmetav1Object<wbr>Meta<wbr>Args></a></span>
    </dt>
    <dd>{{% md %}}{{% /md %}}</dd></dl>
{{% /choosable %}}
