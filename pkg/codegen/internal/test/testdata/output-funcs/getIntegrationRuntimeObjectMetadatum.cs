...
namespace Pulumi.AzureNative.Codegentest
{
    public static class GetIntegrationRuntimeObjectMetadatum
    {
        ...
        public static Output<GetIntegrationRuntimeObjectMetadatumResult> Apply(GetIntegrationRuntimeObjectMetadatumApplyArgs args, InvokeOptions? options = null)
        {
    ...
    public sealed class GetIntegrationRuntimeObjectMetadatumApplyArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The factory name.
        /// </summary>
        ...
        public GetIntegrationRuntimeObjectMetadatumApplyArgs()
        {
        }
    }
    ...
    public sealed class GetIntegrationRuntimeObjectMetadatumResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<ImmutableDictionary<string, string>> Value;

        [OutputConstructor]
        private GetIntegrationRuntimeObjectMetadatumResult(
            string? nextLink,

            ImmutableArray<ImmutableDictionary<string, string>> value)
        {
            NextLink = nextLink;
            Value = value;
        }
