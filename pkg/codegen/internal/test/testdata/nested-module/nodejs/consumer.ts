...
export class Consumer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'foo:index:Consumer';
    ...
    public /*out*/ readonly r!: pulumi.Output<nested.module.Resource | undefined>;
    ...
    constructor(name: string, args?: ConsumerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (!opts.id) {
            resourceInputs["r"] = undefined /*out*/;
        } else {
            resourceInputs["r"] = undefined /*out*/;
        }
