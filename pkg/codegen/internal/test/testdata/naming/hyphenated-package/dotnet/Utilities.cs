...
namespace Pulumi.Hyphenated-package
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Hyphenated-package.version.txt");
    ...
    internal sealed class Hyphenated-packageResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public Hyphenated-packageResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
