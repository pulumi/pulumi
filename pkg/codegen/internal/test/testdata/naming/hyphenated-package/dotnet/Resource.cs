...
{
    [Hyphenated-packageResourceType("hyphenated-package::Resource")]
    public partial class Resource : Pulumi.CustomResource
    {
        ...
        public Resource(string name, ResourceArgs? args = null, CustomResourceOptions? options = null)
            : base("hyphenated-package::Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("hyphenated-package::Resource", name, null, MakeResourceOptions(options, id))
        {
        }
