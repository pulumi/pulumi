...
namespace Pulumi.Regress-7913
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Regress-7913.version.txt");
    ...
    internal sealed class Regress-7913ResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public Regress-7913ResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
