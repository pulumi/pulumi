...
class ResourceArgs:
    def __init__(__self__, *,
                 out: Optional[pulumi.Input[str]] = None):
        """
    ...
    @property
    @pulumi.getter
    def out(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "out")

    @out.setter
    def out(self, value: Optional[pulumi.Input[str]]):
...
class Resource(pulumi.CustomResource):
    ...
    def in_(self) -> pulumi.Output[Optional['_a.b.outputs.Object']]:
