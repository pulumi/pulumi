...
def arg_function(arg1: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('example:a/b/c/d:argFunction', __args__, opts=opts, typ=ArgFunctionResult).value
...
def arg_function_output(arg1: Optional[pulumi.Input[Optional[str]]] = None,
