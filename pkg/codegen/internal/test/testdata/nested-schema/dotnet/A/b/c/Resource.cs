...
namespace Pulumi.Example.A/b/c
{
    [ExampleResourceType("example:a/b/c:Resource")]
    public partial class Resource : Pulumi.CustomResource
    {
        [Output("in")]
        public Output<Pulumi.Example.A/b.Outputs.Object?> In { get; private set; } = null!;
        ...
        public Resource(string name, ResourceArgs? args = null, CustomResourceOptions? options = null)
            : base("example:a/b/c:Resource", name, args ?? new ResourceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Resource(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("example:a/b/c:Resource", name, null, MakeResourceOptions(options, id))
        {
        }
    ...
    {
        [Input("out")]
        public Input<string>? Out { get; set; }
