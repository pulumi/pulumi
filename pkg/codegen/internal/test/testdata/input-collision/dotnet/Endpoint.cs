...
{
    [ExampleResourceType("example::Endpoint")]
    public partial class Endpoint : Pulumi.CustomResource
    {
        ...
        public Endpoint(string name, EndpointArgs? args = null, CustomResourceOptions? options = null)
            : base("example::Endpoint", name, args ?? new EndpointArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Endpoint(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("example::Endpoint", name, null, MakeResourceOptions(options, id))
        {
        }
