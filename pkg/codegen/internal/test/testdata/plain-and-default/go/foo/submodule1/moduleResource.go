...
func NewModuleResource(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("foobar:submodule1:ModuleResource", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetModuleResource(ctx *pulumi.Context,
	...
	var resource ModuleResource
	err := ctx.ReadResource("foobar:submodule1:ModuleResource", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
