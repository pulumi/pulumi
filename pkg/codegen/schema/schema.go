...
type Function struct {
	...
	// package rather than using the core Pulumi codegen libraries.
	IsOverlay bool
	// This experiental flag works for methods that return a single value of type Resource and ensures that the
	// generated code returns the value promptly without wrapping it in an Output. Multiple returns are not allowed.
	XReturnPlainResource bool
}
...
type FunctionSpec struct {
	...
	// This experiental flag works for methods that return a single value of type Resource and ensures that the
	// generated code returns the value promptly without wrapping it in an Output. Multiple returns are not allowed.
	XReturnPlainResource bool `json:"returnPlainResource,omitempty" yaml:"returnPlainResource,omitempty"`
}
