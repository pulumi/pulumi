...
type DocLanguageHelper interface {
	...
	// language (e.g. PascalCase types in Go, snake_case properties in Python). Callers own
	// description-level rendering (markdown walking, example/code-block handling, etc.) and
	// invoke ResolveDocRef per ref they encounter while walking the parsed doc AST.
	//
