...
/*
Package murpc is a generated protocol buffer package.
...
type LogRequest struct {
	Severity LogSeverity `protobuf:"varint,1,opt,name=severity,enum=murpc.LogSeverity" json:"severity,omitempty"`
...
func init() {
	proto.RegisterType((*LogRequest)(nil), "murpc.LogRequest")
	proto.RegisterEnum("murpc.LogSeverity", LogSeverity_name, LogSeverity_value)
}
...
func (c *engineClient) Log(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	...
	err := grpc.Invoke(ctx, "/murpc.Engine/Log", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	,
}
