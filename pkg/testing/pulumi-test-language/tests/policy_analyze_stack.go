...
func init() {
	...
	//
	// Two runs make sure the policy actually inspects the stack rather than
	// hardcoding a response:
	//   0/ registers one resource  -> no violation
	//   1/ registers two resources -> one stack-level violation
