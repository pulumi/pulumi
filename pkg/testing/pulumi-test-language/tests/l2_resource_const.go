...
func init() {
	// Reading a resource property whose schema type has a constant value.
	LanguageTests["l2-resource-const"] = LanguageTest{
		Providers: []func() plugin.Provider{
			func() plugin.Provider { return &providers.ConstProvider{} },
		},
		Runs: []TestRun{
			{
