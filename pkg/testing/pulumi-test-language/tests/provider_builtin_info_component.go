...
func init() {
	LanguageTests["provider-builtin-info-component"] = LanguageTest{
		Providers: []func() plugin.Provider{
			func() plugin.Provider { return &providers.BuiltinInfoComponentProvider{} },
		},
		LanguageProviders: []string{"builtin-info-component"},
		Runs: []TestRun{
			{
