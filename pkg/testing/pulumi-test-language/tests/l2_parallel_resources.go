...
func init() {
	LanguageTests["l2-parallel-resources"] = LanguageTest{
		...
		Runs: []TestRun{
			{
				...
				Assert: func(l *L, res AssertArgs) {
					...
					RequireSingleResource(l, snap.Resources, "pulumi:providers:sync")
					RequireNResources(l, snap.Resources, "sync:index:Block", 3)
				},
			},
		},
	}
