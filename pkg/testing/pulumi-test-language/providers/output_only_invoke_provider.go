...
var _ plugin.Provider = (*OutputOnlyInvokeProvider)(nil)

func (p *OutputOnlyInvokeProvider) Close() error {
	return nil
}

func (p *OutputOnlyInvokeProvider) Configure(
...
func (p *OutputOnlyInvokeProvider) GetSchema(
...
func (p *OutputOnlyInvokeProvider) CheckConfig(
...
func (p *OutputOnlyInvokeProvider) Invoke(
