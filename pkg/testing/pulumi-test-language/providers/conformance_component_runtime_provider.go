...
// ConformanceComponentRuntimeProvider is used by runtime conformance tests
// that need a working Construct implementation for conformance-component.
type ConformanceComponentRuntimeProvider struct {
	ConformanceComponentProvider
}

var _ plugin.Provider = (*ConformanceComponentRuntimeProvider)(nil)
...
func (p *ConformanceComponentRuntimeProvider) Construct(
	ctx context.Context,
