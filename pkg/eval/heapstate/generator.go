...
// Package heapstate turns LumiIL object creation, assignment, etc. events into a LumiGL object graph.
package heapstate
...
// Graph takes the information recorded thus far and produces a new LumiGL graph from it.
