...
// Modules is a map of Module token to Module AST node.
type Modules map[tokens.Module]*Module
...
type ModuleMembers map[tokens.Token]ModuleMember
...
type ClassMembers map[tokens.Token]ClassMember
