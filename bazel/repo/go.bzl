...
def setup_go(name = "setup_go"):
    go_rules_dependencies()

    nixpkgs_go_configure(
        repository = "@nixpkgs",
        nix_file_content = GO_NIX,
...
in
  pkgs.callPackage bazelGo {}
"""

def _local_go_repository_impl(repository_ctx):
    repository_ctx.file(
        "WORKSPACE.bazel",
    ...
    path = "{workspace_root}/{directory}".format(
...
local_go_repository = repository_rule(
...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:VP72+99Fb2zEcYM0MeaWJmV+xQvz5v5cxRHd+ooU1lI=",
        version = "v2.13.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:PjWXHwZPuTLMR1NIb8nEjLucZBMzmf84TLoLbD8BZqk=",
        version = "v1.50.36",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:eVm30ZIDv//r6Aogat9I88b5YX1xASSLcEDqHYRPVl0=",
        version = "v1.31.4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:SBn4I0fJXF9FYOVRSVMWuhvEKoAHDikjGpS3wlmw5DE=",
        version = "v1.30.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:gttKczhMJufxvljW0Z6t8b6a9Ink9aOdqxQxD3igWMA=",
        version = "v1.6.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_azure_azure_sdk_for_go_sdk_resourcemanager_managementgroups_armmanagementgroups",
        importpath = "github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/managementgroups/armmanagementgroups",
        sum = "h1:pPvTJ1dY0sA35JOeFq6TsY2xj6Z85Yo23Pj4wCCvu4o=",
        version = "v1.0.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:po5+ljlcNSU8xtapHTe8gIc8yHxCzC03E8afH2g1ftU=",
        version = "v1.0.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        patch_args = ["-p1"],  # keep
        patches = ["//bazel/repo/patches:com-github-cloudflare-circl.patch"],  # keep
    ...
    go_repository(
        ...
        sum = "h1:UtktXaU2Nb64z/pLiGIxY4431SJ4/dR5cjMmlVHgnT4=",
        version = "v1.8.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:JGaDAt7aiz9casDxojbzFLI+3Mfj19R/+4twAKNGubk=",
        version = "v1.34.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:meCpJSesvzQyao8FCOgk2fGdoADAnbDu2WPJN1lDLJ4=",
        version = "v1.12.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:MGZzzxBuPuK4J0XQo+0uy0NnXQGKzHXhYp5oG1Wy860=",
        version = "v0.0.0-20230330192023-5cba443a66c4",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:5ehGtUBP29DFAgAs6bPw7fVSgqQ3TxaoK2xVcLp1x+c=",
        version = "v0.37.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:XLzC6W3Ah/Y7ht1rmZ6+QfPdt1iGWEAAtIZXgiaj57c=",
        version = "v1.1.0",
    )
    go_repository(
        name = "org_gioui",
