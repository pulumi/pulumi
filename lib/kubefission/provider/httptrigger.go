...
func (p *httProvider) Create(ctx context.Context, obj *idl.HTTPTrigger) (string, error) {
...
func (p *httProvider) Get(ctx context.Context, id string) (*idl.HTTPTrigger, error) {
	return nil, errors.New("Not yet implemented")
}

// InspectChange checks what impacts a hypothetical update will have on the resource's properties.
func (p *httProvider) InspectChange(ctx context.Context, id string,
...
func (p *httProvider) Update(ctx context.Context, id string,
	old *idl.HTTPTrigger, new *idl.HTTPTrigger, diff *resource.ObjectDiff) error {
	return errors.New("Not yet implemented")
}

// Delete tears down an existing resource with the given ID.  If it fails, the resource is assumed to still exist.
func (p *httProvider) Delete(ctx context.Context, id string) error {
	fmt.Printf("Deleting Fission HTTP trigger '%v'\n", id)
	if err := p.ctx.Fission.HTTPTriggerDelete(&fission.Metadata{Name: id}); err != nil {
		return err
	}
