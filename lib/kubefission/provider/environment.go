...
func (p *envProvider) Create(ctx context.Context, obj *idl.Environment) (string, error) {
...
func (p *envProvider) Get(ctx context.Context, id string) (*idl.Environment, error) {
	return nil, errors.New("Not yet implemented")
}

// InspectChange checks what impacts a hypothetical update will have on the resource's properties.
func (p *envProvider) InspectChange(ctx context.Context, id string,
...
func (p *envProvider) Update(ctx context.Context, id string,
	old *idl.Environment, new *idl.Environment, diff *resource.ObjectDiff) error {
	return errors.New("Not yet implemented")
}

// Delete tears down an existing resource with the given ID.  If it fails, the resource is assumed to still exist.
func (p *envProvider) Delete(ctx context.Context, id string) error {
	fmt.Printf("Deleting Fission Environment '%v'\n", id)
	if err := p.ctx.Fission.EnvironmentDelete(&fission.Metadata{Name: id}); err != nil {
		return err
	}
