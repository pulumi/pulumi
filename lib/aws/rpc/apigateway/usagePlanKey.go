...
type UsagePlanKeyProviderOps interface {
    ...
    Create(ctx context.Context, obj *UsagePlanKey) (string, error)
    Get(ctx context.Context, id string) (*UsagePlanKey, error)
    InspectChange(ctx context.Context,
        id string, old *UsagePlanKey, new *UsagePlanKey, diff *resource.ObjectDiff) ([]string, error)
    Update(ctx context.Context,
        id string, old *UsagePlanKey, new *UsagePlanKey, diff *resource.ObjectDiff) error
...
func NewUsagePlanKeyProvider(ops UsagePlanKeyProviderOps) cocorpc.ResourceProviderServer {
