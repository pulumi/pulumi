...
type ClientCertificateProviderOps interface {
    ...
    Query(ctx context.Context) ([]*ClientCertificateItem, error)
}
...
func (p *ClientCertificateProvider) Query(
...
// ClientCertificateItem is a marshalable representation of its corresponding IDL Query type.
type ClientCertificateItem struct {
	Id 			string
