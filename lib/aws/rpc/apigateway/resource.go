...
type ResourceProviderOps interface {
    ...
    Query(ctx context.Context) ([]*ResourceItem, error)
}
...
// ResourceItem is a marshalable representation of its corresponding IDL Query type.
