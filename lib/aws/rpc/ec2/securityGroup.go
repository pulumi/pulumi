...
type SecurityGroupProviderOps interface {
    ...
    Create(ctx context.Context, obj *SecurityGroup) (string, *SecurityGroupOuts, error)
    Get(ctx context.Context, id string) (*SecurityGroup, error)
    InspectChange(ctx context.Context,
        id string, old *SecurityGroup, new *SecurityGroup, diff *resource.ObjectDiff) ([]string, error)
    Update(ctx context.Context,
        id string, old *SecurityGroup, new *SecurityGroup, diff *resource.ObjectDiff) error
