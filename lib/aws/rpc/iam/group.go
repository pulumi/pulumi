...
type GroupProviderOps interface {
    ...
    Create(ctx context.Context, obj *Group) (string, error)
    Get(ctx context.Context, id string) (*Group, error)
    InspectChange(ctx context.Context,
        id string, old *Group, new *Group, diff *resource.ObjectDiff) ([]string, error)
    Update(ctx context.Context,
        id string, old *Group, new *Group, diff *resource.ObjectDiff) error
...
func NewGroupProvider(ops GroupProviderOps) cocorpc.ResourceProviderServer {
