...
type Policy struct {
	...
	PolicyDocument interface{} `coco:"policyDocument"` // TODO: schematize this.
	...
	PolicyName string `coco:"policyName"`
	...
	Roles *[]*Role `coco:"roles,optional"`
	// Users are the users for whom you want to add this policy.
	Users *[]*User `coco:"users,optional"`
}
