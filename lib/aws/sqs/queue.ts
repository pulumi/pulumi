...
export class Queue extends cloudformation.Resource implements QueueProperties {
    ...
    constructor(name: string, args: QueueProperties) {
        super({
            name: name,
...
export interface QueueProperties extends cloudformation.TagArgs {
