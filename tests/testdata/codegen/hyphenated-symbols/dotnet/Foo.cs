...
{
    [ReproResourceType("repro:index:Foo")]
    public partial class Foo : global::Pulumi.CustomResource
    {
        [Output("conditionSets")]
        public Output<ImmutableArray<ImmutableArray<ImmutableArray<Outputs.Bar>>>> ConditionSets { get; private set; } = null!;
        ...
        public Foo(string name, FooArgs? args = null, CustomResourceOptions? options = null)
            : base("repro:index:Foo", name, args ?? new FooArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Foo(string name, Input<string> id, CustomResourceOptions? options = null)
            : base("repro:index:Foo", name, null, MakeResourceOptions(options, id))
        {
        }
