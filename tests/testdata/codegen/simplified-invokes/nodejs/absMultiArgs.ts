 ...
 * Example: abs(1) returns 1, and abs(-1) would also return 1, whereas abs(-3.14) would return 3.14.
 */
export function absMultiArgsOutput(a: pulumi.Input<number>, b?: pulumi.Input<number | undefined>, opts?: pulumi.InvokeOptionsOutput): pulumi.Output<AbsMultiArgsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
