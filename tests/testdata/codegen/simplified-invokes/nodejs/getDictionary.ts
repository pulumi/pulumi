...
export function getDictionaryOutput(a?: pulumi.Input<number | undefined>, opts?: pulumi.InvokeOptionsOutput): pulumi.Output<{[key: string]: outputs.AnotherCustomResult}> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
