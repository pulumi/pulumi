...
export class ResourceInput extends pulumi.CustomResource {
    ...
    /**
     * Returns true if the given object is an instance of ResourceInput (or a subclass of it).  This is
    ...
    public static isInstance(obj: any): obj is ResourceInput {
        ...
        if (obj['__pulumiType'] === ResourceInput.__pulumiType) {
            return true;
        }
        const baseTypes = obj?.constructor?.['__pulumiBaseTypes'];
        return Array.isArray(baseTypes) && baseTypes.indexOf(ResourceInput.__pulumiType) !== -1;
    }

    declare public /*out*/ readonly bar: pulumi.Output<string | undefined>;
