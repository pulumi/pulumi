...
class Component2(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        __inst__ = Component2.__new__(Component2)
        return pulumi.runtime.exists_resource(__inst__, 'example:mod:Component2', resource_name, id, __props__, opts or pulumi.ResourceOptions())
