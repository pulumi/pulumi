...
class StaticPageArgs:
    def __init__(__self__, *,
                 index_content: pulumi.Input[builtins.str],
                 foo: Optional['FooArgs'] = None):
        """
        The set of arguments for constructing a StaticPage resource.
        :param pulumi.Input[builtins.str] index_content: The HTML content for index.html.
        """
    ...
    def index_content(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def index_content(self, value: pulumi.Input[builtins.str]):
...
@_utilities.pulumi_type("xyz:index:StaticPage")
class StaticPage(pulumi.ComponentResource):
    ...
    def __init__(__self__,
                 ...
                 index_content: Optional[pulumi.Input[builtins.str]] = None,
                 __props__=None):
        """
