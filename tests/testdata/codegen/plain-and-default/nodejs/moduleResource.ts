...
export class ModuleResource extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing ModuleResource resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("foobar::ModuleResource", id, {}, { ...opts }, undefined);
    }
