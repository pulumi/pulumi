...
export class Configurer extends pulumi.ComponentResource {
    ...
    /**
     * Returns true if the given object is an instance of Configurer (or a subclass of it).  This is
    ...
    public static isInstance(obj: any): obj is Configurer {
        ...
        if (obj instanceof Configurer) {
            return true;
        }
        if (obj['__pulumiType'] === Configurer.__pulumiType) {
            return true;
        }
        const baseTypes = obj?.constructor?.['__pulumiBaseTypes'];
        return Array.isArray(baseTypes) && baseTypes.indexOf(Configurer.__pulumiType) !== -1;
    }
