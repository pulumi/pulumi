...
def my_function(my_type: Optional[pulumi.InputType['MyType']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('typedDictDisabledExample:index:MyFunction', __args__, opts=opts, typ=MyFunctionResult).value
