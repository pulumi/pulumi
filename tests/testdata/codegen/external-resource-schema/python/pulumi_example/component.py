...
class ComponentArgs:
    def __init__(__self__, *,
                 ...
                 metadata: Optional[pulumi.Input[Optional['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]] = None,
                 metadata_array: Optional[pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]]] = None,
                 metadata_map: Optional[pulumi.Input[Optional[Mapping[str, pulumi.Input['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]]] = None):
        """
    ...
    @property
    @pulumi.getter
    def metadata(self) -> Optional[pulumi.Input[Optional['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]:
        return pulumi.get(self, "metadata")

    @metadata.setter
    def metadata(self, value: Optional[pulumi.Input[Optional['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]):
        pulumi.set(self, "metadata", value)

    @property
    @pulumi.getter(name="metadataArray")
    def metadata_array(self) -> Optional[pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]]]:
        return pulumi.get(self, "metadata_array")

    @metadata_array.setter
    def metadata_array(self, value: Optional[pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]]]):
        pulumi.set(self, "metadata_array", value)

    @property
    @pulumi.getter(name="metadataMap")
    def metadata_map(self) -> Optional[pulumi.Input[Optional[Mapping[str, pulumi.Input['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]]]:
        return pulumi.get(self, "metadata_map")

    @metadata_map.setter
    def metadata_map(self, value: Optional[pulumi.Input[Optional[Mapping[str, pulumi.Input['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]]]):
...
class Component(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 metadata: Optional[pulumi.Input[Optional[pulumi.InputType['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]] = None,
                 metadata_array: Optional[pulumi.Input[Optional[Sequence[pulumi.Input[pulumi.InputType['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]]]] = None,
                 metadata_map: Optional[pulumi.Input[Optional[Mapping[str, pulumi.Input[pulumi.InputType['pulumi_kubernetes.meta.v1.ObjectMetaArgs']]]]]] = None,
