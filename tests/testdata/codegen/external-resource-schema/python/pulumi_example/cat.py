...
class Cat(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 age: pulumi.Input[Optional[_builtins.int]] = None,
                 pet: pulumi.Input[Optional[Union['PetArgs', 'PetArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def exists(id: pulumi.Input[str],
        ...
        return pulumi.runtime.exists_resource(__inst__, 'example::Cat', id, __props__, opts or pulumi.ResourceOptions())
