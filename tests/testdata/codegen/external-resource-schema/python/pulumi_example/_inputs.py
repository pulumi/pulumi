...
class PetArgsDict(TypedDict):
    ...
    name: NotRequired[pulumi.Input[Optional['pulumi_random.RandomPet']]]
    name_array: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_random.RandomPet']]]]]
    name_map: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input['pulumi_random.RandomPet']]]]]
