...
class Foo(pulumi.ComponentResource):
    ...
    class BarResult:
        ...
        def some_value(self) -> _builtins.str:
            return pulumi.get(self, "some_value")

    def bar(__self__, *,
            baz_required: pulumi.Input['_nested.BazArgs'],
            bool_value_required: pulumi.Input[_builtins.bool],
            name_required: pulumi.Input['pulumi_random.RandomPet'],
            string_value_required: pulumi.Input[_builtins.str],
            ...
            bool_value_plain: Optional[_builtins.bool] = None,
            ...
            string_value_plain: Optional[_builtins.str] = None) -> pulumi.Output['Foo.BarResult']:
        """
    ...
    def generate_kubeconfig(__self__, *,
                            bool_value: _builtins.bool) -> pulumi.Output['Foo.GenerateKubeconfigResult']:
        """
