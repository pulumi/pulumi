...
export class RubberTree extends pulumi.CustomResource {
    ...
    /**
     * Returns true if the given object is an instance of RubberTree (or a subclass of it).  This is
    ...
    public static isInstance(obj: any): obj is RubberTree {
        ...
        if (obj instanceof RubberTree) {
            return true;
        }
        if (obj['__pulumiType'] === RubberTree.__pulumiType) {
            return true;
        }
        const baseTypes = obj?.constructor?.['__pulumiBaseTypes'];
        return Array.isArray(baseTypes) && baseTypes.indexOf(RubberTree.__pulumiType) !== -1;
    }
