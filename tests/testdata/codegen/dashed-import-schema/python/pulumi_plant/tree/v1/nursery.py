...
class Nursery(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 sizes: pulumi.Input[Optional[Mapping[str, pulumi.Input['TreeSize']]]] = None,
                 varieties: pulumi.Input[Optional[Sequence[pulumi.Input['RubberTreeVariety']]]] = None,
                 __props__=None):
        """
    ...
    def exists(id: pulumi.Input[str],
        ...
        return pulumi.runtime.exists_resource(__inst__, 'plant:tree/v1:Nursery', id, __props__, opts or pulumi.ResourceOptions())
