...
class ResourceArgs:
    ...
    @property
    @pulumi.getter
    def bar(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "bar")

    @bar.setter
    def bar(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bar", value)


@_utilities.pulumi_type("example::Resource")
class Resource(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def bar(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "bar")
