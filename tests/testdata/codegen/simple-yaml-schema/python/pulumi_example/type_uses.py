...
class TypeUsesArgs:
    def __init__(__self__, *,
                 ...
                 qux: Optional[pulumi.Input[Optional['RubberTreeVariety']]] = None):
        """
    ...
    @property
    @pulumi.getter
    def qux(self) -> Optional[pulumi.Input[Optional['RubberTreeVariety']]]:
        return pulumi.get(self, "qux")

    @qux.setter
    def qux(self, value: Optional[pulumi.Input[Optional['RubberTreeVariety']]]):
