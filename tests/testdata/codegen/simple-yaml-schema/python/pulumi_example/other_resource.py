...
class OtherResourceArgs:
    def __init__(__self__, *,
                 bar: Optional[Sequence[pulumi.Input[builtins.str]]] = None,
    ...
    @property
    @pulumi.getter
    def bar(self) -> Optional[Sequence[pulumi.Input[builtins.str]]]:
        return pulumi.get(self, "bar")

    @bar.setter
    def bar(self, value: Optional[Sequence[pulumi.Input[builtins.str]]]):
...
@_utilities.pulumi_type("example::OtherResource")
