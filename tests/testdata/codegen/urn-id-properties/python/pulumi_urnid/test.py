...
def test(id: Optional[builtins.float] = None,
         urn: Optional[builtins.float] = None,
...
def test_output(id: Optional[pulumi.Input[builtins.float]] = None,
                urn: Optional[pulumi.Input[builtins.float]] = None,
