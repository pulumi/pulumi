...
class Object(dict):
    ...
    def __init__(__self__, *,
                 bar: Optional[builtins.str] = None,
    ...
    @property
    @pulumi.getter
    def bar(self) -> Optional[builtins.str]:
...
class ObjectWithNodeOptionalInputs(dict):
    def __init__(__self__, *,
                 foo: builtins.str,
                 bar: Optional[builtins.int] = None):
        pulumi.set(__self__, "foo", foo)
        if bar is not None:
            pulumi.set(__self__, "bar", bar)
    ...
    @property
    @pulumi.getter
    def bar(self) -> Optional[builtins.int]:
        return pulumi.get(self, "bar")
...
class SomeOtherObject(dict):
    def __init__(__self__, *,
                 baz: Optional[builtins.str] = None):
        if baz is not None:
            pulumi.set(__self__, "baz", baz)

    @property
    @pulumi.getter
    def baz(self) -> Optional[builtins.str]:
