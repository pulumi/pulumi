...
export class FooResource extends pulumi.ComponentResource {
    ...
    /**
     * Returns true if the given object is an instance of FooResource (or a subclass of it).  This is
    ...
    public static isInstance(obj: any): obj is FooResource {
        ...
        if (obj instanceof FooResource) {
            return true;
        }
        if (obj['__pulumiType'] === FooResource.__pulumiType) {
            return true;
        }
        const baseTypes = obj?.constructor?.['__pulumiBaseTypes'];
        return Array.isArray(baseTypes) && baseTypes.indexOf(FooResource.__pulumiType) !== -1;
    }
