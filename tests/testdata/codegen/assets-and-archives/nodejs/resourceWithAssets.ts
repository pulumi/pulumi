...
export class ResourceWithAssets extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing ResourceWithAssets resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("example:index:ResourceWithAssets", id, {}, { ...opts }, undefined);
    }
