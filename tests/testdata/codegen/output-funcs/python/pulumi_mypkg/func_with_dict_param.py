...
def func_with_dict_param(a: Optional[Mapping[str, builtins.str]] = None,
...
def func_with_dict_param_output(a: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
