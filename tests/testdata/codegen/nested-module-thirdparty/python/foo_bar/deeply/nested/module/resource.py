...
class Resource(pulumi.CustomResource):
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'foo-bar:deeply/nested/module:Resource', resource_name, id, __props__, opts or pulumi.ResourceOptions())

    @_builtins.property
    @pulumi.getter
    def baz(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "baz")
