...
class ModuleTest(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 mod1: pulumi.Input[Optional[Union['_mod1.TypArgs', '_mod1.TypArgsDict']]] = None,
                 val: pulumi.Input[Optional[Union['TypArgs', 'TypArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def exists(id: pulumi.Input[str],
        ...
        return pulumi.runtime.exists_resource(__inst__, 'example:index:moduleTest', id, __props__, opts or pulumi.ResourceOptions())
