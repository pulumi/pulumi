...
class KubeClientSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 qps: Optional[builtins.float] = None,
                 rec_test: Optional['outputs.KubeClientSettings'] = None):
        """
        Options for tuning the Kubernetes client used by a Provider.
        :param builtins.int burst: Maximum burst for throttle. Default value is 10.
        :param builtins.float qps: Maximum queries per second (QPS) to the API server from this client. Default value is 5.
        """
        if burst is None:
    ...
    @property
    @pulumi.getter
    def qps(self) -> Optional[builtins.float]:
        """
