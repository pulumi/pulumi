...
class Example_resourceArgs:
    def __init__(__self__, *,
                 map_enum: Optional[pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, pulumi.Input['Enum_XYZ']]]]]]] = None,
                 request__http: Optional[pulumi.Input[Optional['_http_module.RequestArgs']]] = None):
        """
    ...
    @property
    @pulumi.getter
    def map_enum(self) -> Optional[pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, pulumi.Input['Enum_XYZ']]]]]]]:
        return pulumi.get(self, "map_enum")

    @map_enum.setter
    def map_enum(self, value: Optional[pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, pulumi.Input['Enum_XYZ']]]]]]]):
        pulumi.set(self, "map_enum", value)

    @property
    @pulumi.getter(name="request_HTTP")
    def request__http(self) -> Optional[pulumi.Input[Optional['_http_module.RequestArgs']]]:
        return pulumi.get(self, "request__http")

    @request__http.setter
    def request__http(self, value: Optional[pulumi.Input[Optional['_http_module.RequestArgs']]]):
...
class Example_resource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 map_enum: Optional[pulumi.Input[Optional[Sequence[pulumi.Input[Mapping[str, pulumi.Input['Enum_XYZ']]]]]]] = None,
                 request__http: Optional[pulumi.Input[Optional[pulumi.InputType['_http_module.RequestArgs']]]] = None,
                 __props__=None):
        """
