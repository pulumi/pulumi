...
func (r *WebService) Scale(ctx *pulumi.Context, args *WebServiceScaleArgs) error {
	_, err := ctx.Call("example:index:WebService/scale", args, pulumi.AnyOutput{}, r)
	return err
}

type webServiceScaleArgs struct {
	Replicas int `pulumi:"replicas"`
}

// The set of arguments for the Scale method of the WebService resource.
type WebServiceScaleArgs struct {
	Replicas pulumi.IntInput
}

func (WebServiceScaleArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*webServiceScaleArgs)(nil)).Elem()
}
