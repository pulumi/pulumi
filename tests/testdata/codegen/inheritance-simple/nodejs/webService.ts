...
/**
 * A web service that extends the base Service component.
 */
export class WebService extends Service {
    ...
    /** @internal */
    public static readonly __pulumiBaseTypes: string[] = ['example:index:Service'];
    ...
    constructor(name: string, args: WebServiceArgs, opts?: pulumi.ComponentResourceOptions, __chain?: any /* internal */) {
        ...
        if (__chain === undefined) {
            ...
            if (new.target !== WebService) {
                ...
                void pulumi.runtime.constructBaseResource(this, "example:index:WebService", args ?? {}, { version: utilities.getVersion() }, ["instanceCount", "port", "url"]);
                return;
            }
        }
    ...
    /**
     * Scales the web service, overriding the base implementation.
     */
    scale(args: WebService.ScaleArgs): void {
        pulumi.runtime.call("example:index:WebService/scale", {
            "__self__": this,
...
export namespace WebService {
    /**
     * The set of arguments for the WebService.scale method.
     */
