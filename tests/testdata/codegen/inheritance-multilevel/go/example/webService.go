...
func (o WebServiceOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v *WebService) pulumi.StringOutput { return v.Id }).(pulumi.StringOutput)
}
...
func (o WebServiceOutput) Replicas() pulumi.IntOutput {
	return o.ApplyT(func(v *WebService) pulumi.IntOutput { return v.Replicas }).(pulumi.IntOutput)
}
