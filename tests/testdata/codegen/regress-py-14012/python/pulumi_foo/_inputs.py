...
if not MYPY:
    class ProviderCertmanagerArgsDict(TypedDict):
        mtls_cert_pem: pulumi.Input[builtins.str]
        mtls_key_pem: pulumi.Input[builtins.str]
elif False:
...
class ProviderCertmanagerArgs:
    ...
    def mtls_cert_pem(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "mtls_cert_pem")

    @mtls_cert_pem.setter
    def mtls_cert_pem(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "mtls_cert_pem", value)

    @property
    @pulumi.getter(name="mtlsKeyPem")
    def mtls_key_pem(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "mtls_key_pem")

    @mtls_key_pem.setter
    def mtls_key_pem(self, value: pulumi.Input[builtins.str]):
