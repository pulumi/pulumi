...
export class SqlResourceSqlContainer extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing SqlResourceSqlContainer resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("azure-native:documentdb:SqlResourceSqlContainer", id, {}, { ...opts }, undefined);
    }
