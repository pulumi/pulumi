...
func BasicResourceExists(ctx *pulumi.Context,
	id pulumi.IDInput, state *BasicResourceState, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("example:index:BasicResource", id, state, opts...)
}
