...
func BasicResourceV2Exists(ctx *pulumi.Context,
	id pulumi.IDInput, state *BasicResourceV2State, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("example:index:BasicResourceV2", id, state, opts...)
}
