...
export class BasicResourceV2 extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing BasicResourceV2 resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("example:index:BasicResourceV2", id, {}, { ...opts }, undefined);
    }
