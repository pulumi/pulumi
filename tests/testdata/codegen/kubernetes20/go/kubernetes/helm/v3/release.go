...
func ReleaseExists(ctx *pulumi.Context,
	id pulumi.IDInput, state *ReleaseState, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("kubernetes:helm.sh/v3:Release", id, state, opts...)
}
