...
func ConfigMapExists(ctx *pulumi.Context,
	id pulumi.IDInput, state *ConfigMapState, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("kubernetes:core/v1:ConfigMap", id, state, opts...)
}
