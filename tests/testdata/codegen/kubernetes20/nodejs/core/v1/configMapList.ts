...
export class ConfigMapList extends pulumi.CustomResource {
    ...
    /**
     * Returns true if the given object is an instance of ConfigMapList (or a subclass of it).  This is
    ...
    public static isInstance(obj: any): obj is ConfigMapList {
        ...
        if (obj['__pulumiType'] === ConfigMapList.__pulumiType) {
            return true;
        }
        const baseTypes = obj?.constructor?.['__pulumiBaseTypes'];
        return Array.isArray(baseTypes) && baseTypes.indexOf(ConfigMapList.__pulumiType) !== -1;
    }
