...
export class ConfigMap extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing ConfigMap resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("kubernetes:core/v1:ConfigMap", id, {}, { ...opts }, undefined);
    }
