...
def get_function(foo_bar: Optional['_my_mod.Resource'] = None,
    ...
    __ret__ = pulumi.runtime.invoke('example::getFunction', __args__, opts=opts, typ=GetFunctionResult).value
...
def get_function_output(foo_bar: Optional[pulumi.Input[Optional['_my_mod.Resource']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('example::getFunction', __args__, opts=opts, typ=GetFunctionResult)
