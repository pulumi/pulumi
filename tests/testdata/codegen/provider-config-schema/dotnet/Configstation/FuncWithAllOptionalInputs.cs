...
namespace Configstation.Pulumi.Configstation
{
    public static class FuncWithAllOptionalInputs
    {
        ...
        public static Task<FuncWithAllOptionalInputsResult> InvokeAsync(FuncWithAllOptionalInputsArgs? args = null, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<FuncWithAllOptionalInputsResult>("configstation::funcWithAllOptionalInputs", args ?? new FuncWithAllOptionalInputsArgs(), options.WithDefaults());
