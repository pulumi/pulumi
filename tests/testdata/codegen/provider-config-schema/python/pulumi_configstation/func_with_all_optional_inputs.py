...
def func_with_all_optional_inputs(a: Optional[builtins.str] = None,
                                  b: Optional[builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableFuncWithAllOptionalInputsResult:
    """
    Check codegen of functions with all optional inputs.


    :param builtins.str a: Property A
    :param builtins.str b: Property B
    """
    __args__ = dict()
    __args__['a'] = a
    __args__['b'] = b
...
def func_with_all_optional_inputs_output(a: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         b: Optional[pulumi.Input[Optional[builtins.str]]] = None,
