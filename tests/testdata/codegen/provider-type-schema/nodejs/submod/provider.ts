...
export class Provider extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing Provider resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("providerType:submod:provider", id, {}, { ...opts }, undefined);
    }
