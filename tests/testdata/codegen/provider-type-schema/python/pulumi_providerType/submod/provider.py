...
class ProviderArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def a(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "a")

    @a.setter
    def a(self, value: Optional[_builtins.bool]):
...
class Provider(pulumi.CustomResource):
    ...
    def exists(id: pulumi.Input[str],
        ...
        return pulumi.runtime.exists_resource(__inst__, 'providerType:submod:provider', id, __props__, opts or pulumi.ResourceOptions())
