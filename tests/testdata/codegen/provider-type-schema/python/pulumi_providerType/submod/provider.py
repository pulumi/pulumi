...
class ProviderArgs:
    ...
    @property
    @pulumi.getter
    def a(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "a")

    @a.setter
    def a(self, value: Optional[builtins.bool]):
        pulumi.set(self, "a", value)


@_utilities.pulumi_type("providerType:submod:provider")
class Provider(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def a(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "a")
