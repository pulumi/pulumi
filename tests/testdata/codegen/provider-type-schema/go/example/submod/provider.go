...
func ProviderExists(ctx *pulumi.Context,
	id pulumi.IDInput, state *ProviderState, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("providerType:submod:provider", id, state, opts...)
}
