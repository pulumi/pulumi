...
class ResourceArgs:
    def __init__(__self__, *,
                 ...
                 foo_array: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 foo_map: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]):
        """
    ...
    def foo_array(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "foo_array")

    @foo_array.setter
    def foo_array(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        pulumi.set(self, "foo_array", value)

    @_builtins.property
    @pulumi.getter(name="fooMap")
    def foo_map(self) -> pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]:
        return pulumi.get(self, "foo_map")

    @foo_map.setter
    def foo_map(self, value: pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]):
...
class Resource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 config: pulumi.Input[Optional[Union['ConfigArgs', 'ConfigArgsDict']]] = None,
                 config_array: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ConfigArgs', 'ConfigArgsDict']]]]] = None,
                 config_map: pulumi.Input[Optional[Mapping[str, pulumi.Input[Union['ConfigArgs', 'ConfigArgsDict']]]]] = None,
                 foo: pulumi.Input[Optional[_builtins.str]] = None,
                 foo_array: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 foo_map: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
    ...
    def exists(resource_name: str,
        ...
        return pulumi.runtime.exists_resource(__inst__, 'mypkg::Resource', resource_name, id, __props__, opts or pulumi.ResourceOptions())
    ...
    @_builtins.property
    @pulumi.getter
    def foo(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "foo")

    @_builtins.property
    @pulumi.getter(name="fooArray")
    def foo_array(self) -> pulumi.Output[Sequence[_builtins.str]]:
        return pulumi.get(self, "foo_array")
