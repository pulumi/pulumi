...
class Laser(dict):
    ...
    def __init__(__self__, *,
                 ...
                 batteries: Optional[_builtins.bool] = None,
                 light: Optional[_builtins.float] = None):
        """
        A Toy for a cat
        """
    ...
    @_builtins.property
    @pulumi.getter
    def batteries(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "batteries")

    @_builtins.property
    @pulumi.getter
    def light(self) -> Optional[_builtins.float]:
...
class Toy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 wear: Optional[_builtins.float] = None):
        """
        This is a toy
        """
    ...
    @_builtins.property
    @pulumi.getter
    def wear(self) -> Optional[_builtins.float]:
