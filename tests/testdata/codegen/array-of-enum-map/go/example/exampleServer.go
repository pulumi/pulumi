...
func ExampleServerExists(ctx *pulumi.Context,
	id pulumi.IDInput, state *ExampleServerState, opts ...pulumi.ResourceOption) pulumi.BoolOutput {
	return ctx.ExistsResource("example:index:ExampleServer", id, state, opts...)
}
