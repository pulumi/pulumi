...
export class Pet extends pulumi.CustomResource {
    ...
    /**
     * Check whether an existing Pet resource with the given ID exists.
     *
    ...
    public static exists(id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): pulumi.Output<boolean> {
        return pulumi.runtime.existsResource("example::Pet", id, {}, { ...opts }, undefined);
    }
    ...
    constructor(name: string, args?: PetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Pet.__pulumiType, name, resourceInputs, opts);
    }
}
