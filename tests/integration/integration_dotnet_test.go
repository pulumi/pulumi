...
func TestConstructMethodsDotnet(t *testing.T) {
	testConstructMethods(t, "dotnet", "Pulumi")
}
...
func TestConstructProviderDotnet(t *testing.T) {
	testConstructProvider(t, "dotnet", "Pulumi")
}
