...
const transformChild1DependsOnChild2: pulumi.ResourceTransform = (() => {
    ...
    // Return a transform which will rewrite child1 to depend on the promise for child2, and
    // will resolve that promise when it finds child2.
    return (args: pulumi.ResourceTransformArgs) => {
...
const res5 = new MyOtherComponent("res5", {
    transforms: [ transformChild1DependsOnChild2 ],
});
