...
# Meanwhile he register_resource call for the `wait` resource is running in the
...
# The way out of this is to shutdown the callbacks server, which unblocks the
# thread pool and lets the program terminate.
import asyncio
import pulumi
