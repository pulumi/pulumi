...
export class Echo extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'testprovider:index:Echo';
    ...
    constructor(name: string, args?: EchoArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Echo.__pulumiType, name, resourceInputs, opts);
    }
    ...
    doEchoMethod(args?: Echo.DoEchoMethodArgs): pulumi.Output<Echo.DoEchoMethodResult> {
        args = args || {};
        return pulumi.runtime.call("testprovider:index:Echo/doEchoMethod", {
            "__self__": this,
            "echo": args.echo,
        }, this);
    }
