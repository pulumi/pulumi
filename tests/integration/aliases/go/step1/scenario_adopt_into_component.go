...
func newAdoptFooComponent3(ctx *pulumi.Context, name string, opts ...pulumi.ResourceOption) (*adoptFooComponent3, error) {
	fooComp := &adoptFooComponent3{}
	err := ctx.RegisterComponentResource("my:module:FooComponent3", name, fooComp, opts...)
	if err != nil {
		return nil, err
	}
	_, err = newAdoptFooComponent2(ctx, name+"-child", opts...)
	if err != nil {
		return nil, err
	}
	return fooComp, nil
...
func scenarioAdoptIntoComponent(ctx *pulumi.Context) error {
	_, err := newAdoptFooResource(ctx, "res2")
	if err != nil {
		return err
	}
	...
	_, err = newAdoptFooComponent2(ctx, "unparented")
	if err != nil {
		return err
	}
	_, err = newAdoptFooComponent3(ctx, "parentedbystack")
	if err != nil {
		return err
	}
	pbcOpt := pulumi.Parent(comp2)
	_, err = newAdoptFooComponent3(ctx, "parentedbycomponent", pbcOpt)
	if err != nil {
		return err
	}
