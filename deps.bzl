...
def go_deps():
    ...
    go_repository(
        ...
        sum = "h1:dvvIB9OYsOH10RUNAY7yiCq5fQwGebXx1auBOkBTUlg=",
        version = "v1.15.14",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_sns",
        importpath = "github.com/aws/aws-sdk-go-v2/service/sns",
        sum = "h1:ZZuqucIwjbUEJqxxR++VDZX9BcMbX5ZcQaKoWul/ELk=",
        version = "v1.17.10",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:dkh5kaNrTAAYu4ZLWP7kx+k3Nrh/9dkPRxJPsvs5nCQ=",
        version = "v1.27.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Y4YVS9h+gu9YI8RkUyUFJbbqom7XDs1i4AEUi270g6g=",
        version = "v1.0.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:7Lsi9H9ijCAfqOaMiNmQ4c+GL9bdrpCjebNKhV/eQ+c=",
        version = "v0.17.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:CxeO3Up9XLNFgHeJfgUfgSKVqPGp7n00wVTJWf6ahTM=",
        version = "v1.31.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:g+qvdrXfskgMXiq6DQMo5EdEIp8mo/9befVIddWstGI=",
    ...
    go_repository(
        ...
        sum = "h1:LgnE+97wnUK/qcmk5oHIqieJEKwhZtaSidyKpUyeats=",
        version = "v0.37.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:3KLhsPyyFp1pfZPicg8e1VMSeztIyWm+aE+iZQ8b9Kg=",
        version = "v0.13.13",
    )
    go_repository(
