...
import (
	...
	"github.com/pulumi/pulumi/pulumi/pkg/util/cmdutil"
	"github.com/pulumi/pulumi/pulumi/pkg/util/logging"
	"github.com/pulumi/pulumi/pulumi/pkg/util/rpcutil"
	"github.com/pulumi/pulumi/pulumi/pkg/version"
...
func (host *goLanguageHost) constructEnv(req *pulumirpc.RunRequest) ([]string, error) {
	...
	maybeAppendEnv(EnvProject, req.GetProject())
	maybeAppendEnv(EnvStack, req.GetStack())
	maybeAppendEnv(EnvConfig, config)
	maybeAppendEnv(EnvDryRun, fmt.Sprintf("%v", req.GetDryRun()))
	maybeAppendEnv(EnvParallel, fmt.Sprint(req.GetParallel()))
	maybeAppendEnv(EnvMonitor, req.GetMonitorAddress())
	maybeAppendEnv(EnvEngine, host.engineAddress)
