...
// awsInstanceType2Arch is a map of instance type to architecture.
export let awsInstanceType2Arch: {
...
// awsRegionArch2AMI is a map from region to inner maps from architecture to the recommended Linux AMI.
export let awsRegionArch2AMI: {
...
export function getLinuxAMI(instanceType: string): string {
    ...
    let arch = awsInstanceType2Arch[instanceType].Arch;
    return awsRegionArch2AMI[region][arch];
}
