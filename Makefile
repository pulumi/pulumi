...
test_fast::
	$(GO_TEST_FAST) ${FAST_TEST_PKGS} & PID=$$! ; while [ `kill -s 0 $$PID` ]; do printf "."; sleep 20; done; wait $$PID;

test_all::
	$(GO_TEST) ${FAST_TEST_PKGS} & PID=$$! ; while [ `kill -s 0 $$PID` ]; do printf "."; sleep 20; done; wait $$PID;
	$(GO_TEST) ${SLOW_TEST_PKGS} & PID=$$! ; while [ `kill -s 0 $$PID` ]; do printf "."; sleep 20; done; wait $$PID;
