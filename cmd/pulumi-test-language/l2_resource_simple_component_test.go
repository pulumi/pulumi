...
func (h *L2ResourceSimpleComponentLanguageHost) Pack(
	...
	if req.PackageDirectory == filepath.Join(h.tempDir, "sdks", "simple-component-21.0.0") {
		return &pulumirpc.PackResponse{
			ArtifactPath: filepath.Join(req.DestinationDirectory, "simple-component-21.0.0.sdk"),
		}, nil
...
func (h *L2ResourceSimpleComponentLanguageHost) GenerateProject(
	...
	if req.LocalDependencies["simple-component"] != filepath.Join(h.tempDir, "artifacts", "simple-component-21.0.0.sdk") {
...
func (h *L2ResourceSimpleComponentLanguageHost) GeneratePackage(
	...
	if req.Directory != filepath.Join(h.tempDir, "sdks", "simple-component-21.0.0") {
