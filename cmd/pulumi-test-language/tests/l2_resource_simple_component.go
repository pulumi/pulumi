...
func init() {
	LanguageTests["l2-resource-simple-component"] = LanguageTest{
		Providers: []func() plugin.Provider{
			...
			func() plugin.Provider { return &providers.SimpleComponentProvider{} },
		},
		OptionalPackages: []string{"simple"},
		Runs: []TestRun{
			{
				Assert: func(l *L,
					...
					assert.Equal(l, want, simpleComponent.Inputs, "expected inputs to be {value: true}")
