...
type RefComponentProvider struct {
	plugin.UnimplementedProvider
}

var _ plugin.Provider = (*RefComponentProvider)(nil)

func (p *RefComponentProvider) Close() error {
	return nil
}

func (p *RefComponentProvider) Configure(
	context.Context, plugin.ConfigureRequest,
) (plugin.ConfigureResponse, error) {
	return plugin.ConfigureResponse{}, nil
}

func (p *RefComponentProvider) Pkg() tokens.Package {
	return "ref-component"
}

func (p *RefComponentProvider) GetSchema(
	context.Context, plugin.GetSchemaRequest,
) (plugin.GetSchemaResponse, error) {
	resourceProperties := map[string]schema.PropertySpec{
		"inputs": {
			TypeSpec: schema.TypeSpec{
				Ref: "/ref-ref/v12.0.0/schema.json#/types/ref-ref:index:InnerData",
			},
		},
	}
	resourceRequired := []string{"inputs"}

	pkg := schema.PackageSpec{
		Name:    "ref-component",
		Version: "16.0.0",
		Resources: map[string]schema.ResourceSpec{
			"ref-component:index:Resource": {
				IsComponent: true,
...
func (p *RefComponentProvider) CheckConfig(
...
func (p *RefComponentProvider) Check(
	_ context.Context, req plugin.CheckRequest,
) (plugin.CheckResponse, error) {
	return plugin.CheckResponse{}, errors.New("Check not implemented")
}

func (p *RefComponentProvider) Create(
	_ context.Context, req plugin.CreateRequest,
) (plugin.CreateResponse, error) {
	return plugin.CreateResponse{}, errors.New("Create not implemented")
}

func (p *RefComponentProvider) GetPluginInfo(context.Context) (workspace.PluginInfo, error) {
...
func (p *RefComponentProvider) SignalCancellation(context.Context) error {
	return nil
}

func (p *RefComponentProvider) GetMapping(
	context.Context, plugin.GetMappingRequest,
) (plugin.GetMappingResponse, error) {
	return plugin.GetMappingResponse{}, nil
}

func (p *RefComponentProvider) GetMappings(
	context.Context, plugin.GetMappingsRequest,
) (plugin.GetMappingsResponse, error) {
	return plugin.GetMappingsResponse{}, nil
}

func (p *RefComponentProvider) DiffConfig(
	context.Context, plugin.DiffConfigRequest,
) (plugin.DiffConfigResponse, error) {
	return plugin.DiffResult{}, nil
}

func (p *RefComponentProvider) Diff(
	context.Context, plugin.DiffRequest,
) (plugin.DiffResponse, error) {
	return plugin.DiffResult{}, nil
}

func (p *RefComponentProvider) Delete(
	context.Context, plugin.DeleteRequest,
) (plugin.DeleteResponse, error) {
	return plugin.DeleteResponse{}, nil
}

func (p *RefComponentProvider) Construct(
