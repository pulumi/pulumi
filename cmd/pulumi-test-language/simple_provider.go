...
func (p *simpleProvider) CheckConfig(urn resource.URN, name, typ string, oldInputs, newInputs resource.PropertyMap,
	allowUnknowns bool,
...
func (p *simpleProvider) Check(urn resource.URN, name, typ string, oldInputs, newInputs resource.PropertyMap,
...
func (p *simpleProvider) Create(
	urn resource.URN, name, typ string, news resource.PropertyMap,
