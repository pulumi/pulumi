...
func newUpCmd() *cobra.Command {
	...
	upWorkingDirectory := func(opts backend.UpdateOptions) result.IResult {
	...
	upTemplateNameOrURL := func(templateNameOrURL string, opts backend.UpdateOptions) result.IResult {
	...
	var cmd = &cobra.Command{
		...
		Run: cmdutil.RunResultFunc(func(cmd *cobra.Command, args []string) result.IResult {
